...
public final class ByteConverter extends Factory {
   ...
   private static final byte[] responseBodyConverter$lambda_0/* $FF was: responseBodyConverter$lambda-0*/(ResponseBody value) {
      return value.bytes();
   }
}
