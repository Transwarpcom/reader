...
public class SSML implements Serializable {
   ...
   public String toString() {
      ...
      }).orElse(""), Optional.ofNullable(this.pitch).orElse("+0Hz"), Optional.ofNullable(this.rate).orElse("+0%"), Optional.ofNullable(this.volume).orElse("+0%"), this.synthesisText, Optional.ofNullable(this.style).map((s) -> {
         return "</mstts:express-as>";
      }).orElse(""));
   }

   // $FF: synthetic method
   SSML(String x0, VoiceEnum x1, String x2, String x3, String x4, TtsStyleEnum x5, OutputFormat x6, Object x7) {
