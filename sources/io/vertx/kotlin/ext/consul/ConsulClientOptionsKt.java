...
public final class ConsulClientOptionsKt {
    ...
    public static final ConsulClientOptions consulClientOptionsOf(@Nullable String aclToken, @Nullable Iterable<? extends HttpVersion> iterable, @Nullable Integer connectTimeout, @Nullable Iterable<String> iterable2, @Nullable Iterable<? extends Buffer> iterable3, @Nullable String dc, @Nullable Integer decoderInitialBufferSize, @Nullable String defaultHost, @Nullable Integer defaultPort, @Nullable Iterable<String> iterable4, @Nullable Iterable<String> iterable5, @Nullable Boolean followRedirects, @Nullable Boolean forceSni, @Nullable Boolean http2ClearTextUpgrade, @Nullable Integer http2ConnectionWindowSize, @Nullable Integer http2KeepAliveTimeout, @Nullable Integer http2MaxPoolSize, @Nullable Integer http2MultiplexingLimit, @Nullable Integer idleTimeout, @Nullable TimeUnit idleTimeoutUnit, @Nullable Http2Settings initialSettings, @Nullable JdkSSLEngineOptions jdkSslEngineOptions, @Nullable Boolean keepAlive, @Nullable Integer keepAliveTimeout, @Nullable JksOptions keyStoreOptions, @Nullable String localAddress, @Nullable Boolean logActivity, @Nullable Integer maxChunkSize, @Nullable Integer maxHeaderSize, @Nullable Integer maxInitialLineLength, @Nullable Integer maxPoolSize, @Nullable Integer maxRedirects, @Nullable Integer maxWaitQueueSize, @Nullable Integer maxWebSocketFrameSize, @Nullable Integer maxWebSocketMessageSize, @Nullable Integer maxWebsocketFrameSize, @Nullable Integer maxWebsocketMessageSize, @Nullable String metricsName, @Nullable OpenSSLEngineOptions openSslEngineOptions, @Nullable PemKeyCertOptions pemKeyCertOptions, @Nullable PemTrustOptions pemTrustOptions, @Nullable PfxOptions pfxKeyCertOptions, @Nullable PfxOptions pfxTrustOptions, @Nullable Boolean pipelining, @Nullable Integer pipeliningLimit, @Nullable Integer poolCleanerPeriod, @Nullable HttpVersion protocolVersion, @Nullable ProxyOptions proxyOptions, @Nullable Integer receiveBufferSize, @Nullable Boolean reuseAddress, @Nullable Boolean reusePort, @Nullable Integer sendBufferSize, @Nullable Boolean sendUnmaskedFrames, @Nullable Integer soLinger, @Nullable Boolean ssl, @Nullable Long sslHandshakeTimeout, @Nullable TimeUnit sslHandshakeTimeoutUnit, @Nullable Boolean tcpCork, @Nullable Boolean tcpFastOpen, @Nullable Boolean tcpKeepAlive, @Nullable Boolean tcpNoDelay, @Nullable Boolean tcpQuickAck, @Nullable Long timeout, @Nullable Integer trafficClass, @Nullable Boolean trustAll, @Nullable JksOptions trustStoreOptions, @Nullable Boolean tryUseCompression, @Nullable Boolean tryUsePerFrameWebSocketCompression, @Nullable Boolean tryUsePerFrameWebsocketCompression, @Nullable Boolean tryUsePerMessageWebSocketCompression, @Nullable Boolean tryUsePerMessageWebsocketCompression, @Nullable Boolean useAlpn, @Nullable Boolean usePooledBuffers, @Nullable String userAgent, @Nullable Boolean userAgentEnabled, @Nullable Boolean verifyHost, @Nullable Boolean webSocketCompressionAllowClientNoContext, @Nullable Integer webSocketCompressionLevel, @Nullable Boolean webSocketCompressionRequestServerNoContext, @Nullable Boolean websocketCompressionAllowClientNoContext, @Nullable Integer websocketCompressionLevel, @Nullable Boolean websocketCompressionRequestServerNoContext) {
        ...
        if (followRedirects != null) {
            $this$apply.setFollowRedirects(followRedirects.booleanValue());
        }
        if (forceSni != null) {
        ...
        if (userAgentEnabled != null) {
            $this$apply.setUserAgentEnabled(userAgentEnabled.booleanValue());
        }
        if (verifyHost != null) {
    ...
    public static /* synthetic */ ConsulClientOptions ConsulClientOptions$default(String str, Iterable iterable, Integer num, Iterable iterable2, Iterable iterable3, String str2, Integer num2, String str3, Integer num3, Iterable iterable4, Iterable iterable5, Boolean bool, Boolean bool2, Boolean bool3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8, TimeUnit timeUnit, Http2Settings http2Settings, JdkSSLEngineOptions jdkSSLEngineOptions, Boolean bool4, Integer num9, JksOptions jksOptions, String str4, Boolean bool5, Integer num10, Integer num11, Integer num12, Integer num13, Integer num14, Integer num15, Integer num16, Integer num17, Integer num18, Integer num19, String str5, OpenSSLEngineOptions openSSLEngineOptions, PemKeyCertOptions pemKeyCertOptions, PemTrustOptions pemTrustOptions, PfxOptions pfxOptions, PfxOptions pfxOptions2, Boolean bool6, Integer num20, Integer num21, HttpVersion httpVersion, ProxyOptions proxyOptions, Integer num22, Boolean bool7, Boolean bool8, Integer num23, Boolean bool9, Integer num24, Boolean bool10, Long l, TimeUnit timeUnit2, Boolean bool11, Boolean bool12, Boolean bool13, Boolean bool14, Boolean bool15, Long l2, Integer num25, Boolean bool16, JksOptions jksOptions2, Boolean bool17, Boolean bool18, Boolean bool19, Boolean bool20, Boolean bool21, Boolean bool22, Boolean bool23, String str6, Boolean bool24, Boolean bool25, Boolean bool26, Integer num26, Boolean bool27, Boolean bool28, Integer num27, Boolean bool29, int i, int i2, int i3, Object obj) {
        ...
        return ConsulClientOptions(str, iterable, num, iterable2, iterable3, str2, num2, str3, num3, iterable4, iterable5, bool, bool2, bool3, num4, num5, num6, num7, num8, timeUnit, http2Settings, jdkSSLEngineOptions, bool4, num9, jksOptions, str4, bool5, num10, num11, num12, num13, num14, num15, num16, num17, num18, num19, str5, openSSLEngineOptions, pemKeyCertOptions, pemTrustOptions, pfxOptions, pfxOptions2, bool6, num20, num21, httpVersion, proxyOptions, num22, bool7, bool8, num23, bool9, num24, bool10, l, timeUnit2, bool11, bool12, bool13, bool14, bool15, l2, num25, bool16, jksOptions2, bool17, bool18, bool19, bool20, bool21, bool22, bool23, str6, bool24, bool25, bool26, num26, bool27, bool28, num27, bool29);
    }

    @Deprecated(message = "This function will be removed in a future version", replaceWith = @ReplaceWith(imports = {}, expression = "consulClientOptionsOf(aclToken, alpnVersions, connectTimeout, crlPaths, crlValues, dc, decoderInitialBufferSize, defaultHost, defaultPort, enabledCipherSuites, enabledSecureTransportProtocols, followRedirects, forceSni, http2ClearTextUpgrade, http2ConnectionWindowSize, http2KeepAliveTimeout, http2MaxPoolSize, http2MultiplexingLimit, idleTimeout, idleTimeoutUnit, initialSettings, jdkSslEngineOptions, keepAlive, keepAliveTimeout, keyStoreOptions, localAddress, logActivity, maxChunkSize, maxHeaderSize, maxInitialLineLength, maxPoolSize, maxRedirects, maxWaitQueueSize, maxWebSocketFrameSize, maxWebSocketMessageSize, maxWebsocketFrameSize, maxWebsocketMessageSize, metricsName, openSslEngineOptions, pemKeyCertOptions, pemTrustOptions, pfxKeyCertOptions, pfxTrustOptions, pipelining, pipeliningLimit, poolCleanerPeriod, protocolVersion, proxyOptions, receiveBufferSize, reuseAddress, reusePort, sendBufferSize, sendUnmaskedFrames, soLinger, ssl, sslHandshakeTimeout, sslHandshakeTimeoutUnit, tcpCork, tcpFastOpen, tcpKeepAlive, tcpNoDelay, tcpQuickAck, timeout, trafficClass, trustAll, trustStoreOptions, tryUseCompression, tryUsePerFrameWebSocketCompression, tryUsePerFrameWebsocketCompression, tryUsePerMessageWebSocketCompression, tryUsePerMessageWebsocketCompression, useAlpn, usePooledBuffers, userAgent, userAgentEnabled, verifyHost, webSocketCompressionAllowClientNoContext, webSocketCompressionLevel, webSocketCompressionRequestServerNoContext, websocketCompressionAllowClientNoContext, websocketCompressionLevel, websocketCompressionRequestServerNoContext)"))
    @NotNull
    public static final ConsulClientOptions ConsulClientOptions(@Nullable String aclToken, @Nullable Iterable<? extends HttpVersion> iterable, @Nullable Integer connectTimeout, @Nullable Iterable<String> iterable2, @Nullable Iterable<? extends Buffer> iterable3, @Nullable String dc, @Nullable Integer decoderInitialBufferSize, @Nullable String defaultHost, @Nullable Integer defaultPort, @Nullable Iterable<String> iterable4, @Nullable Iterable<String> iterable5, @Nullable Boolean followRedirects, @Nullable Boolean forceSni, @Nullable Boolean http2ClearTextUpgrade, @Nullable Integer http2ConnectionWindowSize, @Nullable Integer http2KeepAliveTimeout, @Nullable Integer http2MaxPoolSize, @Nullable Integer http2MultiplexingLimit, @Nullable Integer idleTimeout, @Nullable TimeUnit idleTimeoutUnit, @Nullable Http2Settings initialSettings, @Nullable JdkSSLEngineOptions jdkSslEngineOptions, @Nullable Boolean keepAlive, @Nullable Integer keepAliveTimeout, @Nullable JksOptions keyStoreOptions, @Nullable String localAddress, @Nullable Boolean logActivity, @Nullable Integer maxChunkSize, @Nullable Integer maxHeaderSize, @Nullable Integer maxInitialLineLength, @Nullable Integer maxPoolSize, @Nullable Integer maxRedirects, @Nullable Integer maxWaitQueueSize, @Nullable Integer maxWebSocketFrameSize, @Nullable Integer maxWebSocketMessageSize, @Nullable Integer maxWebsocketFrameSize, @Nullable Integer maxWebsocketMessageSize, @Nullable String metricsName, @Nullable OpenSSLEngineOptions openSslEngineOptions, @Nullable PemKeyCertOptions pemKeyCertOptions, @Nullable PemTrustOptions pemTrustOptions, @Nullable PfxOptions pfxKeyCertOptions, @Nullable PfxOptions pfxTrustOptions, @Nullable Boolean pipelining, @Nullable Integer pipeliningLimit, @Nullable Integer poolCleanerPeriod, @Nullable HttpVersion protocolVersion, @Nullable ProxyOptions proxyOptions, @Nullable Integer receiveBufferSize, @Nullable Boolean reuseAddress, @Nullable Boolean reusePort, @Nullable Integer sendBufferSize, @Nullable Boolean sendUnmaskedFrames, @Nullable Integer soLinger, @Nullable Boolean ssl, @Nullable Long sslHandshakeTimeout, @Nullable TimeUnit sslHandshakeTimeoutUnit, @Nullable Boolean tcpCork, @Nullable Boolean tcpFastOpen, @Nullable Boolean tcpKeepAlive, @Nullable Boolean tcpNoDelay, @Nullable Boolean tcpQuickAck, @Nullable Long timeout, @Nullable Integer trafficClass, @Nullable Boolean trustAll, @Nullable JksOptions trustStoreOptions, @Nullable Boolean tryUseCompression, @Nullable Boolean tryUsePerFrameWebSocketCompression, @Nullable Boolean tryUsePerFrameWebsocketCompression, @Nullable Boolean tryUsePerMessageWebSocketCompression, @Nullable Boolean tryUsePerMessageWebsocketCompression, @Nullable Boolean useAlpn, @Nullable Boolean usePooledBuffers, @Nullable String userAgent, @Nullable Boolean userAgentEnabled, @Nullable Boolean verifyHost, @Nullable Boolean webSocketCompressionAllowClientNoContext, @Nullable Integer webSocketCompressionLevel, @Nullable Boolean webSocketCompressionRequestServerNoContext, @Nullable Boolean websocketCompressionAllowClientNoContext, @Nullable Integer websocketCompressionLevel, @Nullable Boolean websocketCompressionRequestServerNoContext) {
        ConsulClientOptions $this$apply = new ConsulClientOptions();
        if (aclToken != null) {
            $this$apply.setAclToken(aclToken);
        }
