...
public final class MongoServiceKt {
    ...
    @Nullable
    public static final Object saveWithOptionsAwait(@NotNull final MongoService $this$saveWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject document, @Nullable final WriteOption writeOption, @NotNull Continuation<? super String> continuation) {
    ...
    @Nullable
    public static final Object insertAwait(@NotNull final MongoService $this$insertAwait, @NotNull final String collection, @NotNull final JsonObject document, @NotNull Continuation<? super String> continuation) {
    ...
    @Nullable
    public static final Object insertWithOptionsAwait(@NotNull final MongoService $this$insertWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject document, @Nullable final WriteOption writeOption, @NotNull Continuation<? super String> continuation) {
    ...
    @Nullable
    public static final Object updateCollectionAwait(@NotNull final MongoService $this$updateCollectionAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final JsonObject update, @NotNull Continuation<? super MongoClientUpdateResult> continuation) {
    ...
    @Nullable
    public static final Object replaceDocumentsAwait(@NotNull final MongoService $this$replaceDocumentsAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final JsonObject replace, @NotNull Continuation<? super MongoClientUpdateResult> continuation) {
    ...
    @Nullable
    public static final Object replaceDocumentsWithOptionsAwait(@NotNull final MongoService $this$replaceDocumentsWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final JsonObject replace, @NotNull final UpdateOptions options, @NotNull Continuation<? super MongoClientUpdateResult> continuation) {
    ...
    @Nullable
    public static final Object bulkWriteAwait(@NotNull final MongoService $this$bulkWriteAwait, @NotNull final String collection, @NotNull final List<? extends BulkOperation> list, @NotNull Continuation<? super MongoClientBulkWriteResult> continuation) {
    ...
    @Nullable
    public static final Object findAwait(@NotNull final MongoService $this$findAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull Continuation<? super List<? extends JsonObject>> continuation) {
    ...
    @Nullable
    public static final Object findWithOptionsAwait(@NotNull final MongoService $this$findWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final FindOptions options, @NotNull Continuation<? super List<? extends JsonObject>> continuation) {
    ...
    @Nullable
    public static final Object findOneAwait(@NotNull final MongoService $this$findOneAwait, @NotNull final String collection, @NotNull final JsonObject query, @Nullable final JsonObject fields, @NotNull Continuation<? super JsonObject> continuation) {
    ...
    @Nullable
    public static final Object findOneAndUpdateAwait(@NotNull final MongoService $this$findOneAndUpdateAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final JsonObject update, @NotNull Continuation<? super JsonObject> continuation) {
    ...
    @Nullable
    public static final Object findOneAndReplaceAwait(@NotNull final MongoService $this$findOneAndReplaceAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final JsonObject replace, @NotNull Continuation<? super JsonObject> continuation) {
    ...
    @Nullable
    public static final Object findOneAndReplaceWithOptionsAwait(@NotNull final MongoService $this$findOneAndReplaceWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final JsonObject update, @NotNull final FindOptions findOptions, @NotNull final UpdateOptions updateOptions, @NotNull Continuation<? super JsonObject> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<JsonObject>>, Unit>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.findOneAndReplaceWithOptionsAwait.2
            ...
            public final void invoke2(@NotNull Handler<AsyncResult<JsonObject>> it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                $this$findOneAndReplaceWithOptionsAwait.findOneAndReplaceWithOptions(collection, query, update, findOptions, updateOptions, it);
            }
        }, continuation);
    }

    @Nullable
    public static final Object findOneAndDeleteAwait(@NotNull final MongoService $this$findOneAndDeleteAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull Continuation<? super JsonObject> continuation) {
    ...
    @Nullable
    public static final Object findOneAndDeleteWithOptionsAwait(@NotNull final MongoService $this$findOneAndDeleteWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull final FindOptions findOptions, @NotNull Continuation<? super JsonObject> continuation) {
    ...
    @Nullable
    public static final Object countAwait(@NotNull final MongoService $this$countAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull Continuation<? super Long> continuation) {
    ...
    @Nullable
    public static final Object removeDocumentsAwait(@NotNull final MongoService $this$removeDocumentsAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull Continuation<? super MongoClientDeleteResult> continuation) {
    ...
    @Nullable
    public static final Object removeDocumentsWithOptionsAwait(@NotNull final MongoService $this$removeDocumentsWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject query, @Nullable final WriteOption writeOption, @NotNull Continuation<? super MongoClientDeleteResult> continuation) {
    ...
    @Nullable
    public static final Object removeDocumentAwait(@NotNull final MongoService $this$removeDocumentAwait, @NotNull final String collection, @NotNull final JsonObject query, @NotNull Continuation<? super MongoClientDeleteResult> continuation) {
    ...
    @Nullable
    public static final Object removeDocumentWithOptionsAwait(@NotNull final MongoService $this$removeDocumentWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject query, @Nullable final WriteOption writeOption, @NotNull Continuation<? super MongoClientDeleteResult> continuation) {
    ...
    @Nullable
    public static final Object createCollectionAwait(@NotNull final MongoService $this$createCollectionAwait, @NotNull final String collectionName, @NotNull Continuation<? super Unit> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<Unit>>, Unit>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.createCollectionAwait.2
            ...
            public final void invoke2(@NotNull final Handler<AsyncResult<Unit>> it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                $this$createCollectionAwait.createCollection(collectionName, new Handler<AsyncResult<Void>>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.createCollectionAwait.2.1
    ...
    @Nullable
    public static final Object getCollectionsAwait(@NotNull final MongoService $this$getCollectionsAwait, @NotNull Continuation<? super List<String>> continuation) {
    ...
    @Nullable
    public static final Object dropCollectionAwait(@NotNull final MongoService $this$dropCollectionAwait, @NotNull final String collection, @NotNull Continuation<? super Unit> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<Unit>>, Unit>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.dropCollectionAwait.2
            ...
            public final void invoke2(@NotNull final Handler<AsyncResult<Unit>> it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                $this$dropCollectionAwait.dropCollection(collection, new Handler<AsyncResult<Void>>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.dropCollectionAwait.2.1
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // io.vertx.core.Handler
                    public final void handle(AsyncResult<Void> asyncResult) {
                        it.handle(asyncResult.mapEmpty());
    ...
    @Nullable
    public static final Object createIndexAwait(@NotNull final MongoService $this$createIndexAwait, @NotNull final String collection, @NotNull final JsonObject key, @NotNull Continuation<? super Unit> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<Unit>>, Unit>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.createIndexAwait.2
            ...
            public final void invoke2(@NotNull final Handler<AsyncResult<Unit>> it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                $this$createIndexAwait.createIndex(collection, key, new Handler<AsyncResult<Void>>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.createIndexAwait.2.1
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // io.vertx.core.Handler
                    public final void handle(AsyncResult<Void> asyncResult) {
                        it.handle(asyncResult.mapEmpty());
    ...
    @Nullable
    public static final Object createIndexWithOptionsAwait(@NotNull final MongoService $this$createIndexWithOptionsAwait, @NotNull final String collection, @NotNull final JsonObject key, @NotNull final IndexOptions options, @NotNull Continuation<? super Unit> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<Unit>>, Unit>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.createIndexWithOptionsAwait.2
            ...
            public final void invoke2(@NotNull final Handler<AsyncResult<Unit>> it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                $this$createIndexWithOptionsAwait.createIndexWithOptions(collection, key, options, new Handler<AsyncResult<Void>>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.createIndexWithOptionsAwait.2.1
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // io.vertx.core.Handler
                    public final void handle(AsyncResult<Void> asyncResult) {
                        it.handle(asyncResult.mapEmpty());
    ...
    @Nullable
    public static final Object listIndexesAwait(@NotNull final MongoService $this$listIndexesAwait, @NotNull final String collection, @NotNull Continuation<? super JsonArray> continuation) {
    ...
    @Nullable
    public static final Object dropIndexAwait(@NotNull final MongoService $this$dropIndexAwait, @NotNull final String collection, @NotNull final String indexName, @NotNull Continuation<? super Unit> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<Unit>>, Unit>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.dropIndexAwait.2
            ...
            public final void invoke2(@NotNull final Handler<AsyncResult<Unit>> it) {
                Intrinsics.checkParameterIsNotNull(it, "it");
                $this$dropIndexAwait.dropIndex(collection, indexName, new Handler<AsyncResult<Void>>() { // from class: io.vertx.kotlin.ext.mongo.MongoServiceKt.dropIndexAwait.2.1
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // io.vertx.core.Handler
                    public final void handle(AsyncResult<Void> asyncResult) {
                        it.handle(asyncResult.mapEmpty());
    ...
    @Nullable
    public static final Object runCommandAwait(@NotNull final MongoService $this$runCommandAwait, @NotNull final String commandName, @NotNull final JsonObject command, @NotNull Continuation<? super JsonObject> continuation) {
    ...
    @Nullable
    public static final Object distinctAwait(@NotNull final MongoService $this$distinctAwait, @NotNull final String collection, @NotNull final String fieldName, @NotNull final String resultClassname, @NotNull Continuation<? super JsonArray> continuation) {
    ...
    @Nullable
    public static final Object distinctWithQueryAwait(@NotNull final MongoService $this$distinctWithQueryAwait, @NotNull final String collection, @NotNull final String fieldName, @NotNull final String resultClassname, @NotNull final JsonObject query, @NotNull Continuation<? super JsonArray> continuation) {
