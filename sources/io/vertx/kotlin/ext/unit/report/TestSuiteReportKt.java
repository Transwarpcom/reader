...
/* loaded from: reader.jar:BOOT-INF/lib/vertx-lang-kotlin-3.8.5.jar:io/vertx/kotlin/ext/unit/report/TestSuiteReportKt.class */
public final class TestSuiteReportKt {
    @Nullable
    public static final Object pipeToAwait(@NotNull final TestSuiteReport $this$pipeToAwait, @NotNull final WriteStream<TestCaseReport> writeStream, @NotNull Continuation<? super Unit> continuation) {
        return VertxCoroutineKt.awaitResult(new Function1<Handler<AsyncResult<Unit>>, Unit>() { // from class: io.vertx.kotlin.ext.unit.report.TestSuiteReportKt.pipeToAwait.2
            ...
            public final void invoke2(@NotNull final Handler<AsyncResult<Unit>> it) {
                ...
                $this$pipeToAwait.pipeTo(writeStream, new Handler<AsyncResult<Void>>() { // from class: io.vertx.kotlin.ext.unit.report.TestSuiteReportKt.pipeToAwait.2.1
