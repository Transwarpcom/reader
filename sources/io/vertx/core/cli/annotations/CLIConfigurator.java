...
/* loaded from: reader.jar:BOOT-INF/lib/vertx-core-3.8.5.jar:io/vertx/core/cli/annotations/CLIConfigurator.class */
        ...
        for (Method method : methods) {
            ...
            if (option != null) {
                ...
                try {
                    ...
                    throw new CLIException("Cannot inject value for option '" + name + OperatorName.SHOW_TEXT_LINE, e);
                }
            }
            if (argument != null) {
                int index = argument.index();
                try {
                    Object injected2 = getArgumentValue(method, index, cli);
                    if (injected2 != null) {
                        method.setAccessible(true);
                        method.invoke(object, injected2);
                    }
                } catch (Exception e2) {
                    throw new CLIException("Cannot inject value for argument '" + index + OperatorName.SHOW_TEXT_LINE, e2);
                }
            }
        }
    }

    private static <T> Object createMultiValueContainer(Method setter, List<T> values) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
