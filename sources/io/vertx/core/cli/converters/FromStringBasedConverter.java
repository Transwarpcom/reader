...
/* loaded from: reader.jar:BOOT-INF/lib/vertx-core-3.8.5.jar:io/vertx/core/cli/converters/FromStringBasedConverter.class */
public final class FromStringBasedConverter<T> implements Converter<T> {
    ...
    public static <T> FromStringBasedConverter<T> getIfEligible(Class<T> clazz) throws NoSuchMethodException, SecurityException {
        try {
