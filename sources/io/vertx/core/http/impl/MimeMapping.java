...
/* loaded from: reader.jar:BOOT-INF/lib/vertx-core-3.8.5.jar:io/vertx/core/http/impl/MimeMapping.class */
public class MimeMapping {
    ...
    static {
        ...
        m.put(OperatorName.NON_STROKING_COLOR, "application/vnd.ibm.secure-container");
        ...
        m.put(NCXDocumentV2.PREFIX_DTB, "application/x-dtbook+xml");
        ...
        m.put(LiveBeansView.MBEAN_APPLICATION_KEY, "application/x-ms-application");
        ...
        m.put(OperatorName.SHADING_FILL, "application/x-sh");
        ...
        m.put(NCXDocumentV2.NCXAttributes.src, "application/x-wais-source");
        ...
        m.put("xml", MimeTypeUtils.APPLICATION_XML_VALUE);
        m.put("xsl", MimeTypeUtils.APPLICATION_XML_VALUE);
        ...
        m.put(ImgUtil.IMAGE_TYPE_BMP, "image/bmp");
        m.put("cgm", "image/cgm");
        m.put("g3", "image/g3fax");
        m.put(ImgUtil.IMAGE_TYPE_GIF, MimeTypeUtils.IMAGE_GIF_VALUE);
        m.put("ief", "image/ief");
        m.put(ImgUtil.IMAGE_TYPE_JPEG, MimeTypeUtils.IMAGE_JPEG_VALUE);
        m.put(ImgUtil.IMAGE_TYPE_JPG, MimeTypeUtils.IMAGE_JPEG_VALUE);
        m.put("jpe", MimeTypeUtils.IMAGE_JPEG_VALUE);
        m.put("ktx", "image/ktx");
        m.put(ImgUtil.IMAGE_TYPE_PNG, MimeTypeUtils.IMAGE_PNG_VALUE);
        ...
        m.put(ImgUtil.IMAGE_TYPE_PSD, "image/vnd.adobe.photoshop");
        ...
        m.put(NCXDocumentV2.NCXTags.text, "text/plain");
        m.put("conf", "text/plain");
        m.put(BaseParser.DEF, "text/plain");
        m.put(BeanDefinitionParserDelegate.LIST_ELEMENT, "text/plain");
        ...
        m.put("me", "text/troff");
        m.put("ms", "text/troff");
        m.put(RtspHeaders.Values.TTL, "text/turtle");
        ...
        m.put(OperatorName.CLOSE_AND_STROKE, "text/x-asm");
        m.put("asm", "text/x-asm");
        m.put(OperatorName.CURVE_TO, "text/x-c");
        m.put("cc", "text/x-c");
        m.put("cxx", "text/x-c");
        m.put("cpp", "text/x-c");
        m.put(OperatorName.CLOSE_PATH, "text/x-c");
        m.put("hh", "text/x-c");
        m.put("dic", "text/x-c");
        m.put(OperatorName.FILL_NON_ZERO, "text/x-fortran");
