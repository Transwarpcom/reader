...
/* loaded from: reader.jar:BOOT-INF/lib/vertx-core-3.8.5.jar:io/vertx/core/eventbus/impl/CodecManager.class */
public class CodecManager {
    ...
    public MessageCodec lookupCodec(Object body, String codecName) {
        MessageCodec codec;
        if (codecName != null) {
            codec = this.userCodecMap.get(codecName);
            if (codec == null) {
            ...
            codec = this.defaultCodecMap.get(body.getClass());
            if (codec == null) {
    ...
    public MessageCodec getCodec(String codecName) {
        return this.userCodecMap.get(codecName);
    }
    ...
    public void unregisterDefaultCodec(Class clazz) {
        Objects.requireNonNull(clazz);
        MessageCodec codec = this.defaultCodecMap.remove(clazz);
        if (codec != null) {
