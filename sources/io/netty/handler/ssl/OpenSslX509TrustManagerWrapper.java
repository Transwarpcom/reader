...
/* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509TrustManagerWrapper.class */
final class OpenSslX509TrustManagerWrapper {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509TrustManagerWrapper$TrustManagerWrapper.class */
    ...
    public static SSLContext newSSLContext() throws NoSuchAlgorithmException {
        return SSLContext.getInstance(SSLProtocols.TLS);
    }

    /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509TrustManagerWrapper$UnsafeTrustManagerWrapper.class */
