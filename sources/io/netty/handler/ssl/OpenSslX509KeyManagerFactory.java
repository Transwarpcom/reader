...
/* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509KeyManagerFactory.class */
public final class OpenSslX509KeyManagerFactory extends KeyManagerFactory {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi.class */
    private static final class OpenSslKeyManagerFactorySpi extends KeyManagerFactorySpi {
        ...
        protected synchronized void engineInit(KeyStore keyStore, char[] chars) throws NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException {
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi$ProviderFactory.class */
        private static final class ProviderFactory {
            ...
            /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi$ProviderFactory$OpenSslPopulatedKeyMaterialProvider.class */
    ...
    public static OpenSslX509KeyManagerFactory newEngineBased(File certificateChain, String password) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, CertificateException, KeyStoreException {
        return newEngineBased(SslContext.toX509Certificates(certificateChain), password);
    }

    public static OpenSslX509KeyManagerFactory newEngineBased(X509Certificate[] certificateChain, String password) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, CertificateException, KeyStoreException {
    ...
    public static OpenSslX509KeyManagerFactory newKeyless(File chain) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, CertificateException, KeyStoreException {
        return newKeyless(SslContext.toX509Certificates(chain));
    }

    public static OpenSslX509KeyManagerFactory newKeyless(InputStream chain) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, CertificateException, KeyStoreException {
        return newKeyless(SslContext.toX509Certificates(chain));
    }

    public static OpenSslX509KeyManagerFactory newKeyless(X509Certificate... certificateChain) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, CertificateException, KeyStoreException {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyStore.class */
