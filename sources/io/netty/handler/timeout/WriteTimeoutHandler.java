...
/* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/timeout/WriteTimeoutHandler.class */
public class WriteTimeoutHandler extends ChannelOutboundHandlerAdapter {
    ...
    private void scheduleTimeout(ChannelHandlerContext ctx, ChannelPromise promise) {
        ...
        if (!task.scheduledFuture.isDone()) {
            ...
            promise.addListener2((GenericFutureListener<? extends Future<? super Void>>) task);
        }
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/timeout/WriteTimeoutHandler$WriteTimeoutTask.class */
