...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/DateFormatter.class */
public final class DateFormatter {
    ...
    public static String format(Date date) {
        return formatter().format0((Date) ObjectUtil.checkNotNull(date, PackageDocumentBase.DCTags.date));
    }

    public static StringBuilder append(Date date, StringBuilder sb) {
        return formatter().append0((Date) ObjectUtil.checkNotNull(date, PackageDocumentBase.DCTags.date), (StringBuilder) ObjectUtil.checkNotNull(sb, "sb"));
    }
