...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/spdy/SpdyFrameEncoder.class */
public class SpdyFrameEncoder {
    ...
    public ByteBuf encodePingFrame(ByteBufAllocator allocator, int id) {
        ByteBuf frame = allocator.ioBuffer(8 + 4).order(ByteOrder.BIG_ENDIAN);
