...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/spdy/SpdyHttpEncoder.class */
public class SpdyHttpEncoder extends MessageToMessageEncoder<HttpObject> {
    ...
    private SpdySynStreamFrame createSynStreamFrame(HttpRequest httpRequest) throws Exception {
        ...
        httpHeaders.mo1933remove(SpdyHttpHeaders.Names.STREAM_ID);
        httpHeaders.mo1933remove(SpdyHttpHeaders.Names.ASSOCIATED_TO_STREAM_ID);
        httpHeaders.mo1933remove(SpdyHttpHeaders.Names.PRIORITY);
        httpHeaders.mo1933remove(SpdyHttpHeaders.Names.SCHEME);
        httpHeaders.mo1933remove(HttpHeaderNames.CONNECTION);
        httpHeaders.mo1934remove("Keep-Alive");
        httpHeaders.mo1934remove("Proxy-Connection");
        httpHeaders.mo1933remove(HttpHeaderNames.TRANSFER_ENCODING);
        ...
        httpHeaders.mo1933remove(HttpHeaderNames.HOST);
