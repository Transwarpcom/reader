...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/spdy/SpdyFrameDecoder.class */
public class SpdyFrameDecoder {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/spdy/SpdyFrameDecoder$State.class */
    private enum State {
        READ_COMMON_HEADER,
        READ_DATA_FRAME,
        ...
        while (true) {
            switch (this.state) {
                case READ_COMMON_HEADER:
                    ...
                    if (control) {
                        version = SpdyCodecUtil.getUnsignedShort(buffer, frameOffset) & ShortCompanionObject.MAX_VALUE;
