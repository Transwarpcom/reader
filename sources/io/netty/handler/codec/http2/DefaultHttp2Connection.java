...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection.class */
public class DefaultHttp2Connection implements Http2Connection {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$Event.class */
    interface Event {
        void process();
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$DefaultStream.class */
    private class DefaultStream implements Http2Stream {
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$DefaultStream$PropertyMap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$ConnectionStream.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$DefaultEndpoint.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$ActiveStreams.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$DefaultPropertyKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2Connection$PropertyKeyRegistry.class */
