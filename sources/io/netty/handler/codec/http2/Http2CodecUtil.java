...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2CodecUtil.class */
public final class Http2CodecUtil {
    ...
    private static final ByteBuf CONNECTION_PREFACE = Unpooled.unreleasableBuffer(Unpooled.directBuffer(24).writeBytes(Http1xOrH2CHandler.HTTP_2_PREFACE.getBytes(CharsetUtil.UTF_8))).asReadOnly();
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2CodecUtil$SimpleChannelPromiseAggregator.class */
