...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/HpackEncoder.class */
final class HpackEncoder {
    ...
    HpackEncoder(boolean ignoreMaxHeaderListSize, int arraySizeHint, int huffCodeThreshold) {
        ...
        this.maxHeaderTableSize = io.vertx.core.http.Http2Settings.DEFAULT_HEADER_TABLE_SIZE;
    ...
    private void encodeHeader(ByteBuf out, CharSequence name, CharSequence value, boolean sensitive, long headerSize) {
        ...
        int staticTableIndex2 = HpackStaticTable.getIndex(name, value);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/HpackEncoder$HeaderEntry.class */
