...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/HttpConversionUtil.class */
public final class HttpConversionUtil {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/HttpConversionUtil$ExtensionHeaderNames.class */
    ...
    public static void addHttp2ToHttpHeaders(int streamId, Http2Headers inputHeaders, HttpHeaders outputHeaders, HttpVersion httpVersion, boolean isTrailer, boolean isRequest) throws Http2Exception {
        ...
        try {
            ...
            outputHeaders.mo1933remove(HttpHeaderNames.TRANSFER_ENCODING);
            outputHeaders.mo1933remove(HttpHeaderNames.TRAILER);
            if (!isTrailer) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/HttpConversionUtil$Http2ToHttpHeaderTranslator.class */
