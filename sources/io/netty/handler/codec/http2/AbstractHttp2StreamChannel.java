...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/AbstractHttp2StreamChannel.class */
abstract class AbstractHttp2StreamChannel extends DefaultAttributeMap implements Http2StreamChannel {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/AbstractHttp2StreamChannel$ReadStatus.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/AbstractHttp2StreamChannel$FlowControlledFrameSizeEstimator.class */
    ...
    private void fireChannelWritabilityChanged(boolean invokeLater) {
        ...
        if (invokeLater) {
            ...
            if (task == null) {
                Runnable runnable = new Runnable() { // from class: io.netty.handler.codec.http2.AbstractHttp2StreamChannel.3
    ...
    void fireChildRead(Http2Frame frame) {
        ...
        if (this.readStatus != ReadStatus.IDLE) {
            ...
            this.flowControlledBytes += this.unsafe.doRead0(frame, allocHandle);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/AbstractHttp2StreamChannel$Http2ChannelUnsafe.class */
    private final class Http2ChannelUnsafe implements Channel.Unsafe {
        ...
        /* JADX WARN: Removed duplicated region for block: B:14:0x0069 A[PHI: r9
  0x0069: PHI (r9v2 'continueReading' boolean) = (r9v1 'continueReading' boolean), (r9v4 'continueReading' boolean) binds: [B:11:0x005b, B:13:0x0066] A[DONT_GENERATE, DONT_INLINE]] */
        /*
        ...
        */
        void doBeginRead() {
            ...
            L0:
                ...
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel$ReadStatus r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.access$1200(r0)
                ...
                r0 = r6
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.this
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel$Http2ChannelUnsafe r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.access$1300(r0)
                r0.closeForcibly()
                goto Lad
            L2a:
                r0 = r6
            ...
            L3e:
                ...
                r1 = r6
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel r1 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.this
                int r1 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.access$1400(r1)
                r2 = r6
                r3 = r7
                io.netty.handler.codec.http2.Http2Frame r3 = (io.netty.handler.codec.http2.Http2Frame) r3
                r4 = r8
                int r2 = r2.doRead0(r3, r4)
                int r1 = r1 + r2
                int r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.access$1402(r0, r1)
                r0 = r6
                boolean r0 = r0.readEOS
                if (r0 != 0) goto L69
                r0 = r8
            ...
            L72:
                ...
                r0 = r6
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.this
                boolean r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.access$500(r0)
                if (r0 != 0) goto Laa
                r0 = r6
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.this
                r1 = 1
                boolean r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.access$502(r0, r1)
                r0 = r6
                io.netty.handler.codec.http2.AbstractHttp2StreamChannel r0 = io.netty.handler.codec.http2.AbstractHttp2StreamChannel.this
                r0.addChannelToReadCompletePendingQueue()
                goto Laa
            La4:
                r0 = r6
                r1 = r8
        ...
        private void updateLocalWindowIfNeeded() {
            if (AbstractHttp2StreamChannel.this.flowControlledBytes != 0) {
                ...
                AbstractHttp2StreamChannel.this.write0(AbstractHttp2StreamChannel.this.parentContext(), new DefaultHttp2WindowUpdateFrame(bytes).stream((Http2FrameStream) AbstractHttp2StreamChannel.this.stream));
        ...
        public void write(Object msg, final ChannelPromise promise) {
            ...
            try {
                if (msg instanceof Http2StreamFrame) {
                    ...
                    ChannelFuture f2 = AbstractHttp2StreamChannel.this.write0(AbstractHttp2StreamChannel.this.parentContext(), msg);
                    if (!f2.isDone()) {
                        final long bytes2 = FlowControlledFrameSizeEstimator.HANDLE_INSTANCE.size(msg);
                        AbstractHttp2StreamChannel.this.incrementPendingOutboundBytes(bytes2, false);
                        f2.addListener2((GenericFutureListener<? extends Future<? super Void>>) new ChannelFutureListener() { // from class: io.netty.handler.codec.http2.AbstractHttp2StreamChannel.Http2ChannelUnsafe.4
                            @Override // io.netty.util.concurrent.GenericFutureListener
                            public void operationComplete(ChannelFuture future) {
                                Http2ChannelUnsafe.this.writeComplete(future, promise);
                                AbstractHttp2StreamChannel.this.decrementPendingOutboundBytes(bytes2, false);
                            }
                        });
                        this.writeDoneAndNoFlush = true;
                    } else {
                        writeComplete(f2, promise);
                    }
                    return;
                }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/AbstractHttp2StreamChannel$Http2StreamChannelConfig.class */
