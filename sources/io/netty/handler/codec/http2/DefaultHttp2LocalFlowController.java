...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2LocalFlowController.class */
public class DefaultHttp2LocalFlowController implements Http2LocalFlowController {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2LocalFlowController$FlowState.class */
    ...
    public boolean consumeBytes(Http2Stream stream, int numBytes) throws Http2Exception {
        ...
        if (numBytes != 0 && stream != null && !isClosed(stream)) {
            ...
            return windowUpdateSent | state(stream).consumeBytes(numBytes);
        }
        return false;
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2LocalFlowController$AutoRefillState.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2LocalFlowController$DefaultState.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2LocalFlowController$WindowUpdateVisitor.class */
