...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2ClientUpgradeCodec.class */
public class Http2ClientUpgradeCodec implements HttpClientUpgradeHandler.UpgradeCodec {
    ...
    private CharSequence getSettingsHeaderValue(ChannelHandlerContext ctx) {
        ...
        try {
            ...
            String string = encodedBuf.toString(CharsetUtil.UTF_8);
