...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2FrameCodec.class */
public class Http2FrameCodec extends Http2ConnectionHandler {
    ...
    private final ChannelFutureListener bufferedStreamsListener;
    ...
    static /* synthetic */ int access$010(Http2FrameCodec x0) {
    ...
    Http2FrameCodec(Http2ConnectionEncoder encoder, Http2ConnectionDecoder decoder, Http2Settings initialSettings, boolean decoupleCloseAndGoAway) {
        ...
        this.bufferedStreamsListener = new ChannelFutureListener() { // from class: io.netty.handler.codec.http2.Http2FrameCodec.1
            @Override // io.netty.util.concurrent.GenericFutureListener
            public void operationComplete(ChannelFuture future) {
                Http2FrameCodec.access$010(Http2FrameCodec.this);
            }
        };
    ...
    final void forEachActiveStream(final Http2FrameStreamVisitor streamVisitor) throws Http2Exception {
        ...
        if (connection().numActiveStreams() > 0) {
            connection().forEachActiveStream(new Http2StreamVisitor() { // from class: io.netty.handler.codec.http2.Http2FrameCodec.2
    ...
    public final void userEventTriggered(final ChannelHandlerContext ctx, final Object evt) throws Exception {
        if (evt == Http2ConnectionPrefaceAndSettingsFrameWrittenEvent.INSTANCE) {
            tryExpandConnectionFlowControlWindow(connection());
            ctx.executor().execute(new Runnable() { // from class: io.netty.handler.codec.http2.Http2FrameCodec.3
    ...
    private void writeHeadersFrame(ChannelHandlerContext ctx, Http2HeadersFrame headersFrame, ChannelPromise promise) {
        ...
        if (!promise.isDone()) {
            ...
            promise.addListener2((GenericFutureListener<? extends Future<? super Void>>) this.bufferedStreamsListener);
        }
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2FrameCodec$ConnectionListener.class */
    ...
    private void onHttp2UnknownStreamError(ChannelHandlerContext ctx, Throwable cause, Http2Exception.StreamException streamException) {
        LOG.warn("Stream exception thrown for unknown stream {}.", Integer.valueOf(streamException.streamId()), cause);
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2FrameCodec$FrameListener.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2FrameCodec$Http2RemoteFlowControllerListener.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/Http2FrameCodec$DefaultHttp2FrameStream.class */
