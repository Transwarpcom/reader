...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/DefaultHttp2UnknownFrame.class */
public final class DefaultHttp2UnknownFrame extends DefaultByteBufHolder implements Http2UnknownFrame {
    ...
    public boolean equals(Object o) {
        ...
        return (super.equals(other) && flags().equals(other.flags()) && frameType() == other.frameType() && stream() == null && other.stream() == null) || stream().equals(other.stream());
    }

    @Override // io.netty.buffer.DefaultByteBufHolder
    public int hashCode() {
        int hash = super.hashCode();
        int hash2 = (((hash * 31) + frameType()) * 31) + flags().hashCode();
        if (stream() != null) {
            hash2 = (hash2 * 31) + stream().hashCode();
        }
        return hash2;
    }
}
