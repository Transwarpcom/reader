...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http2-4.1.42.Final.jar:io/netty/handler/codec/http2/InboundHttpToHttp2Adapter.class */
public class InboundHttpToHttp2Adapter extends ChannelInboundHandlerAdapter {
    ...
    static void handle(ChannelHandlerContext ctx, Http2Connection connection, Http2FrameListener listener, FullHttpMessage message) throws Http2Exception {
        try {
            ...
            listener.onHeadersRead(ctx, streamId, messageHeaders, 0, (hasContent || hasTrailers) ? false : true);
            if (hasContent) {
