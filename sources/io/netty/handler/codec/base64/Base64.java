...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/base64/Base64.class */
public final class Base64 {
    ...
    public static ByteBuf encode(ByteBuf src, boolean breakLines, Base64Dialect dialect) {
        if (src == null) {
            throw new NullPointerException(NCXDocumentV2.NCXAttributes.src);
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/base64/Base64$Decoder.class */
    private static final class Decoder implements ByteProcessor {
        ...
        public boolean process(byte value) throws Exception {
            ...
            if (this.sbiDecode >= Base64.WHITE_SPACE_ENC) {
                if (this.sbiDecode >= -1) {
                    byte[] bArr = this.b4;
                    int i = this.b4Posn;
                    this.b4Posn = i + 1;
            ...
            throw new IllegalArgumentException("invalid bad Base64 input character: " + ((int) ((short) (value & 255))) + " (decimal)");
        }
