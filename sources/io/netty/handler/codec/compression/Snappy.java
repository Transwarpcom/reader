...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/compression/Snappy.class */
public final class Snappy {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/compression/Snappy$State.class */
    private enum State {
        READY,
        READING_PREAMBLE,
        READING_TAG,
    ...
    */
    ...
    static int calculateChecksum(ByteBuf data, int offset, int length) {
        ...
        try {
            ...
            int iMaskChecksum = maskChecksum((int) crc32.getValue());
            crc32.reset();
