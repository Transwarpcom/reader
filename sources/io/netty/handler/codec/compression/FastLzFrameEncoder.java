...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/compression/FastLzFrameEncoder.class */
        ...
        while (in.isReadable()) {
            ...
            if (length < 32) {
                ...
                if (checksum != null) {
                    ...
                    System.arraycopy(input2, inputPtr2, output, outputPtr, length);
                } else {
                ...
                int outputPtr2 = out.arrayOffset() + outputOffset + 4;
                int compressedLength = FastLz.compress(input, inputPtr, length, output2, outputPtr2, this.level);
                if (compressedLength < length) {
                    ...
                    blockType = 0;
                    System.arraycopy(input, inputPtr, output2, outputPtr2 - 2, length);
                    chunkLength = length;
                }
            }
            out.setShort(outputOffset, length);
            out.setByte(outputIdx + 3, blockType | (checksum != null ? (byte) 16 : (byte) 0));
