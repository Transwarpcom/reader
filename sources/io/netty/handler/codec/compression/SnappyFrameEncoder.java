...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/compression/SnappyFrameEncoder.class */
public class SnappyFrameEncoder extends MessageToByteEncoder<ByteBuf> {
    ...
    public void encode(ChannelHandlerContext ctx, ByteBuf in, ByteBuf out) throws Exception {
        ...
        while (true) {
            ...
            out.writeInt(0);
            if (dataLength > 32767) {
                ByteBuf slice = in.readSlice(ShortCompanionObject.MAX_VALUE);
                calculateAndWriteChecksum(slice, out);
                this.snappy.encode(slice, out, ShortCompanionObject.MAX_VALUE);
