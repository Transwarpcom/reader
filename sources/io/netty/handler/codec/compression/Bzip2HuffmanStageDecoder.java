...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-4.1.42.Final.jar:io/netty/handler/codec/compression/Bzip2HuffmanStageDecoder.class */
final class Bzip2HuffmanStageDecoder {
    ...
    Bzip2HuffmanStageDecoder(Bzip2BitReader reader, int totalTables, int alphabetSize) {
        ...
        this.codeSymbols = new int[totalTables][WGL4Names.NUMBER_OF_MAC_GLYPHS];
        this.tableCodeLengths = new byte[totalTables][WGL4Names.NUMBER_OF_MAC_GLYPHS];
    }
