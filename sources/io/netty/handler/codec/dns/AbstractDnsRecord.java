...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-dns-4.1.42.Final.jar:io/netty/handler/codec/dns/AbstractDnsRecord.class */
public abstract class AbstractDnsRecord implements DnsRecord {
    ...
    public boolean equals(Object obj) {
        ...
        return (hashCode == 0 || hashCode == that.hashCode()) && type().intValue() == that.type().intValue() && dnsClass() == that.dnsClass() && name().equals(that.name());
    }
    ...
    public int hashCode() {
        ...
        int iHashCode = (this.name.hashCode() * 31) + (type().intValue() * 31) + dnsClass();
