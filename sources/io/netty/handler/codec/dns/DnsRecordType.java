...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-dns-4.1.42.Final.jar:io/netty/handler/codec/dns/DnsRecordType.class */
public class DnsRecordType implements Comparable<DnsRecordType> {
    ...
    public static final DnsRecordType RP = new DnsRecordType(17, StandardStructureTypes.RP);
