...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpHeaderNames.class */
public final class HttpHeaderNames {
    ...
    public static final AsciiString DATE = AsciiString.cached(PackageDocumentBase.DCTags.date);
    ...
    public static final AsciiString FROM = AsciiString.cached(FromBasedConverter.FROM);
