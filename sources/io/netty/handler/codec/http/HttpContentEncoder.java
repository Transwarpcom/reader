...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpContentEncoder.class */
public abstract class HttpContentEncoder extends MessageToMessageCodec<HttpRequest, HttpObject> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpContentEncoder$State.class */
    private enum State {
        PASS_THROUGH,
        AWAIT_HEADERS,
        AWAIT_CONTENT
    ...
    protected void encode2(ChannelHandlerContext ctx, HttpObject msg, List<Object> out) throws Exception {
        ...
        switch (this.state) {
            case AWAIT_HEADERS:
                ...
                res.headers().mo1933remove(HttpHeaderNames.CONTENT_LENGTH);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpContentEncoder$Result.class */
