...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpContentCompressor.class */
public class HttpContentCompressor extends HttpContentEncoder {
    ...
    protected HttpContentEncoder.Result beginEncode(HttpResponse headers, String acceptEncoding) throws Exception {
        ...
        if (contentEncoding != null || (wrapper = determineWrapper(acceptEncoding)) == null) {
            return null;
        }
        switch (wrapper) {
            case GZIP:
    ...
    protected ZlibWrapper determineWrapper(String acceptEncoding) throws NumberFormatException {
        float starQ = -1.0f;
        float gzipQ = -1.0f;
        float deflateQ = -1.0f;
