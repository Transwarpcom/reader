...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpHeaders.class */
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    @Deprecated
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpHeaders$Names.class */
    ...
    @Deprecated
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpHeaders$Values.class */
    ...
    private static boolean containsCommaSeparatedTrimmed(CharSequence rawNext, CharSequence expected, boolean ignoreCase) {
        int begin = 0;
        if (ignoreCase) {
            int iIndexOf = AsciiString.indexOf(rawNext, ',', 0);
            int end = iIndexOf;
            if (iIndexOf == -1) {
            ...
            while (!AsciiString.contentEqualsIgnoreCase(AsciiString.trim(rawNext.subSequence(begin, end)), expected)) {
                begin = end + 1;
                int iIndexOf2 = AsciiString.indexOf(rawNext, ',', begin);
                end = iIndexOf2;
                if (iIndexOf2 == -1) {
        ...
        int iIndexOf3 = AsciiString.indexOf(rawNext, ',', 0);
        int end2 = iIndexOf3;
        if (iIndexOf3 == -1) {
        ...
        while (!AsciiString.contentEquals(AsciiString.trim(rawNext.subSequence(begin, end2)), expected)) {
            begin = end2 + 1;
            int iIndexOf4 = AsciiString.indexOf(rawNext, ',', begin);
            end2 = iIndexOf4;
            if (iIndexOf4 == -1) {
