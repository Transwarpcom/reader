...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpServerExpectContinueHandler.class */
        ...
        if (msg instanceof HttpRequest) {
            ...
            if (HttpUtil.is100ContinueExpected(req)) {
                ...
                if (accept == null) {
                    ...
                    ctx.writeAndFlush(rejection).addListener2((GenericFutureListener<? extends Future<? super Void>>) ChannelFutureListener.CLOSE_ON_FAILURE);
                    return;
                }
                ctx.writeAndFlush(accept).addListener2((GenericFutureListener<? extends Future<? super Void>>) ChannelFutureListener.CLOSE_ON_FAILURE);
                req.headers().mo1933remove(HttpHeaderNames.EXPECT);
            }
        }
