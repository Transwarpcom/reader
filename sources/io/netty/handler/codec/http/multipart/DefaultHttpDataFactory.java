...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/DefaultHttpDataFactory.class */
public class DefaultHttpDataFactory implements HttpDataFactory {
    ...
    public Attribute createAttribute(HttpRequest request, String name) {
        ...
        if (this.checkSize) {
            Attribute attribute2 = new MixedAttribute(name, this.minSize, this.charset);
    ...
    public Attribute createAttribute(HttpRequest request, String name, long definedSize) {
        ...
        if (this.checkSize) {
            Attribute attribute2 = new MixedAttribute(name, definedSize, this.minSize, this.charset);
            attribute2.setMaxSize(this.maxSize);
            List<HttpData> list2 = getList(request);
            list2.add(attribute2);
            return attribute2;
    ...
    public Attribute createAttribute(HttpRequest request, String name, String value) {
        ...
        if (this.checkSize) {
            Attribute attribute2 = new MixedAttribute(name, value, this.minSize, this.charset);
            attribute2.setMaxSize(this.maxSize);
