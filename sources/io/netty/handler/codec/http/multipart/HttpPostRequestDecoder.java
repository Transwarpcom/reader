...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestDecoder.class */
public class HttpPostRequestDecoder implements InterfaceHttpPostRequestDecoder {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestDecoder$EndOfDataDecoderException.class */
    public static class EndOfDataDecoderException extends DecoderException {
        private static final long serialVersionUID = 1336267941020800769L;
    }

    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestDecoder$MultiPartStatus.class */
    ...
    protected static String[] getMultipartDataBoundary(String contentType) {
        ...
        if (headerContentType[0].regionMatches(true, 0, multiPartHeader, 0, multiPartHeader.length())) {
            ...
            if (headerContentType[crank].regionMatches(true, 0, charsetHeader, 0, charsetHeader.length()) && (charset = StringUtil.substringAfter(headerContentType[crank], '=')) != null) {
                return new String[]{UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX + boundary, charset};
            }
            return new String[]{UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX + boundary};
        }
        return null;
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestDecoder$NotEnoughDataDecoderException.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestDecoder$ErrorDataDecoderException.class */
