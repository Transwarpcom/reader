...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestEncoder.class */
public class HttpPostRequestEncoder implements ChunkedInput<HttpContent> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestEncoder$EncoderMode.class */
    ...
    public void addBodyHttpData(InterfaceHttpData data) throws ErrorDataEncoderException, UnsupportedEncodingException {
        ...
        if (data instanceof Attribute) {
            if (this.duringMixedMode) {
                ...
                internal.addValue("\r\n--" + this.multipartMixedBoundary + UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX);
            ...
            if (!this.multipartHttpDatas.isEmpty()) {
                internal2.addValue(StrPool.CRLF);
            }
            internal2.addValue(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX + this.multipartDataBoundary + StrPool.CRLF);
            ...
            internal2.addValue(((Object) HttpHeaderNames.CONTENT_LENGTH) + ": " + attribute2.length() + StrPool.CRLF);
            Charset localcharset = attribute2.getCharset();
            if (localcharset != null) {
                internal2.addValue(((Object) HttpHeaderNames.CONTENT_TYPE) + ": text/plain; " + ((Object) HttpHeaderValues.CHARSET) + '=' + localcharset.name() + StrPool.CRLF);
            }
            internal2.addValue(StrPool.CRLF);
        ...
        if (data instanceof FileUpload) {
            ...
            if (!this.multipartHttpDatas.isEmpty()) {
                internal3.addValue(StrPool.CRLF);
            }
            if (this.duringMixedMode) {
                if (this.currentFileUpload != null && this.currentFileUpload.getName().equals(fileUpload2.getName())) {
                    localMixed = true;
                } else {
                    internal3.addValue(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX + this.multipartMixedBoundary + UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX);
                ...
                StringBuilder replacement = new StringBuilder(139 + this.multipartDataBoundary.length() + (this.multipartMixedBoundary.length() * 2) + fileUpload2.getFilename().length() + fileUpload2.getName().length()).append(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX).append(this.multipartDataBoundary).append(StrPool.CRLF).append((CharSequence) HttpHeaderNames.CONTENT_DISPOSITION).append(": ").append((CharSequence) HttpHeaderValues.FORM_DATA).append("; ").append((CharSequence) HttpHeaderValues.NAME).append("=\"").append(fileUpload2.getName()).append("\"\r\n").append((CharSequence) HttpHeaderNames.CONTENT_TYPE).append(": ").append((CharSequence) HttpHeaderValues.MULTIPART_MIXED).append("; ").append((CharSequence) HttpHeaderValues.BOUNDARY).append('=').append(this.multipartMixedBoundary).append("\r\n\r\n").append(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX).append(this.multipartMixedBoundary).append(StrPool.CRLF).append((CharSequence) HttpHeaderNames.CONTENT_DISPOSITION).append(": ").append((CharSequence) HttpHeaderValues.ATTACHMENT);
                ...
                replacement.append(StrPool.CRLF);
            ...
            if (localMixed) {
                internal3.addValue(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX + this.multipartMixedBoundary + StrPool.CRLF);
                if (fileUpload2.getFilename().isEmpty()) {
                    internal3.addValue(((Object) HttpHeaderNames.CONTENT_DISPOSITION) + ": " + ((Object) HttpHeaderValues.ATTACHMENT) + StrPool.CRLF);
                } else {
                ...
                internal3.addValue(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX + this.multipartDataBoundary + StrPool.CRLF);
                if (fileUpload2.getFilename().isEmpty()) {
            ...
            internal3.addValue(((Object) HttpHeaderNames.CONTENT_LENGTH) + ": " + fileUpload2.length() + StrPool.CRLF);
            ...
            if (contentTransferEncoding != null && contentTransferEncoding.equals(HttpPostBodyUtil.TransferEncodingMechanism.BINARY.value())) {
                internal3.addValue(StrPool.CRLF + ((Object) HttpHeaderNames.CONTENT_TRANSFER_ENCODING) + ": " + HttpPostBodyUtil.TransferEncodingMechanism.BINARY.value() + "\r\n\r\n");
    ...
    public HttpRequest finalizeRequest() throws ErrorDataEncoderException {
        if (!this.headerFinalized) {
            ...
            if (contentTypes != null) {
                headers.mo1933remove(HttpHeaderNames.CONTENT_TYPE);
            ...
            if (realSize > 8096 || this.isMultipart) {
                ...
                if (transferEncoding != null) {
                    headers.mo1933remove(HttpHeaderNames.TRANSFER_ENCODING);
    ...
    private HttpContent encodeNextChunkUrlEncoded(int sizeleft) throws ErrorDataEncoderException {
        ...
        try {
            ...
            if (buffer2.readableBytes() < size) {
                this.isKey = true;
                delimiter = this.iterator.hasNext() ? Unpooled.wrappedBuffer(BeanFactory.FACTORY_BEAN_PREFIX.getBytes()) : null;
            }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestEncoder$ErrorDataEncoderException.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestEncoder$WrappedHttpRequest.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/HttpPostRequestEncoder$WrappedFullHttpRequest.class */
