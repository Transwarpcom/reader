...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/multipart/AbstractDiskHttpData.class */
public abstract class AbstractDiskHttpData extends AbstractHttpData {
    ...
    public ByteBuf getChunk(int length) throws IOException {
        ...
        if (this.fileChannel == null) {
            RandomAccessFile accessFile = new RandomAccessFile(this.file, PDPageLabelRange.STYLE_ROMAN_LOWER);
            this.fileChannel = accessFile.getChannel();
        }
        int read = 0;
    ...
    public boolean renameTo(File dest) throws IOException {
        ...
        long position = 0;
        try {
            inputAccessFile = new RandomAccessFile(this.file, PDPageLabelRange.STYLE_ROMAN_LOWER);
    ...
    private static byte[] readFrom(File src) throws IOException {
        ...
        RandomAccessFile accessFile = new RandomAccessFile(src, PDPageLabelRange.STYLE_ROMAN_LOWER);
