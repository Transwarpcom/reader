...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpResponseStatus.class */
public class HttpResponseStatus implements Comparable<HttpResponseStatus> {
    ...
    public static final HttpResponseStatus CREATED = newStatus(ByteCode.JSR_W, "Created");
    public static final HttpResponseStatus ACCEPTED = newStatus(ByteCode.BREAKPOINT, "Accepted");
    ...
    public static final HttpResponseStatus MULTIPLE_CHOICES = newStatus(OS2WindowsMetricsTable.WEIGHT_CLASS_LIGHT, "Multiple Choices");
    ...
    public static final HttpResponseStatus BAD_REQUEST = newStatus(OS2WindowsMetricsTable.WEIGHT_CLASS_NORMAL, "Bad Request");
    ...
    public static final HttpResponseStatus SERVICE_UNAVAILABLE = newStatus(TimeoutHandler.DEFAULT_ERRORCODE, "Service Unavailable");
    ...
    private static HttpResponseStatus valueOf0(int code) {
        switch (code) {
            ...
            case 502:
                return BAD_GATEWAY;
            case TimeoutHandler.DEFAULT_ERRORCODE /* 503 */:
