...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpContentDecoder.class */
        ...
        try {
            ...
            if (msg instanceof HttpMessage) {
                ...
                if (headers.contains(HttpHeaderNames.CONTENT_LENGTH)) {
                    headers.mo1933remove(HttpHeaderNames.CONTENT_LENGTH);
                    headers.set(HttpHeaderNames.TRANSFER_ENCODING, HttpHeaderValues.CHUNKED);
                }
                CharSequence targetContentEncoding = getTargetContentEncoding(contentEncoding2);
                if (HttpHeaderValues.IDENTITY.contentEquals(targetContentEncoding)) {
                    headers.mo1933remove(HttpHeaderNames.CONTENT_ENCODING);
                } else {
