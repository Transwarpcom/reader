...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpObjectAggregator.class */
public class HttpObjectAggregator extends MessageAggregator<HttpObject, HttpMessage, HttpContent, FullHttpMessage> {
    ...
    public Object newContinueResponse(HttpMessage start, int maxContentLength, ChannelPipeline pipeline) {
        ...
        if (response != null) {
            start.headers().mo1933remove(HttpHeaderNames.EXPECT);
        }
        return response;
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpObjectAggregator$AggregatedFullHttpMessage.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpObjectAggregator$AggregatedFullHttpRequest.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpObjectAggregator$AggregatedFullHttpResponse.class */
