...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpMethod.class */
public class HttpMethod implements Comparable<HttpMethod> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpMethod$EnumNameMap.class */
    private static final class EnumNameMap<T> {
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-http-4.1.42.Final.jar:io/netty/handler/codec/http/HttpMethod$EnumNameMap$Node.class */
