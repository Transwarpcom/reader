...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v5/Socks5CommandRequestDecoder.class */
public class Socks5CommandRequestDecoder extends ReplayingDecoder<State> {
    private final Socks5AddressDecoder addressDecoder;

    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v5/Socks5CommandRequestDecoder$State.class */
    enum State {
        INIT,
        SUCCESS,
        FAILURE
    ...
    */
    protected void decode(io.netty.channel.ChannelHandlerContext r9, io.netty.buffer.ByteBuf r10, java.util.List<java.lang.Object> r11) throws java.lang.Exception {
        /*
            r8 = this;
            int[] r0 = io.netty.handler.codec.socksx.v5.Socks5CommandRequestDecoder.AnonymousClass1.$SwitchMap$io$netty$handler$codec$socksx$v5$Socks5CommandRequestDecoder$State     // Catch: java.lang.Exception -> Ld8
            r1 = r8
            java.lang.Object r1 = r1.state()     // Catch: java.lang.Exception -> Ld8
            io.netty.handler.codec.socksx.v5.Socks5CommandRequestDecoder$State r1 = (io.netty.handler.codec.socksx.v5.Socks5CommandRequestDecoder.State) r1     // Catch: java.lang.Exception -> Ld8
        ...
        L68:
            r0 = r10
            byte r0 = r0.readByte()     // Catch: java.lang.Exception -> Ld8
            io.netty.handler.codec.socksx.v5.Socks5CommandType r0 = io.netty.handler.codec.socksx.v5.Socks5CommandType.valueOf(r0)     // Catch: java.lang.Exception -> Ld8
            r13 = r0
            r0 = r10
            r1 = 1
            ...
            r16 = r0
            r0 = r11
            io.netty.handler.codec.socksx.v5.DefaultSocks5CommandRequest r1 = new io.netty.handler.codec.socksx.v5.DefaultSocks5CommandRequest     // Catch: java.lang.Exception -> Ld8
            r2 = r1
            r3 = r13
            r4 = r14
            r5 = r15
            ...
            r0 = r8
            io.netty.handler.codec.socksx.v5.Socks5CommandRequestDecoder$State r1 = io.netty.handler.codec.socksx.v5.Socks5CommandRequestDecoder.State.SUCCESS     // Catch: java.lang.Exception -> Ld8
    ...
    private void fail(List<Object> out, Exception cause) {
        ...
        Socks5Message m = new DefaultSocks5CommandRequest(Socks5CommandType.CONNECT, Socks5AddressType.IPv4, NetServerOptions.DEFAULT_HOST, 1);
