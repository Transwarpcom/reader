...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v5/Socks5PasswordAuthResponseDecoder.class */
public class Socks5PasswordAuthResponseDecoder extends ReplayingDecoder<State> {

    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v5/Socks5PasswordAuthResponseDecoder$State.class */
    enum State {
        INIT,
        SUCCESS,
        FAILURE
