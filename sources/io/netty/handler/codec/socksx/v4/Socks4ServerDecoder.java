...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v4/Socks4ServerDecoder.class */
public class Socks4ServerDecoder extends ReplayingDecoder<State> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v4/Socks4ServerDecoder$State.class */
    enum State {
        START,
        READ_USERID,
        READ_DOMAIN,
