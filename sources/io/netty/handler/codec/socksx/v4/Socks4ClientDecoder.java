...
/* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v4/Socks4ClientDecoder.class */
public class Socks4ClientDecoder extends ReplayingDecoder<State> {

    /* loaded from: reader.jar:BOOT-INF/lib/netty-codec-socks-4.1.42.Final.jar:io/netty/handler/codec/socksx/v4/Socks4ClientDecoder$State.class */
    enum State {
        START,
        SUCCESS,
        FAILURE
