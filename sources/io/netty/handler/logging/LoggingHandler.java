...
/* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/logging/LoggingHandler.class */
public class LoggingHandler extends ChannelDuplexHandler {
    ...
    private static String formatByteBuf(ChannelHandlerContext ctx, String eventName, ByteBuf msg) {
        ...
        StringBuilder buf2 = new StringBuilder(chStr.length() + 1 + eventName.length() + 2 + 10 + 1 + 2 + (rows * 80));
    ...
    private static String formatByteBufHolder(ChannelHandlerContext ctx, String eventName, ByteBufHolder msg) {
        ...
        int rows = (length / 16) + (length % 15 == 0 ? 0 : 1) + 4;
        StringBuilder buf2 = new StringBuilder(chStr.length() + 1 + eventName.length() + 2 + msgStr.length() + 2 + 10 + 1 + 2 + (rows * 80));
