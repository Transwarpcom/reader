...
/* loaded from: reader.jar:BOOT-INF/lib/netty-handler-4.1.42.Final.jar:io/netty/handler/stream/ChunkedNioFile.class */
public class ChunkedNioFile implements ChunkedInput<ByteBuf> {
    ...
    public ChunkedNioFile(File in) throws IOException {
        this(new RandomAccessFile(in, PDPageLabelRange.STYLE_ROMAN_LOWER).getChannel());
    }

    public ChunkedNioFile(File in, int chunkSize) throws IOException {
        this(new RandomAccessFile(in, PDPageLabelRange.STYLE_ROMAN_LOWER).getChannel(), chunkSize);
    }
