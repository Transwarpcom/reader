...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/AbstractByteBuf.class */
public abstract class AbstractByteBuf extends ByteBuf {
    ...
    final void ensureWritable0(int minWritableBytes) {
        ...
        int newCapacity = alloc().calculateNewCapacity(minNewCapacity, this.maxCapacity);
    ...
    private int firstIndexOf(int fromIndex, int toIndex, byte value) {
        ...
        if (fromIndex2 >= toIndex || capacity() == 0) {
            return -1;
        }
        checkIndex(fromIndex2, toIndex - fromIndex2);
    ...
    private int lastIndexOf(int fromIndex, int toIndex, byte value) {
        ...
        checkIndex(toIndex, fromIndex2 - toIndex);
    ...
    protected final void checkReadableBytes(int minimumReadableBytes) {
        ObjectUtil.checkPositiveOrZero(minimumReadableBytes, "minimumReadableBytes");
