...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/ByteBufUtil.class */
public final class ByteBufUtil {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/ByteBufUtil$HexUtil.class */
    private static final class HexUtil {
        ...
        public static String hexDump(ByteBuf buffer, int fromIndex, int length) {
            ObjectUtil.checkPositiveOrZero(length, Length.TOKEN_NAME);
            if (length == 0) {
                return "";
            }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/ByteBufUtil$ThreadLocalUnsafeDirectByteBuf.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/ByteBufUtil$ThreadLocalDirectByteBuf.class */
