...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolThreadCache.class */
final class PoolThreadCache {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolThreadCache$SubPageMemoryRegionCache.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolThreadCache$NormalMemoryRegionCache.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolThreadCache$MemoryRegionCache.class */
    private static abstract class MemoryRegionCache<T> {
        ...
        protected abstract void initBuf(PoolChunk<T> poolChunk, ByteBuffer byteBuffer, long j, PooledByteBuf<T> pooledByteBuf, int i);
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolThreadCache$MemoryRegionCache$Entry.class */
