...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PooledByteBuf.class */
abstract class PooledByteBuf<T> extends AbstractReferenceCountedByteBuf {
    ...
    protected PooledByteBuf(Recycler.Handle<? extends PooledByteBuf<T>> handle, int maxCapacity) {
        super(maxCapacity);
