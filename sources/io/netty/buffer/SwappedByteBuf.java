...
@Deprecated
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/SwappedByteBuf.class */
public class SwappedByteBuf extends ByteBuf {
    ...
    public int getUnsignedMedium(int index) {
        return getMedium(index) & Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND;
    }

    @Override // io.netty.buffer.ByteBuf
    public int getUnsignedMediumLE(int index) {
        return getMediumLE(index) & Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND;
    }
