...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolArena.class */
abstract class PoolArena<T> implements PoolArenaMetric {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolArena$SizeClass.class */
    enum SizeClass {
        Tiny,
        Small,
        Normal
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolArena$HeapArena.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/PoolArena$DirectArena.class */
