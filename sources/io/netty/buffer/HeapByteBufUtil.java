...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/HeapByteBufUtil.class */
final class HeapByteBufUtil {
    ...
    static long getLong(byte[] memory, int index) {
        return ((memory[index] & 255) << 56) | ((memory[index + 1] & 255) << 48) | ((memory[index + 2] & 255) << 40) | ((memory[index + 3] & 255) << 32) | ((memory[index + 4] & 255) << 24) | ((memory[index + 5] & 255) << 16) | ((memory[index + 6] & 255) << 8) | (memory[index + 7] & 255);
    }

    static long getLongLE(byte[] memory, int index) {
        return (memory[index] & 255) | ((memory[index + 1] & 255) << 8) | ((memory[index + 2] & 255) << 16) | ((memory[index + 3] & 255) << 24) | ((memory[index + 4] & 255) << 32) | ((memory[index + 5] & 255) << 40) | ((memory[index + 6] & 255) << 48) | ((memory[index + 7] & 255) << 56);
    }
