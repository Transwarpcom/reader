...
/* loaded from: reader.jar:BOOT-INF/lib/netty-buffer-4.1.42.Final.jar:io/netty/buffer/AbstractByteBufAllocator.class */
public abstract class AbstractByteBufAllocator implements ByteBufAllocator {
    ...
    public int calculateNewCapacity(int minNewCapacity, int maxCapacity) {
        ...
        if (minNewCapacity > CALCULATE_THRESHOLD) {
            int newCapacity2 = (minNewCapacity / CALCULATE_THRESHOLD) * CALCULATE_THRESHOLD;
            if (newCapacity2 > maxCapacity - CALCULATE_THRESHOLD) {
                newCapacity = maxCapacity;
            } else {
                newCapacity = newCapacity2 + CALCULATE_THRESHOLD;
            }
            return newCapacity;
        }
        int i = 64;
