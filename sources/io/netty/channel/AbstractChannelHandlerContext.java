...
/* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/AbstractChannelHandlerContext.class */
abstract class AbstractChannelHandlerContext implements ChannelHandlerContext, ResourceLeakHint {
    ...
    static void invokeUserEventTriggered(AbstractChannelHandlerContext next, final Object event) {
        ObjectUtil.checkNotNull(event, PackageDocumentBase.OPFAttributes.event);
        EventExecutor executor = next.executor();
        if (executor.inEventLoop()) {
    ...
    private static boolean inExceptionCaught(Throwable cause) {
        ...
        do {
            ...
            if (trace != null) {
                ...
                for (int i = 0; i < length && (t = trace[i]) != null; i++) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/AbstractChannelHandlerContext$AbstractWriteTask.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/AbstractChannelHandlerContext$WriteTask.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/AbstractChannelHandlerContext$WriteAndFlushTask.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/AbstractChannelHandlerContext$Tasks.class */
