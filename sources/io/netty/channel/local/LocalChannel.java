...
/* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/local/LocalChannel.class */
public class LocalChannel extends AbstractChannel {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/local/LocalChannel$State.class */
    private enum State {
        OPEN,
        BOUND,
        CONNECTED,
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/local/LocalChannel$LocalUnsafe.class */
