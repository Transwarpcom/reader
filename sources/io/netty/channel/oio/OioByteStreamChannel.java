...
@Deprecated
/* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/oio/OioByteStreamChannel.class */
public abstract class OioByteStreamChannel extends AbstractOioByteChannel {
    ...
    protected final void activate(InputStream is, OutputStream os) {
        ...
        if (is == null) {
            throw new NullPointerException(BeanUtil.PREFIX_GETTER_IS);
        }
        if (os == null) {
