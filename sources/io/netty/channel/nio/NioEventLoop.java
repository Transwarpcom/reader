...
/* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/nio/NioEventLoop.class */
public final class NioEventLoop extends SingleThreadEventLoop {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/nio/NioEventLoop$SelectorTuple.class */
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x0088 A[Catch: Throwable -> 0x00c9, TryCatch #4 {Throwable -> 0x00c9, blocks: (B:2:0x0000, B:3:0x0011, B:5:0x002f, B:7:0x0045, B:11:0x005c, B:13:0x0071, B:14:0x0076, B:19:0x0088, B:20:0x008c, B:21:0x0093, B:23:0x00ac, B:24:0x00af, B:25:0x00c5, B:16:0x007e, B:17:0x0084, B:10:0x0051), top: B:41:0x0000, inners: #0, #2, #3 }] */
    ...
    */
    ...
    protected boolean beforeScheduledTaskSubmitted(long deadlineNanos) {
        return deadlineNanos < this.nextWakeupTime;
    }
    ...
    private void select(boolean oldWakenUp) throws IOException {
        ...
        try {
            ...
            while (true) {
                long timeoutMillis = ((selectDeadLineNanos - currentTimeNanos) + 500000) / StaticHandler.DEFAULT_MAX_AVG_SERVE_TIME_NS;
                if (timeoutMillis <= 0) {
                    if (selectCnt == 0) {
                        selector.selectNow();
                        selectCnt = 1;
            ...
            if (selectCnt > 3 && logger.isDebugEnabled()) {
                logger.debug("Selector.select() returned prematurely {} times in a row for Selector {}.", Integer.valueOf(selectCnt - 1), selector);
            }
        } catch (CancelledKeyException e) {
            if (logger.isDebugEnabled()) {
