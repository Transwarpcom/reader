...
/* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/socket/nio/NioServerSocketChannel.class */
public class NioServerSocketChannel extends AbstractNioMessageChannel implements ServerSocketChannel {
    ...
    protected int doReadMessages(List<Object> buf) throws Exception {
        SocketChannel ch2 = SocketUtils.accept(javaChannel());
        if (ch2 != null) {
            try {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/socket/nio/NioServerSocketChannel$NioServerSocketChannelConfig.class */
