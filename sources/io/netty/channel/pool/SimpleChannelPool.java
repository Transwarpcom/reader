...
/* loaded from: reader.jar:BOOT-INF/lib/netty-transport-4.1.42.Final.jar:io/netty/channel/pool/SimpleChannelPool.class */
public class SimpleChannelPool implements ChannelPool {
    private final AttributeKey<SimpleChannelPool> poolKey;
    ...
    public SimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler handler, ChannelHealthChecker healthCheck, boolean releaseHealthCheck, boolean lastRecentUsed) {
        this.poolKey = AttributeKey.newInstance("channelPool." + System.identityHashCode(this));
        ...
        this.bootstrap = ((Bootstrap) ObjectUtil.checkNotNull(bootstrap, "bootstrap")).mo1227clone();
    ...
    private Future<Channel> acquireHealthyFromPoolOrNew(final Promise<Channel> promise) {
        ...
        if (ch2 == null) {
            Bootstrap bs = this.bootstrap.mo1227clone();
    ...
    public void notifyHealthCheck(Future<Boolean> future, Channel ch2, Promise<Channel> promise) {
        ...
        if (future.isSuccess()) {
            if (future.getNow().booleanValue()) {
                try {
                    ch2.attr(this.poolKey).set(this);
