...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/AsciiString.class */
public final class AsciiString implements CharSequence, Comparable<CharSequence> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/AsciiString$CharEqualityComparator.class */
    ...
    public boolean regionMatches(boolean ignoreCase, int thisStart, CharSequence string, int start, int length) {
        ...
        while (thisStart2 < thisEnd) {
            ...
            int i2 = start;
            start++;
            if (!equalsIgnoreCase(b2c(this.value[i]), string.charAt(i2))) {
                return false;
            }
        }
        return true;
    ...
    private int parseInt(int start, int end, int radix, boolean negative) {
        ...
        while (currOffset < end) {
            int i = currOffset;
            currOffset++;
            int digit = Character.digit((char) (this.value[i + this.offset] & 255), radix);
            if (digit == -1) {
                throw new NumberFormatException(subSequence(start, end, false).toString());
            }
            if (max > result) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/AsciiString$DefaultCharEqualityComparator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/AsciiString$AsciiCaseInsensitiveCharEqualityComparator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/AsciiString$GeneralCaseInsensitiveCharEqualityComparator.class */
