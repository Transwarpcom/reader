...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/internal/StringUtil.class */
public final class StringUtil {
    ...
    public static <T extends Appendable> T byteToHexStringPadded(T buf, int value) throws IOException {
        try {
    ...
    public static <T extends Appendable> T toHexStringPadded(T dst, byte[] src, int offset, int length) throws IOException {
    ...
    public static <T extends Appendable> T byteToHexString(T buf, int value) throws IOException {
        try {
    ...
    public static <T extends Appendable> T toHexString(T dst, byte[] src, int offset, int length) throws IOException {
        ...
        int i2 = i;
        int i3 = i + 1;
        byteToHexString(dst, src[i2]);
        int remaining = end - i3;
        toHexStringPadded(dst, src, i3, remaining);
        return dst;
    }
