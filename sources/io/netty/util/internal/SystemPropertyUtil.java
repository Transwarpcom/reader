...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/internal/SystemPropertyUtil.class */
public final class SystemPropertyUtil {
    ...
    public static boolean getBoolean(String key, boolean def) {
        ...
        if ("true".equals(value2) || CustomBooleanEditor.VALUE_YES.equals(value2) || CustomBooleanEditor.VALUE_1.equals(value2)) {
            return true;
        }
