...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/internal/shaded/org/jctools/queues/MpscArrayQueue.class */
public class MpscArrayQueue<E> extends MpscArrayQueueL3Pad<E> {
    ...
    public E poll() {
        ...
        if (null == objLvElement) {
            if (jLpConsumerIndex != lvProducerIndex()) {
                do {
                    objLvElement = UnsafeRefArrayAccess.lvElement(eArr, jCalcElementOffset);
    ...
    public E relaxedPoll() {
        ...
        long jLpConsumerIndex = lpConsumerIndex();
        long jCalcElementOffset = calcElementOffset(jLpConsumerIndex);
        E e = (E) UnsafeRefArrayAccess.lvElement(eArr, jCalcElementOffset);
        if (null == e) {
            return null;
        }
        UnsafeRefArrayAccess.spElement(eArr, jCalcElementOffset, null);
    ...
    public int drain(MessagePassingQueue.Consumer<E> consumer, int limit) {
        ...
        for (int i = 0; i < limit; i++) {
            ...
            Object objLvElement = UnsafeRefArrayAccess.lvElement(buffer, offset);
            if (null == objLvElement) {
                return i;
            }
