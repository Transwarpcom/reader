...
/*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
    java.lang.NullPointerException
    */
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/HashedWheelTimer.class */
public class HashedWheelTimer implements Timer {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/HashedWheelTimer$Worker.class */
    private final class Worker implements Runnable {
        ...
        private long waitForNextTick() throws InterruptedException {
            ...
            while (true) {
                ...
                long sleepTimeMs = ((deadline - currentTime) + 999999) / StaticHandler.DEFAULT_MAX_AVG_SERVE_TIME_NS;
                if (sleepTimeMs <= 0) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/HashedWheelTimer$HashedWheelTimeout.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/HashedWheelTimer$HashedWheelBucket.class */
