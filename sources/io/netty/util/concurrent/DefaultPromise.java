...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/DefaultPromise.class */
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/DefaultPromise$LeanCancellationException.class */
        ...
        do {
            try {
                synchronized (this) {
                    ...
                    try {
                        try {
                            wait(waitTime / StaticHandler.DEFAULT_MAX_AVG_SERVE_TIME_NS, (int) (waitTime % StaticHandler.DEFAULT_MAX_AVG_SERVE_TIME_NS));
                            decWaiters();
                        } catch (Throwable th) {
                            decWaiters();
                            throw th;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/DefaultPromise$CauseHolder.class */
