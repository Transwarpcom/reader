...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/ScheduledFutureTask.class */
            ...
            if (this.periodNanos == 0) {
                ...
                if (!executor().isShutdown()) {
                    ...
                    if (!isCancelled()) {
                        ...
                        if (!$assertionsDisabled && scheduledTaskQueue == null) {
                            throw new AssertionError();
                        }
