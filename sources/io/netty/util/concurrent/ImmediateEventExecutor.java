...
/* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/ImmediateEventExecutor.class */
public final class ImmediateEventExecutor extends AbstractEventExecutor {
    ...
    public void execute(Runnable command) {
        ...
        try {
            ...
            logger.info("Throwable caught while executing Runnable {}", command, cause3);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/ImmediateEventExecutor$ImmediatePromise.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-common-4.1.42.Final.jar:io/netty/util/concurrent/ImmediateEventExecutor$ImmediateProgressivePromise.class */
