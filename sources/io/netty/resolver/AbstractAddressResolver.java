...
/* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-4.1.42.Final.jar:io/netty/resolver/AbstractAddressResolver.class */
public abstract class AbstractAddressResolver<T extends SocketAddress> implements AddressResolver<T> {
    ...
    protected AbstractAddressResolver(EventExecutor executor) {
        ...
        this.matcher = TypeParameterMatcher.find(this, AbstractAddressResolver.class, PDNumberFormatDictionary.FRACTIONAL_DISPLAY_TRUNCATE);
    }
