...
/* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DefaultDnsCnameCache.class */
public final class DefaultDnsCnameCache implements DnsCnameCache {
    ...
    public String get(String hostname) {
        ...
        List<? extends String> cached = this.cache.get(hostname);
