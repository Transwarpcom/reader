...
/* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsQueryContext.class */
abstract class DnsQueryContext implements FutureListener<AddressedEnvelope<DnsResponse, InetSocketAddress>> {
            ...
            this.timeoutFuture = this.parent.f7ch.eventLoop().schedule(new Runnable() { // from class: io.netty.resolver.dns.DnsQueryContext.4
                ...
                public void run() {
                    if (!DnsQueryContext.this.promise.isDone()) {
                        DnsQueryContext.this.setFailure("query via " + DnsQueryContext.this.protocol() + " timed out after " + queryTimeoutMillis + " milliseconds", null);
                    }
                }
    ...
    private void setSuccess(AddressedEnvelope<? extends DnsResponse, InetSocketAddress> envelope) {
        if (!this.promise.trySuccess(envelope.retain())) {
            envelope.release();
        }
    }
