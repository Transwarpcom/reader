...
/* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsAddressResolverGroup.class */
public class DnsAddressResolverGroup extends AddressResolverGroup<InetSocketAddress> {
    ...
    protected final AddressResolver<InetSocketAddress> newResolver(EventExecutor executor) throws Exception {
        ...
        return newResolver((EventLoop) executor, this.dnsResolverBuilder.channelFactory(), this.dnsResolverBuilder.nameServerProvider());
    }
