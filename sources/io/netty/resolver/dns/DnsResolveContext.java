...
/* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext.class */
abstract class DnsResolveContext<T> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext$DnsResolveContextException.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext$SearchDomainUnknownHostException.class */
    ...
    public void query(final DnsServerAddressStream nameServerAddrStream, final int nameServerAddrStreamIndex, final DnsQuestion question, final DnsQueryLifecycleObserver queryLifecycleObserver, boolean flush, final Promise<List<T>> promise, Throwable cause) {
        if (this.completeEarly || nameServerAddrStreamIndex >= nameServerAddrStream.size() || this.allowedQueries == 0 || promise.isCancelled()) {
    ...
    private void queryUnresolvedNameserver(final InetSocketAddress nameServerAddr, final DnsServerAddressStream nameServerAddrStream, final int nameServerAddrStreamIndex, final DnsQuestion question, final DnsQueryLifecycleObserver queryLifecycleObserver, final Promise<List<T>> promise, final Throwable cause) {
        ...
        if (!DnsNameResolver.doResolveAllCached(nameServerName, this.additionals, promiseNewPromise, resolveCache(), this.parent.resolvedInternetProtocolFamiliesUnsafe())) {
            ...
            new DnsAddressResolveContext(this.parent, nameServerName, this.additionals, this.parent.newNameServerAddressStream(nameServerName), resolveCache(), new AuthoritativeDnsServerCache() { // from class: io.netty.resolver.dns.DnsResolveContext.4
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext$DnsAddressStreamList.class */
    ...
    */
    ...
    private void followCname(DnsQuestion question, String cname, DnsQueryLifecycleObserver queryLifecycleObserver, Promise<List<T>> promise) {
        ...
        try {
            DnsQuestion cnameQuestion = new DefaultDnsQuestion(cname, question.type(), this.dnsClass);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext$CombinedDnsServerAddressStream.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext$AuthoritativeNameServerList.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/netty-resolver-dns-4.1.42.Final.jar:io/netty/resolver/dns/DnsResolveContext$AuthoritativeNameServer.class */
