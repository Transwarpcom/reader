...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/scheduling/CoroutineScheduler$WhenMappings.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState.class */
    ...
    public final void parkedWorkersStackTopUpdate(@NotNull Worker worker, int oldIndex, int newIndex) {
        ...
        while (true) {
            ...
            int index = (int) (top & 2097151);
            long updVersion = (top + PARKED_VERSION_INC) & PARKED_VERSION_MASK;
            if (index == oldIndex) {
                if (newIndex == 0) {
    ...
    public final boolean parkedWorkersStackPush(@NotNull Worker worker) {
        ...
        do {
            ...
            int index = (int) (top & 2097151);
            updVersion = (top + PARKED_VERSION_INC) & PARKED_VERSION_MASK;
    ...
    private final int parkedWorkersStackNextIndex(Worker worker) {
        ...
        while (true) {
            ...
            nextParkedWorker = nextWorker.getNextParkedWorker();
        }
    }
    ...
    private final int getAvailableCpuPermits() {
        ...
        return (int) ((state$iv & CPU_PERMITS_MASK) >> 42);
    }
    ...
    private final boolean tryAcquireCpuPermit() {
        ...
        do {
            ...
            int available = (int) ((state & CPU_PERMITS_MASK) >> 42);
            if (available == 0) {
                return false;
            }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/scheduling/CoroutineScheduler$Companion.class */
    ...
    public final void shutdown(long timeout) {
        ...
        if (_isTerminated$FU.compareAndSet(this, 0, 1)) {
            ...
            while (true) {
                Task taskFindTask = currentWorker == null ? null : currentWorker.findTask(true);
                if (taskFindTask == null) {
                    Task taskRemoveFirstOrNull = this.globalCpuQueue.removeFirstOrNull();
                    if (taskRemoveFirstOrNull == null) {
                        Task taskRemoveFirstOrNull2 = this.globalBlockingQueue.removeFirstOrNull();
                        if (taskRemoveFirstOrNull2 == null) {
                            break;
                        } else {
                            task = taskRemoveFirstOrNull2;
                        }
                    } else {
            ...
            if (DebugKt.getASSERTIONS_ENABLED()) {
                ...
                if (!(((int) ((state$iv$iv & CPU_PERMITS_MASK) >> 42)) == this.corePoolSize)) {
                    throw new AssertionError();
                }
            }
            this.parkedWorkersStack = 0L;
    ...
    private final boolean tryCreateWorker(long state) {
        ...
        int blocking = (int) ((state & BLOCKING_MASK) >> 21);
    ...
    private final Worker currentWorker() {
        ...
        Worker it = threadCurrentThread instanceof Worker ? (Worker) threadCurrentThread : null;
        if (it != null && Intrinsics.areEqual(CoroutineScheduler.this, this)) {
            return it;
        }
        return null;
    }
    ...
    public String toString() {
        ...
        sb.append(", Control State {created workers= ").append((int) (state & 2097151)).append(", blocking tasks = ").append((int) ((state & BLOCKING_MASK) >> 21)).append(", CPUs acquired = ").append(this.corePoolSize - ((int) ((state & CPU_PERMITS_MASK) >> 42))).append("}]");
        return sb.toString();
    }
    ...
    public final class Worker extends Thread {
        ...
        private final boolean tryAcquireCpuPermit() {
            ...
            while (true) {
                ...
                int available$iv = (int) ((state$iv & CoroutineScheduler.CPU_PERMITS_MASK) >> 42);
                if (available$iv == 0) {
                    z = false;
                    break;
                }
        ...
        public final int nextInt(int upperBound) {
            ...
            return (r4 & Integer.MAX_VALUE) % upperBound;
        }
        ...
        private final void tryTerminateWorker() {
            ...
            synchronized (lock$iv) {
                ...
                if (workerCtl$FU.compareAndSet(this, -1, 1)) {
                    ...
                    int lastIndex = (int) (state$iv$iv & 2097151);
        ...
        public final Task findTask(boolean scanLocalQueue) {
            ...
            if (scanLocalQueue) {
                ...
                taskRemoveFirstOrNull = taskPoll == null ? CoroutineScheduler.this.globalBlockingQueue.removeFirstOrNull() : taskPoll;
            } else {
                taskRemoveFirstOrNull = CoroutineScheduler.this.globalBlockingQueue.removeFirstOrNull();
            }
            Task task = taskRemoveFirstOrNull;
        ...
        private final Task findAnyTask(boolean scanLocalQueue) {
            ...
            Task it2;
            if (scanLocalQueue) {
                boolean globalFirst = nextInt(2 * CoroutineScheduler.this.corePoolSize) == 0;
