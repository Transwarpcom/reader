...
final class MissingMainCoroutineDispatcher extends MainCoroutineDispatcher implements Delay {
    ...
    public /* bridge */ /* synthetic */ void mo4327scheduleResumeAfterDelay(long timeMillis, CancellableContinuation continuation) {
    ...
    @Override // kotlinx.coroutines.Delay
    @Nullable
    public Object delay(long time, @NotNull Continuation<?> continuation) {
        missing();
        throw new KotlinNothingValueException();
    }
    ...
    private final Void missing() {
        ...
        String str2 = "Module with the Main dispatcher had failed to initialize";
        String it = this.errorHint;
        if (it == null) {
            str = "";
        } else {
            String strStringPlus = Intrinsics.stringPlus(". ", it);
            str2 = "Module with the Main dispatcher had failed to initialize";
            str = strStringPlus == null ? "" : strStringPlus;
        }
        String message = Intrinsics.stringPlus(str2, str);
