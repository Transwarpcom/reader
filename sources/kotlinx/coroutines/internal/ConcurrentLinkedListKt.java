    ...
    private static final <S extends Segment<S>> Object findSegmentInternal(S s, long id, Function2<? super Long, ? super S, ? extends S> function2) {
        ...
        while (true) {
            if (cur.getId() < id || cur.getRemoved()) {
                ...
                if (it$iv == CLOSED) {
                    return SegmentOrClosed.m4335constructorimpl(CLOSED);
                }
                ...
                return SegmentOrClosed.m4335constructorimpl(cur);
            }
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v14, types: [kotlinx.coroutines.internal.ConcurrentLinkedListNode] */
    @NotNull
