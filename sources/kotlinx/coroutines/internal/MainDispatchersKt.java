...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/internal/MainDispatchersKt.class */
public final class MainDispatchersKt {
    ...
    @NotNull
    public static final MainCoroutineDispatcher tryCreateDispatcher(@NotNull MainDispatcherFactory $this$tryCreateDispatcher, @NotNull List<? extends MainDispatcherFactory> list) throws Throwable {
        MainCoroutineDispatcher mainCoroutineDispatcherCreateMissingDispatcher;
        try {
            mainCoroutineDispatcherCreateMissingDispatcher = $this$tryCreateDispatcher.createDispatcher(list);
        } catch (Throwable cause) {
            mainCoroutineDispatcherCreateMissingDispatcher = createMissingDispatcher(cause, $this$tryCreateDispatcher.hintOnError());
        }
        return mainCoroutineDispatcherCreateMissingDispatcher;
    }
