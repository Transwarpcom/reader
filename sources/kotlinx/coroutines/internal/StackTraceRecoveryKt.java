...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM2105constructorimpl = Result.m2105constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            objM2105constructorimpl = Result.m2105constructorimpl(ResultKt.createFailure(th));
        }
        Object obj = objM2105constructorimpl;
        baseContinuationImplClassName = (String) (Result.m2103exceptionOrNullimpl(obj) == null ? obj : baseContinuationImplClass);
        try {
            Result.Companion companion3 = Result.Companion;
            objM2105constructorimpl2 = Result.m2105constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            objM2105constructorimpl2 = Result.m2105constructorimpl(ResultKt.createFailure(th2));
        }
        Object obj2 = objM2105constructorimpl2;
        stackTraceRecoveryClassName = (String) (Result.m2103exceptionOrNullimpl(obj2) == null ? obj2 : stackTraceRecoveryClass);
    }

    @NotNull
    public static final <E extends Throwable> E recoverStackTrace(@NotNull E e) {
        Throwable thTryCopyAndVerify;
        if (DebugKt.getRECOVER_STACK_TRACES() && (thTryCopyAndVerify = tryCopyAndVerify(e)) != null) {
            return (E) sanitizeStackTrace(thTryCopyAndVerify);
        }
        return e;
    }
    ...
    private static final <E extends Throwable> E sanitizeStackTrace(E e) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (i3 == 0) {
                ...
                stackTraceElementArtificialFrame = stackTrace[(startIndex + i3) - 1];
            }
            trace[i3] = stackTraceElementArtificialFrame;
        }
    ...
    @Nullable
    public static final Object recoverAndThrow(@NotNull Throwable exception, @NotNull Continuation<?> continuation) throws Throwable {
    ...
    private static final ArrayDeque<StackTraceElement> createStackTrace(CoroutineStackFrame continuation) {
        ...
        while (true) {
            CoroutineStackFrame coroutineStackFrame = last;
            CoroutineStackFrame coroutineStackFrame2 = coroutineStackFrame instanceof CoroutineStackFrame ? coroutineStackFrame : null;
            CoroutineStackFrame callerFrame = coroutineStackFrame2 == null ? null : coroutineStackFrame2.getCallerFrame();
            if (callerFrame != null) {
                last = callerFrame;
