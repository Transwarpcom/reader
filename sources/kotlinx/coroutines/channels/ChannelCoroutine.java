...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/ChannelCoroutine.class */
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo4210tryReceivePtdJZtk() {
        return this._channel.mo4210tryReceivePtdJZtk();
    }
    ...
    public Object mo4213trySendJP2dKIU(E e) {
        return this._channel.mo4213trySendJP2dKIU(e);
    }
    ...
    public Object mo4209receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo4209receiveCatchingJP2dKIU(continuation);
    ...
    public ChannelCoroutine(@NotNull CoroutineContext parentContext, @NotNull Channel<E> channel, boolean initParentJob, boolean active) {
