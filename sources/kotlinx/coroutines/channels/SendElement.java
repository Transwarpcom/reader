...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/SendElement.class */
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(@NotNull Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m2105constructorimpl(ResultKt.createFailure(sendException)));
    }
