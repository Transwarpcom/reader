...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/BroadcastCoroutine.class */
class BroadcastCoroutine<E> extends AbstractCoroutine<Unit> implements ProducerScope<E>, BroadcastChannel<E> {
    ...
    public BroadcastCoroutine(@NotNull CoroutineContext parentContext, @NotNull BroadcastChannel<E> broadcastChannel, boolean active) {
