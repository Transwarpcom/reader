...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/ConflatedBroadcastChannel$Companion.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/ConflatedBroadcastChannel$State.class */
    private static final class State<E> {
        ...
        public State(@Nullable Object value, @Nullable Subscriber<E>[] subscriberArr) {
            this.value = value;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed.class */
    private static final class Closed {
        ...
        public Closed(@Nullable Throwable closeCause) {
    ...
    public Object mo4213trySendJP2dKIU(E e) {
        Closed it = offerInternal(e);
        if (it != null) {
            return ChannelResult.Companion.m4239closedJP2dKIU(it.getSendException());
        }
    ...
    private final Closed offerInternal(E e) {
        ...
        do {
            try {
                ...
                if (!(state instanceof Closed)) {
                    if (state instanceof State) {
                        update = new State(e, ((State) state).subscribers);
                    } else {
                        throw new IllegalStateException(Intrinsics.stringPlus("Invalid state ", state).toString());
                    }
                } else {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/ConflatedBroadcastChannel$Subscriber.class */
