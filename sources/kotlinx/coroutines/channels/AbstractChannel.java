...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel.class */
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final <R> Object receiveSuspend(int receiveMode, Continuation<? super R> continuation) {
        ...
        ReceiveElement receiveElement = receiveElementWithUndeliveredHandler;
        while (true) {
            ...
            if (result != AbstractChannelKt.POLL_FAILED) {
                cont.resume(receiveElement.resumeValue(result), receiveElement.resumeOnCancellationFun(result));
                break;
            }
        }
    ...
    protected boolean enqueueReceiveInternal(@NotNull Receive<? super E> receive) {
        ...
        LockFreeLinkedListHead this_$iv2 = getQueue();
    ...
    */
    public final java.lang.Object mo4209receiveCatchingJP2dKIU(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r7) {
        /*
            r6 = this;
            r0 = r7
        ...
        L5c:
            ...
            java.lang.Object r0 = r0.m4239closedJP2dKIU(r1)
            goto L90
        L89:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            r1 = r9
            java.lang.Object r0 = r0.m4237successJP2dKIU(r1)
        L90:
            return r0
        L91:
            r0 = r6
        ...
        Lb5:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo4209receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final Object mo4210tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m4238failurePtdJZtk() : result instanceof Closed ? ChannelResult.Companion.m4239closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.Companion.m4237successJP2dKIU(result);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m4313constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.remove()) {
                    ...
                    list = InlineList.m4307plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo4211onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel$TryPollDesc.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final <R> void registerSelectReceiveMode(SelectInstance<? super R> selectInstance, int receiveMode, Function2<Object, ? super Continuation<? super R>, ? extends Object> function2) throws Throwable {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) throws Throwable {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m4233boximpl(ChannelResult.Companion.m4239closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode == 1) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m4233boximpl(value instanceof Closed ? ChannelResult.Companion.m4239closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.Companion.m4237successJP2dKIU(value)), selectInstance.getCompletion());
        } else {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel$RemoveReceiveOnCancel.class */
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m2105constructorimpl(boolBoxBoolean));
                    } else {
                        CancellableContinuationImpl cancellableContinuationImpl2 = cont;
                        Throwable receiveException = ((Closed) result).getReceiveException();
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl2.resumeWith(Result.m2105constructorimpl(ResultKt.createFailure(receiveException)));
                    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel$ReceiveElement.class */
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public ReceiveElement(@NotNull CancellableContinuation<Object> cancellableContinuation, int receiveMode) {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m4233boximpl(ChannelResult.Companion.m4237successJP2dKIU(e)) : e;
        }

        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        @Nullable
        public Symbol tryResumeReceive(E e, @Nullable LockFreeLinkedListNode.PrepareOp otherOp) {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m2105constructorimpl(ResultKt.createFailure(receiveException)));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation2 = this.cont;
            ChannelResult channelResultM4233boximpl = ChannelResult.m4233boximpl(ChannelResult.Companion.m4239closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            cancellableContinuation2.resumeWith(Result.m2105constructorimpl(channelResultM4233boximpl));
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel$ReceiveElementWithUndeliveredHandler.class */
    private static final class ReceiveElementWithUndeliveredHandler<E> extends ReceiveElement<E> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public ReceiveElementWithUndeliveredHandler(@NotNull CancellableContinuation<Object> cancellableContinuation, int receiveMode, @NotNull Function1<? super E, Unit> function1) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel$ReceiveHasNext.class */
    private static class ReceiveHasNext<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            ...
            Object token = objTryResumeWithException;
            if (token != null) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannel$ReceiveSelect.class */
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public ReceiveSelect(@NotNull AbstractChannel<E> abstractChannel, @NotNull SelectInstance<? super R> selectInstance, @NotNull Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, int receiveMode) {
            this.channel = abstractChannel;
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m4233boximpl(ChannelResult.Companion.m4237successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        break;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m4233boximpl(ChannelResult.Companion.m4239closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        break;
                }
            }
        }
