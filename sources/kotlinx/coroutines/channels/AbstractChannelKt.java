...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/channels/AbstractChannelKt.class */
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object $this$toResult) {
        return $this$toResult instanceof Closed ? ChannelResult.Companion.m4239closedJP2dKIU(((Closed) $this$toResult).closeCause) : ChannelResult.Companion.m4237successJP2dKIU($this$toResult);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m4239closedJP2dKIU(closed.closeCause);
    }
}
