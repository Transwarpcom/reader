...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/NonCancellable.class */
public final class NonCancellable extends AbstractCoroutineContextElement implements Job {
    ...
    @Deprecated(message = message, level = DeprecationLevel.WARNING)
    @NotNull
    public DisposableHandle invokeOnCompletion(boolean onCancelling, boolean invokeImmediately, @NotNull Function1<? super Throwable, Unit> function1) {
        return NonDisposableHandle.INSTANCE;
    }
