...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object objCollect = $this$collect$iv.collect(new ChannelFlowMerge$collectTo$$inlined$collect$1(job, semaphore, producerScope, collector), continuation);
