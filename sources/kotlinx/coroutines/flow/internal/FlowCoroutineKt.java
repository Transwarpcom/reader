...
public final class FlowCoroutineKt {
    ...
    @NotNull
    public static final <T> ReceiveChannel<T> flowProduce(@NotNull CoroutineScope $this$flowProduce, @NotNull CoroutineContext context, int capacity, @BuilderInference @NotNull Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
