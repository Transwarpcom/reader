...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/flow/FlowKt__CountKt$count$$inlined$collect$2.class */
public final class FlowKt__CountKt$count$$inlined$collect$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(f = "Count.kt", l = {135}, i = {0}, s = {"L$0"}, n = {"this"}, m = "emit", c = "kotlinx.coroutines.flow.FlowKt__CountKt$count$$inlined$collect$2")
    /* renamed from: kotlinx.coroutines.flow.FlowKt__CountKt$count$$inlined$collect$2$1, reason: invalid class name */
    /* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/flow/FlowKt__CountKt$count$$inlined$collect$2$1.class */
    ...
    */
    public java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
        /*
            r6 = this;
            r0 = r8
            boolean r0 = r0 instanceof kotlinx.coroutines.flow.FlowKt__CountKt$count$$inlined$collect$2.AnonymousClass1
            if (r0 == 0) goto L24
            r0 = r8
        ...
        L8e:
            ...
            kotlinx.coroutines.flow.FlowKt__CountKt$count$$inlined$collect$2 r0 = (kotlinx.coroutines.flow.FlowKt__CountKt$count$$inlined$collect$2) r0
            r6 = r0
            r0 = r10
            kotlin.ResultKt.throwOnFailure(r0)
            r0 = r10
        La0:
            ...
            if (r0 == 0) goto Lc1
            r0 = r6
            kotlin.jvm.internal.Ref$IntRef r0 = r0.$i$inlined
            r1 = r6
            kotlin.jvm.internal.Ref$IntRef r1 = r1.$i$inlined
            int r1 = r1.element
            r2 = 1
            int r1 = r1 + r2
            r0.element = r1
