...
/* loaded from: reader.jar:BOOT-INF/lib/kotlinx-coroutines-core-jvm-1.5.2.jar:kotlinx/coroutines/EventLoop.class */
public abstract class EventLoop extends CoroutineDispatcher {
    ...
    public final void dispatchUnconfined(@NotNull DispatchedTask<?> dispatchedTask) {
        ...
        ArrayQueue arrayQueue2 = this.unconfinedQueue;
        if (arrayQueue2 != null) {
            arrayQueue = arrayQueue2;
        } else {
            ArrayQueue it = new ArrayQueue();
