...
/* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/cache/CacheStrategy.class */
public final class CacheStrategy {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/cache/CacheStrategy$Factory.class */
    public static final class Factory {
        ...
        private final CacheStrategy computeCandidate() {
            ...
            String str = conditionValue;
            Intrinsics.checkNotNull(str);
            conditionalRequestHeaders.addLenient$okhttp(conditionName, str);
        ...
        private final long cacheResponseAge() {
            ...
            if (servedDate != null) {
                jMax = Math.max(0L, this.receivedResponseMillis - servedDate.getTime());
            } else {
                jMax = 0;
            }
            long apparentReceivedAge = jMax;
            if (this.ageSeconds != -1) {
                jMax2 = Math.max(apparentReceivedAge, TimeUnit.SECONDS.toMillis(this.ageSeconds));
            } else {
                jMax2 = apparentReceivedAge;
            }
            long receivedAge = jMax2;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/cache/CacheStrategy$Companion.class */
