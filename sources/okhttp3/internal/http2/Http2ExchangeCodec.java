...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/http2/Http2ExchangeCodec$Companion.class */
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(@NotNull Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(name) || (Intrinsics.areEqual(name, Http2ExchangeCodec.TE) && Intrinsics.areEqual(headers.value(i), HttpHeaders.Values.TRAILERS))) {
