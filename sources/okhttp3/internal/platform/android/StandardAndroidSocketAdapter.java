...
/* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/platform/android/StandardAndroidSocketAdapter.class */
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    @Override // okhttp3.internal.platform.android.AndroidSocketAdapter, okhttp3.internal.platform.android.SocketAdapter
    @Nullable
    public X509TrustManager trustManager(@NotNull SSLSocketFactory sslSocketFactory) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Intrinsics.checkNotNullParameter(sslSocketFactory, "sslSocketFactory");
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/platform/android/StandardAndroidSocketAdapter$Companion.class */
    public static final class Companion {
        ...
        @Nullable
        public final SocketAdapter buildIfSupported(@NotNull String packageName) throws ClassNotFoundException {
            StandardAndroidSocketAdapter standardAndroidSocketAdapter;
            Class sslSocketClass;
            Intrinsics.checkNotNullParameter(packageName, "packageName");
            try {
                sslSocketClass = Class.forName(packageName + ".OpenSSLSocketImpl");
            } catch (Exception e) {
