...
/* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/platform/ConscryptPlatform.class */
public final class ConscryptPlatform extends Platform {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/platform/ConscryptPlatform$DisabledHostnameVerifier.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/okhttp-4.9.1.jar:okhttp3/internal/platform/ConscryptPlatform$Companion.class */
    ...
    static {
        /*
            ...
            r1 = 0
            okhttp3.internal.platform.ConscryptPlatform$Companion r2 = okhttp3.internal.platform.ConscryptPlatform.Companion     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            java.lang.Class r2 = r2.getClass()     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            java.lang.ClassLoader r2 = r2.getClassLoader()     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            java.lang.Class r0 = java.lang.Class.forName(r0, r1, r2)     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            boolean r0 = org.conscrypt.Conscrypt.isAvailable()     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            if (r0 == 0) goto L34
            okhttp3.internal.platform.ConscryptPlatform$Companion r0 = okhttp3.internal.platform.ConscryptPlatform.Companion     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            r1 = 2
            r2 = 1
            r3 = 0
            boolean r0 = r0.atLeastVersion(r1, r2, r3)     // Catch: java.lang.NoClassDefFoundError -> L39 java.lang.ClassNotFoundException -> L3f
            if (r0 == 0) goto L34
            r0 = 1
            goto L35
        L34:
        ...
        L42:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.platform.ConscryptPlatform.m4615clinit():void");
    }
}
