...
public final class RealBufferedSource implements BufferedSource {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    @Override // okio.BufferedSource
    public int select(@org.jetbrains.annotations.NotNull okio.Options r6) {
        /*
            r5 = this;
            r0 = r6
    ...
    @Override // okio.BufferedSource
    public int read(@NotNull byte[] sink, int offset, int byteCount) throws IOException {
        Intrinsics.checkNotNullParameter(sink, "sink");
    ...
    public long readAll(@NotNull Sink sink) throws IOException {
        ...
        if (this.bufferField.size() > 0) {
            totalBytesWritten$iv += this.bufferField.size();
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        ...
        if (scanLength$iv < Long.MAX_VALUE && request(scanLength$iv) && this.bufferField.getByte(scanLength$iv - 1) == ((byte) 13) && request(scanLength$iv + 1) && this.bufferField.getByte(scanLength$iv) == ((byte) 10)) {
    ...
    public long readDecimalLong() throws EOFException {
        ...
        while (true) {
            ...
            b$iv = this.bufferField.getByte(pos$iv);
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        if (!(0 <= fromIndex$iv && toIndex >= fromIndex$iv)) {
    ...
    public boolean rangeEquals(long offset, @NotNull ByteString bytes, int bytesOffset, int byteCount) {
        ...
        for (int i$iv = 0; i$iv < byteCount; i$iv++) {
            long bufferOffset$iv = offset + i$iv;
