...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/boolex/JaninoEventEvaluator.class */
public class JaninoEventEvaluator extends JaninoEventEvaluatorBase<ILoggingEvent> {
    ...
    static {
        ...
        DEFAULT_PARAM_NAME_LIST.add(PackageDocumentBase.OPFAttributes.event);
