...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/ComponentDelegate.class */
public class ComponentDelegate extends ContextAwareBase implements GroovyObject {
    ...
    */
    ...
    public void methodMissing(String name, Object args) {
        ...
        callSiteArr$getCallSiteArray[50].callCurrent(this, new GStringImpl(new Object[]{name, getLabel(), getComponentName(), callSiteArr$getCallSiteArray[51].callGetProperty(callSiteArr$getCallSiteArray[52].call(this.component))}, new String[]{"No 'class' argument specified for [", "] in ", " ", " of type [", "]"}));
    }
    ...
    public void propertyMissing(String name, Object value) {
        ...
        if (ScriptBytecodeAdapter.compareEqual(nestingType, callSiteArr$getCallSiteArray[57].callGetProperty(NestingType.class))) {
            callSiteArr$getCallSiteArray[58].callCurrent(this, new GStringImpl(new Object[]{callSiteArr$getCallSiteArray[59].callCurrent(this), callSiteArr$getCallSiteArray[60].callCurrent(this), callSiteArr$getCallSiteArray[61].callGetProperty(callSiteArr$getCallSiteArray[62].call(this.component)), name}, new String[]{"", " ", " of type [", "] has no appplicable [", "] property "}));
        } else {
    ...
    public String getComponentName() {
        ...
        if (DefaultTypeTransformation.booleanUnbox(callSiteArr$getCallSiteArray[88].call(this.component, "name"))) {
            return ShortTypeHandling.castToString(new GStringImpl(new Object[]{callSiteArr$getCallSiteArray[89].callGetProperty(this.component)}, new String[]{"[", "]"}));
        }
        return "";
    }
}
