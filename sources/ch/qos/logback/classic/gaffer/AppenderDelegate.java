...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/AppenderDelegate.class */
public class AppenderDelegate extends ComponentDelegate {
    ...
    */
    ...
    /* compiled from: AppenderDelegate.groovy */
    /* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/AppenderDelegate$_closure1.class */
    ...
    public AppenderDelegate(Appender appender, List<Appender<?>> list) {
        ...
        this.appendersByName = ScriptBytecodeAdapter.createMap(new Object[0]);
        this.appendersByName = (Map) ScriptBytecodeAdapter.castToType(callSiteArr$getCallSiteArray[0].call(list, new _closure1(this, this)), Map.class);
    }
    ...
    public void appenderRef(String name) throws Throwable {
        CallSite[] callSiteArr$getCallSiteArray = $getCallSiteArray();
        if (!DefaultTypeTransformation.booleanUnbox(callSiteArr$getCallSiteArray[1].call(AppenderAttachable.class, callSiteArr$getCallSiteArray[2].callGetProperty(callSiteArr$getCallSiteArray[3].callGroovyObjectGetProperty(this))))) {
            Object errorMessage = callSiteArr$getCallSiteArray[4].call(callSiteArr$getCallSiteArray[5].call(callSiteArr$getCallSiteArray[6].call(callSiteArr$getCallSiteArray[7].callGetProperty(callSiteArr$getCallSiteArray[8].callGetProperty(callSiteArr$getCallSiteArray[9].callGroovyObjectGetProperty(this))), " does not implement "), callSiteArr$getCallSiteArray[10].callGetProperty(AppenderAttachable.class)), ".");
            throw ((Throwable) callSiteArr$getCallSiteArray[11].callConstructor(IllegalArgumentException.class, errorMessage));
        }
        callSiteArr$getCallSiteArray[12].call(callSiteArr$getCallSiteArray[13].callGroovyObjectGetProperty(this), callSiteArr$getCallSiteArray[14].call(this.appendersByName, name));
    }
}
