...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/GafferConfigurator.class */
public class GafferConfigurator implements GroovyObject {
    ...
    private static /* synthetic */ void $createCallSiteArray_1(String[] strArr) {
        ...
        strArr[2] = "run";
        strArr[3] = NCXDocumentV2.NCXTags.text;
        strArr[4] = "informContextOfURLUsedForConfiguration";
        strArr[5] = "toURL";
        strArr[6] = "toURI";
        strArr[7] = "run";
        strArr[8] = NCXDocumentV2.NCXTags.text;
    ...
    */
    ...
    /* compiled from: GafferConfigurator.groovy */
    /* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/GafferConfigurator$_run_closure1.class */
    ...
    protected ImportCustomizer importCustomizer() {
        ...
        callSiteArr$getCallSiteArray[37].call(customizer, "off", callSiteArr$getCallSiteArray[38].callGetProperty(Level.class), "OFF");
        callSiteArr$getCallSiteArray[39].call(customizer, "error", callSiteArr$getCallSiteArray[40].callGetProperty(Level.class), "ERROR");
        callSiteArr$getCallSiteArray[41].call(customizer, "warn", callSiteArr$getCallSiteArray[42].callGetProperty(Level.class), "WARN");
        callSiteArr$getCallSiteArray[43].call(customizer, "info", callSiteArr$getCallSiteArray[44].callGetProperty(Level.class), "INFO");
        ...
        callSiteArr$getCallSiteArray[49].call(customizer, "all", callSiteArr$getCallSiteArray[50].callGetProperty(Level.class), "ALL");
