...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/gaffer/GafferUtil.class */
public class GafferUtil {
    ...
    public static void runGafferConfiguratorOn(LoggerContext loggerContext, Object origin, File configFile) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    public static void runGafferConfiguratorOn(LoggerContext loggerContext, Object origin, URL configFile) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        GafferConfigurator gafferConfigurator = newGafferConfiguratorInstance(loggerContext, origin);
        if (gafferConfigurator != null) {
            gafferConfigurator.run(configFile);
        }
    ...
    private static GafferConfigurator newGafferConfiguratorInstance(LoggerContext loggerContext, Object origin) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        try {
