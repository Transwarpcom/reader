...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/PatternLayout.class */
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        defaultConverterMap.put(PackageDocumentBase.DCTags.date, DateConverter.class.getName());
        defaultConverterMap.put(PDPageLabelRange.STYLE_ROMAN_LOWER, RelativeTimeConverter.class.getName());
        ...
        defaultConverterMap.put(OperatorName.CURVE_TO, LoggerConverter.class.getName());
        defaultConverterMap.put("m", MessageConverter.class.getName());
        defaultConverterMap.put("msg", MessageConverter.class.getName());
        defaultConverterMap.put("message", MessageConverter.class.getName());
        defaultConverterMap.put("C", ClassOfCallerConverter.class.getName());
        defaultConverterMap.put("class", ClassOfCallerConverter.class.getName());
        defaultConverterMap.put(OperatorName.SET_LINE_MITERLIMIT, MethodOfCallerConverter.class.getName());
        ...
        defaultConverterMap.put(OperatorName.ENDPATH, LineSeparatorConverter.class.getName());
