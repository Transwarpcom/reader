...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/log4j/XMLLayout.class */
    ...
    public String doLayout(ILoggingEvent event) {
        ...
        if (getProperties() && (propertyMap = event.getMDCPropertyMap()) != null && propertyMap.size() != 0) {
            ...
            for (Map.Entry<String, String> entry : entrySet) {
                this.buf.append("\r\n    <log4j:data");
                this.buf.append(" name='" + Transform.escapeTags(entry.getKey()) + OperatorName.SHOW_TEXT_LINE);
                this.buf.append(" value='" + Transform.escapeTags(entry.getValue()) + OperatorName.SHOW_TEXT_LINE);
                this.buf.append(" />");
            }
            this.buf.append("\r\n  </log4j:properties>");
        }
