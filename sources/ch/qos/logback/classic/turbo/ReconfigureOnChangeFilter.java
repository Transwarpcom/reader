...
/*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
    ...
    */
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/turbo/ReconfigureOnChangeFilter.class */
public class ReconfigureOnChangeFilter extends TurboFilter {
    ...
    private void updateMaskIfNecessary(long now) {
        ...
        if (timeElapsedSinceLastMaskUpdateCheck < 100 && this.mask < WebSocketProtocol.PAYLOAD_SHORT_MAX) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/turbo/ReconfigureOnChangeFilter$ReconfiguringThread.class */
