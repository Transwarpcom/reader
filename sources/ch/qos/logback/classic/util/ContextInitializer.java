...
/* loaded from: reader.jar:BOOT-INF/lib/logback-classic-1.2.3.jar:ch/qos/logback/classic/util/ContextInitializer.class */
public class ContextInitializer {
    ...
    public void configureByResource(URL url) throws NoSuchMethodException, JoranException, ClassNotFoundException, SecurityException {
        if (url == null) {
