...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/sift/SiftingJoranConfiguratorBase.class */
public abstract class SiftingJoranConfiguratorBase<E> extends GenericConfigurator {
    ...
    public String toString() {
        return getClass().getName() + StrPool.DELIM_START + this.key + "=" + this.value + '}';
    }
}
