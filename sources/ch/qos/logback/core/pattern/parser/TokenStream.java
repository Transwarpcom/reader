...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/pattern/parser/TokenStream.class */
class TokenStream {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/pattern/parser/TokenStream$TokenizerState.class */
    enum TokenizerState {
        LITERAL_STATE,
    ...
    private void handleKeywordState(char c, List<Token> tokenList, StringBuffer buf) {
        ...
        if (c == '(') {
            addValuedToken(WebSocketProtocol.CLOSE_NO_STATUS_CODE, buf, tokenList);
            this.state = TokenizerState.LITERAL_STATE;
            return;
        }
        if (c == '%') {
