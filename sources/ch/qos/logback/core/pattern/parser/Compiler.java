...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/pattern/parser/Compiler.class */
                ...
                switch (n.type) {
                    ...
                    case 2:
                        ...
                        if (compositeConverter == null) {
                            addError("Failed to create converter for [%" + cn2.getValue() + "] keyword");
                            addToList(new LiteralConverter("%PARSER_ERROR[" + cn2.getValue() + "]"));
                            break;
                        } else {
