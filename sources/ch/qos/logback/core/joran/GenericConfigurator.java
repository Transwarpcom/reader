...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/joran/GenericConfigurator.class */
public abstract class GenericConfigurator extends ContextAwareBase {
    ...
    public final void doConfigure(InputStream inputStream) throws SAXException, JoranException, IOException {
        doConfigure(new InputSource(inputStream));
    }

    public final void doConfigure(InputStream inputStream, String systemId) throws SAXException, JoranException, IOException {
    ...
    public final void doConfigure(InputSource inputSource) throws SAXException, JoranException, IOException {
