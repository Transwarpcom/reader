...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/joran/event/StartEvent.class */
    ...
    public String toString() {
        ...
        if (this.attributes != null) {
            for (int i = 0; i < this.attributes.getLength(); i++) {
                ...
                b.append(this.attributes.getLocalName(i)).append("=\"").append(this.attributes.getValue(i)).append(OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            }
        }
        b.append(")  [");
