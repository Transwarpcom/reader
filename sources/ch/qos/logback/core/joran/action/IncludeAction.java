...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/joran/action/IncludeAction.class */
public class IncludeAction extends Action {
    ...
    private void parseAndRecord(InputStream inputSource, SaxEventRecorder recorder) throws SAXException, JoranException, IOException {
