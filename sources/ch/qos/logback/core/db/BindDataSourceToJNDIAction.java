...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/db/BindDataSourceToJNDIAction.class */
public class BindDataSourceToJNDIAction extends Action {
    ...
    public void begin(InterpretationContext ec, String localName, Attributes attributes) {
        ...
        try {
            DataSource ds = (DataSource) OptionHelper.instantiateByClassName(dsClassName, (Class<?>) DataSource.class, this.context);
