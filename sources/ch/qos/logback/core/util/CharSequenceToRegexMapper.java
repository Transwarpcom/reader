...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/util/CharSequenceToRegexMapper.class */
    ...
    String toRegex(CharSequenceState css) {
        ...
        switch (css.c) {
            ...
            default:
                ...
                return c + StrPool.DELIM_START + occurrences + "}";
            case '.':
                return "\\.";
            case 'D':
            case 'F':
