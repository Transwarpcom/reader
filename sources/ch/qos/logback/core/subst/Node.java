...
/* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/subst/Node.class */
public class Node {
    Type type;
    Object payload;
    Object defaultPart;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/logback-core-1.2.3.jar:ch/qos/logback/core/subst/Node$Type.class */
    enum Type {
        LITERAL,
        VARIABLE
    }
    ...
    public String toString() {
        switch (this.type) {
            ...
            case VARIABLE:
                ...
                String r = "Node{type=" + this.type + ", payload='" + payloadBuf.toString() + OperatorName.SHOW_TEXT_LINE;
                if (this.defaultPart != null) {
