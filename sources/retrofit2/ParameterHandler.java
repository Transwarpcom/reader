...
/* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler.class */
abstract class ParameterHandler<T> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$RelativeUrl.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Header.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Path.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Query.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$QueryName.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$QueryMap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$HeaderMap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Headers.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Field.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$FieldMap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Part.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$RawPart.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$PartMap.class */
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder builder, @Nullable Map<String, T> value) throws IOException {
            ...
            for (Map.Entry<String, T> entry : value.entrySet()) {
                ...
                okhttp3.Headers headers = okhttp3.Headers.of(HttpHeaders.CONTENT_DISPOSITION, "form-data; name=\"" + entryKey + OperatorName.SHOW_TEXT_LINE_AND_SPACE, HttpHeaders.Names.CONTENT_TRANSFER_ENCODING, this.transferEncoding);
                builder.addPart(headers, this.valueConverter.convert(entryValue));
            }
        }
    }

    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Body.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/retrofit-2.6.1.jar:retrofit2/ParameterHandler$Tag.class */
