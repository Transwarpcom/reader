...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/NumbersKt__NumbersKt.class */
class NumbersKt__NumbersKt extends NumbersKt__NumbersJVMKt {
    ...
    public static final short rotateLeft(short $this$rotateLeft, int bitCount) {
        return (short) (($this$rotateLeft << (bitCount & 15)) | (($this$rotateLeft & 65535) >>> (16 - (bitCount & 15))));
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalStdlibApi
    public static final short rotateRight(short $this$rotateRight, int bitCount) {
        return (short) (($this$rotateRight << (16 - (bitCount & 15))) | (($this$rotateRight & 65535) >>> (bitCount & 15)));
    }
}
