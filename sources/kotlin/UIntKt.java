...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/UIntKt.class */
public final class UIntKt {
    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final int toUInt(byte $this$toUInt) {
        return UInt.m2244constructorimpl($this$toUInt);
    }
    ...
    private static final int toUInt(long $this$toUInt) {
        return UInt.m2244constructorimpl((int) $this$toUInt);
    }
