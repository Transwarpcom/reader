...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/jvm/internal/ClassReference$Companion.class */
        ...
        */
        ...
        public final String getClassQualifiedName(@NotNull Class<?> jClass) {
            ...
            if (!jClass.isArray()) {
                ...
                return str2 != null ? str2 : jClass.getCanonicalName();
            }
            Class componentType = jClass.getComponentType();
            Intrinsics.checkNotNullExpressionValue(componentType, "componentType");
            String str3 = (!componentType.isPrimitive() || (str = (String) ClassReference.classFqNames.get(componentType.getName())) == null) ? null : str + "Array";
            if (str3 == null) {
                return "kotlin.Array";
            }
            return str3;
