...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m3330getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }

    /* renamed from: getFirst-s-VKNKU, reason: not valid java name */
    public final long m3389getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU, reason: not valid java name */
    public final long m3390getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((int) ULong.m2323constructorimpl(this.first ^ ULong.m2323constructorimpl(this.first >>> 32)))) + ((int) ULong.m2323constructorimpl(this.last ^ ULong.m2323constructorimpl(this.last >>> 32))))) + ((int) (this.step ^ (this.step >>> 32)));
    }

    @NotNull
    public String toString() {
        return this.step > 0 ? ULong.m2322toStringimpl(this.first) + ".." + ULong.m2322toStringimpl(this.last) + " step " + this.step : ULong.m2322toStringimpl(this.first) + " downTo " + ULong.m2322toStringimpl(this.last) + " step " + (-this.step);
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/ranges/ULongProgression$Companion.class */
    public static final class Companion {
        ...
        public final ULongProgression m3392fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
