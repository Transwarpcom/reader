...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/StandardKt__SynchronizedKt.class */
class StandardKt__SynchronizedKt extends StandardKt__StandardKt {
    @InlineOnly
    /* renamed from: synchronized, reason: not valid java name */
    private static final <R> R m2113synchronized(Object lock, Function0<? extends R> function0) {
        R rInvoke;
        synchronized (lock) {
            try {
