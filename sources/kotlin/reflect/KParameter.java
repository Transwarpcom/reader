...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/reflect/KParameter.class */
public interface KParameter extends KAnnotatedElement {

    /* compiled from: KParameter.kt */
    @Metadata(mv = {1, 5, 1}, k = 3)
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/reflect/KParameter$DefaultImpls.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-stdlib-1.5.21.jar:kotlin/reflect/KParameter$Kind.class */
    public enum Kind {
        INSTANCE,
        EXTENSION_RECEIVER,
        VALUE
