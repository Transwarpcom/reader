...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/descriptors/impl/MutableClassDescriptor.class */
public class MutableClassDescriptor extends ClassDescriptorBase {
    ...
    public MutableClassDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull ClassKind kind, boolean isInner, boolean isExternal, @NotNull Name name, @NotNull SourceElement source, @NotNull StorageManager storageManager) {
        ...
        if (!$assertionsDisabled && kind == ClassKind.OBJECT) {
    ...
    public void createTypeConstructor() {
        ...
        for (ClassConstructorDescriptor functionDescriptor : getConstructors()) {
