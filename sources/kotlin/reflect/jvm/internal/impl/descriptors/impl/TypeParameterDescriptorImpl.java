...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/descriptors/impl/TypeParameterDescriptorImpl.class */
public class TypeParameterDescriptorImpl extends AbstractTypeParameterDescriptor {
    ...
    @NotNull
    public static TypeParameterDescriptor createWithDefaultBound(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, boolean reified, @NotNull Variance variance, @NotNull Name name, int index, @NotNull StorageManager storageManager) {
    ...
    public static TypeParameterDescriptorImpl createForFurtherModification(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, boolean reified, @NotNull Variance variance, @NotNull Name name, int index, @NotNull SourceElement source, @NotNull StorageManager storageManager) {
        if (containingDeclaration == null) {
            $$$reportNull$$$0(6);
        }
        if (annotations == null) {
