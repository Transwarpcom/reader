...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/resolve/jvm/JavaDescriptorResolver.class */
public final class JavaDescriptorResolver {
    ...
    public final ClassDescriptor resolveClass(@NotNull JavaClass javaClass) {
        ...
        if (outerClass != null) {
            ...
            MemberScope outerClassScope = classDescriptorResolveClass == null ? null : classDescriptorResolveClass.getUnsubstitutedInnerClassesScope();
            ClassifierDescriptor contributedClassifier = outerClassScope == null ? null : outerClassScope.mo3858getContributedClassifier(javaClass.getName(), NoLookupLocation.FROM_JAVA_LOADER);
