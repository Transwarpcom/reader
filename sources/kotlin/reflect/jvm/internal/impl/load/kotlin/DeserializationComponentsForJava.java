...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/load/kotlin/DeserializationComponentsForJava.class */
public final class DeserializationComponentsForJava {
    ...
    public DeserializationComponentsForJava(@NotNull StorageManager storageManager, @NotNull ModuleDescriptor moduleDescriptor, @NotNull DeserializationConfiguration configuration, @NotNull JavaClassDataFinder classDataFinder, @NotNull BinaryClassAnnotationAndConstantLoaderImpl annotationAndConstantLoader, @NotNull LazyJavaPackageFragmentProvider packageFragmentProvider, @NotNull NotFoundClasses notFoundClasses, @NotNull ErrorReporter errorReporter, @NotNull LookupTracker lookupTracker, @NotNull ContractDeserializer contractDeserializer, @NotNull NewKotlinTypeChecker kotlinTypeChecker) {
        ...
        JvmBuiltInsCustomizer customizer = jvmBuiltIns == null ? null : jvmBuiltIns.getCustomizer();
        JvmBuiltInsCustomizer jvmBuiltInsCustomizer = customizer == null ? AdditionalClassPartsProvider.None.INSTANCE : customizer;
        JvmBuiltInsCustomizer customizer2 = jvmBuiltIns == null ? null : jvmBuiltIns.getCustomizer();
        this.components = new DeserializationComponents(storageManager, moduleDescriptor, configuration, javaClassDataFinder, binaryClassAnnotationAndConstantLoaderImpl, lazyJavaPackageFragmentProvider, r9, errorReporter, lookupTracker, javaFlexibleTypeDeserializer, listEmptyList, notFoundClasses, contractDeserializer, jvmBuiltInsCustomizer, customizer2 == null ? PlatformDependentDeclarationFilter.NoPlatformDependent.INSTANCE : customizer2, JvmProtoBufUtil.INSTANCE.getEXTENSION_REGISTRY(), kotlinTypeChecker, new SamConversionResolverImpl(storageManager, CollectionsKt.emptyList()), null, 262144, null);
    }
