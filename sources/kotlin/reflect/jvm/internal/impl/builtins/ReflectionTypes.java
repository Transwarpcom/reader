...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/builtins/ReflectionTypes.class */
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String className, int numberOfTypeParameters) {
        ...
        Intrinsics.checkNotNullExpressionValue(name, "identifier(className)");
        ClassifierDescriptor contributedClassifier = getKotlinReflectScope().mo3858getContributedClassifier(name, NoLookupLocation.FROM_REFLECTION);
    ...
    /* compiled from: ReflectionTypes.kt */
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/builtins/ReflectionTypes$ClassLookup.class */
    ...
    /* compiled from: ReflectionTypes.kt */
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/builtins/ReflectionTypes$Companion.class */
    public static final class Companion {
        ...
        public final KotlinType createKPropertyStarType(@NotNull ModuleDescriptor module) {
            ...
            return KotlinTypeFactory.simpleNotNullType(empty, kPropertyClass, CollectionsKt.listOf(new StarProjectionImpl((TypeParameterDescriptor) objSingle)));
        }
    }
}
