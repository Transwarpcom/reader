...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/builtins/UnsignedArrayType.class */
public final class UnsignedArrayType {
    ...
    private UnsignedArrayType(String $enum$name, int $enum$ordinal, ClassId classId) {
