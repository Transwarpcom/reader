...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/builtins/KotlinBuiltIns.class */
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.primitives = storageManager.createLazyValue(new Function0<Primitives>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.2
            ...
            public Primitives invoke() {
                ...
                PrimitiveType[] arr$ = PrimitiveType.values();
                for (PrimitiveType primitive : arr$) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo3858getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (classifier == null) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/builtins/KotlinBuiltIns$Primitives.class */
    ...
    public ModuleDescriptorImpl getBuiltInsModule() {
        if (!$assertionsDisabled && this.builtInsModule == null && this.postponedBuiltInsModule == null) {
    ...
    private ClassDescriptor getBuiltInClassByName(@NotNull String simpleName) {
        ...
        ClassDescriptor classDescriptorInvoke = this.builtInClassesByName.invoke(Name.identifier(simpleName));
    ...
    public ClassDescriptor getSuspendFunction(int parameterCount) {
        ClassDescriptor builtInClassByFqName = getBuiltInClassByFqName(StandardNames.COROUTINES_PACKAGE_FQ_NAME_RELEASE.child(Name.identifier(StandardNames.getSuspendFunctionName(parameterCount))));
    ...
    @NotNull
    public SimpleType getBuiltInTypeByClassName(@NotNull String classSimpleName) {
    ...
    public KotlinType getArrayElementType(@NotNull KotlinType arrayType) {
        ...
        if (isArray(arrayType)) {
            ...
            KotlinType type = arrayType.getArguments().get(0).getType();
            if (type == null) {
                $$$reportNull$$$0(68);
            }
            return type;
    ...
    private static KotlinType getElementTypeForUnsignedArray(@NotNull KotlinType notNullArrayType, @NotNull ModuleDescriptor module) {
        ...
        ClassifierDescriptor descriptor = notNullArrayType.getConstructor().mo3831getDeclarationDescriptor();
    ...
    public SimpleType getArrayType(@NotNull Variance projectionType, @NotNull KotlinType argument, @NotNull Annotations annotations) {
        ...
        SimpleType simpleTypeSimpleNotNullType = KotlinTypeFactory.simpleNotNullType(annotations, getArray(), types);
