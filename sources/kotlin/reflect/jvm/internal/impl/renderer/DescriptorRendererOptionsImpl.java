...
/* loaded from: reader.jar:BOOT-INF/lib/kotlin-reflect-1.5.21.jar:kotlin/reflect/jvm/internal/impl/renderer/DescriptorRendererOptionsImpl.class */
        ...
        while (i < length) {
            ...
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (property == null) {
                    ...
                    boolean z = !StringsKt.startsWith$default(name, BeanUtil.PREFIX_GETTER_IS, false, 2, (Object) null);
                    if (_Assertions.ENABLED && !z) {
                    ...
                    if (name3.length() > 0) {
                        ...
                        descriptorRendererOptionsImpl = descriptorRendererOptionsImpl;
                        ...
                        str = String.valueOf(upperCase) + strSubstring;
                    } else {
                        str = name3;
                    }
                    Object value = observableProperty.getValue(descriptorRendererOptionsImpl, new PropertyReference1Impl(orCreateKotlinClass, name2, Intrinsics.stringPlus(str2, str)));
