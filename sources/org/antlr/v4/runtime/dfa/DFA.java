...
/* loaded from: reader.jar:BOOT-INF/lib/antlr4-runtime-4.7.2.jar:org/antlr/v4/runtime/dfa/DFA.class */
public class DFA {
    ...
    public List<DFAState> getStates() {
        ...
        Collections.sort(result, new Comparator<DFAState>() { // from class: org.antlr.v4.runtime.dfa.DFA.1
