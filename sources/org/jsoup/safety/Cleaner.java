...
/* loaded from: reader.jar:BOOT-INF/lib/jsoup-1.14.1.jar:org/jsoup/safety/Cleaner.class */
public class Cleaner {
    ...
    public Document clean(Document dirtyDocument) {
        ...
        clean.outputSettings(dirtyDocument.outputSettings().m5205clone());
        return clean;
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/jsoup-1.14.1.jar:org/jsoup/safety/Cleaner$CleaningVisitor.class */
    private final class CleaningVisitor implements NodeVisitor {
        ...
        public void head(Node source, int depth) {
            ...
            if (!(source instanceof TextNode)) {
                if ((source instanceof DataNode) && Cleaner.this.safelist.isSafeTag(source.parent().nodeName())) {
    ...
    public ElementMeta createSafeElement(Element sourceEl) {
        ...
        Iterator<Attribute> it = sourceAttrs.iterator();
        while (it.hasNext()) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/jsoup-1.14.1.jar:org/jsoup/safety/Cleaner$ElementMeta.class */
