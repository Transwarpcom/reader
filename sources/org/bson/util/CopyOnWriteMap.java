...
/* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/util/CopyOnWriteMap.class */
abstract class CopyOnWriteMap<K, V> extends AbstractCopyOnWriteMap<K, V, Map<K, V>> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/util/CopyOnWriteMap$Builder.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/util/CopyOnWriteMap$Hash.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/util/CopyOnWriteMap$Linked.class */
