...
/* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/BsonValue.class */
public abstract class BsonValue {
    ...
    private void throwIfInvalidType(BsonType expectedType) {
        if (getBsonType() != expectedType) {
            throw new BsonInvalidOperationException(String.format("Value expected to be of type %s is of unexpected type %s", expectedType, getBsonType()));
        }
    }
}
