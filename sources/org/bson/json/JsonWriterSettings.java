...
/* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/json/JsonWriterSettings.class */
public class JsonWriterSettings extends BsonWriterSettings {
    ...
    private JsonWriterSettings(Builder builder) {
        ...
        if (this.outputMode == JsonMode.EXTENDED || this.outputMode == JsonMode.RELAXED) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/bson-3.8.2.jar:org/bson/json/JsonWriterSettings$Builder.class */
