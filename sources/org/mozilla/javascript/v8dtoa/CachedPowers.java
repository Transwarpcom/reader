...
/* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/v8dtoa/CachedPowers.class */
public class CachedPowers {
    ...
    static {
        $assertionsDisabled = !CachedPowers.class.desiredAssertionStatus();
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/v8dtoa/CachedPowers$CachedPower.class */
    ...
    static int getCachedPower(int e, int alpha, int gamma, DiyFp c_mk) {
        double k = Math.ceil((((alpha - e) + 64) - 1) * kD_1_LOG2_10);
        ...
        if ($assertionsDisabled || (alpha <= c_mk.e() + e && c_mk.e() + e <= gamma)) {
