...
/* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/optimizer/ClassCompiler.class */
public class ClassCompiler {
    ...
    public Object[] compileToClassFiles(String source, String sourceLocation, int lineno, String mainClassName) throws NoSuchMethodException, RuntimeException {
        ...
        if (isPrimary) {
            ...
            scriptClassName = makeAuxiliaryClassName(mainClassName, CustomBooleanEditor.VALUE_1);
        }
