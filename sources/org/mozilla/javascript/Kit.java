...
/* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/Kit.class */
public class Kit {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/Kit$ComplexKey.class */
    ...
    public static String readReader(Reader reader) throws IOException {
        ...
        try {
            ...
            while (true) {
                int bytes_read = in.read(cbuf, 0, 1024);
                if (bytes_read == -1) {
                    break;
                }
