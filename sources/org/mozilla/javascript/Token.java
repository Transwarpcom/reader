...
/* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/Token.class */
public class Token {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/Token$CommentType.class */
    ...
    public static String typeToName(int token) {
        switch (token) {
            ...
            case 84:
                return "LB";
            case 85:
                return StandardStructureTypes.RB;
            case 86:
                return "LC";
            case 87:
                return "RC";
            case 88:
                return "LP";
            case 89:
                return StandardStructureTypes.RP;
            case 90:
                return "COMMA";
            case 91:
                return "ASSIGN";
