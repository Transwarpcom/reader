...
/* loaded from: reader.jar:BOOT-INF/lib/rhino-1.7.13-1.jar:org/mozilla/javascript/ObjArray.class */
public class ObjArray implements Serializable {
    ...
    public final void remove(int index) {
        ...
        switch (index) {
            ...
            default:
                if (index != N2) {
                    System.arraycopy(this.data, (index - 5) + 1, this.data, index - 5, N2 - index);
                }
                this.data[N2 - 5] = null;
                break;
        }
    ...
    private void ensureCapacity(int minimalCapacity) {
        ...
        if (this.data == null) {
            ...
            this.data = new Object[alloc2];
            return;
        }
        int alloc3 = this.data.length;
        if (alloc3 < required) {
            if (alloc3 <= 5) {
                alloc = 10;
            } else {
