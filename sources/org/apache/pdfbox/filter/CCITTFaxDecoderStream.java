...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/filter/CCITTFaxDecoderStream.class */
final class CCITTFaxDecoderStream extends FilterInputStream {
    ...
    public CCITTFaxDecoderStream(InputStream stream, int columns, int type, long options, boolean byteAligned) {
        ...
        switch (type) {
            ...
            case 3:
                ...
                this.optionG3Fill = (options & 4) != 0;
                this.optionUncompressed = (options & 2) != 0;
                return;
            case 4:
                this.optionByteAligned = byteAligned;
                this.optionG32D = false;
    ...
    private boolean readBit() throws IOException {
        ...
        boolean isSet = (this.buffer & 128) != 0;
        this.buffer <<= 1;
        this.bufferPos++;
        return isSet;
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/filter/CCITTFaxDecoderStream$Node.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/filter/CCITTFaxDecoderStream$Tree.class */
