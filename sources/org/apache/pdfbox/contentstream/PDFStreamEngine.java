...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/contentstream/PDFStreamEngine.class */
public abstract class PDFStreamEngine {
    private static final Log LOG = LogFactory.getLog((Class<?>) PDFStreamEngine.class);
    ...
    protected void processTransparencyGroup(PDTransparencyGroup group) throws IOException {
        ...
        this.initialMatrix = graphicsState.getCurrentTransformationMatrix().m5119clone();
    ...
    protected void processAnnotation(PDAnnotation annotation, PDAppearanceStream appearance) throws IOException {
        ...
        if (rect != null && rect.getWidth() > 0.0f && rect.getHeight() > 0.0f && bbox != null && bbox.getWidth() > 0.0f && bbox.getHeight() > 0.0f) {
            ...
            clipToRect(bbox);
            this.initialMatrix = aa.m5119clone();
            try {
    ...
    public void saveGraphicsState() {
        this.graphicsStack.push(this.graphicsStack.peek().m5050clone());
    }
    ...
    protected final Deque<PDGraphicsState> saveGraphicsStack() {
        ...
        this.graphicsStack.add(savedStack.peek().m5050clone());
        return savedStack;
    }
