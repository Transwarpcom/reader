...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/rendering/TilingPaint.class */
class TilingPaint implements Paint {
    private static final Log LOG = LogFactory.getLog((Class<?>) TilingPaint.class);
