...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/rendering/PageDrawer.class */
public class PageDrawer extends PDFGraphicsStreamEngine {
    private static final Log LOG = LogFactory.getLog((Class<?>) PageDrawer.class);
    ...
    protected void showFontGlyph(Matrix textRenderingMatrix, PDFont font, int code, Vector displacement) throws IOException {
        ...
        try {
            ...
            LOG.error("Could not draw glyph for code " + code + " at position (" + at.getTranslateX() + "," + at.getTranslateY() + ")", ex);
        }
    }
    ...
    private Stroke getStroke() {
        ...
        if (isAllZeroDash(dashArray)) {
            return new Stroke() { // from class: org.apache.pdfbox.rendering.PageDrawer.2
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/rendering/PageDrawer$TransparencyGroup.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean hasBlendMode(PDTransparencyGroup group, Set<COSBase> groupsDone) {
        PDXObject xObject;
    ...
    public void beginMarkedContentSequence(COSName tag, COSDictionary properties) {
        ...
        } else if (tag != null && getPage().getResources() != null && isHiddenOCG(getPage().getResources().getProperties(tag))) {
