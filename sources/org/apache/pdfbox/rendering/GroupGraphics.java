...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/rendering/GroupGraphics.class */
class GroupGraphics extends Graphics2D {
    ...
    private int backdropRemoval(int groupRGB, int backdropRGB, int shift, float alphaFactor) {
        float cn2 = (groupRGB >> shift) & 255;
        float c0 = (backdropRGB >> shift) & 255;
        int c = Math.round(cn2 + ((cn2 - c0) * alphaFactor));
        if (c < 0) {
            return 0;
        }
        if (c > 255) {
