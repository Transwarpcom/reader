...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/graphics/shading/Type1ShadingPaint.class */
class Type1ShadingPaint extends ShadingPaint<PDShadingType1> {
    private static final Log LOG = LogFactory.getLog((Class<?>) Type1ShadingPaint.class);
