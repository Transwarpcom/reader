...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/graphics/state/PDGraphicsState.class */
public class PDGraphicsState implements Cloneable {
    ...
    public PDGraphicsState m5050clone() {
        try {
            PDGraphicsState clone = (PDGraphicsState) super.clone();
            clone.textState = this.textState.m5052clone();
            clone.currentTransformationMatrix = this.currentTransformationMatrix.m5119clone();
