...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/font/PDCIDFontType2Embedder.class */
final class PDCIDFontType2Embedder extends TrueTypeEmbedder {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/font/PDCIDFontType2Embedder$State.class */
    enum State {
        FIRST,
        BRACKET,
        SERIAL
    ...
    PDCIDFontType2Embedder(PDDocument document, COSDictionary dict, TrueTypeFont ttf, boolean embedSubset, PDType0Font parent, boolean vertical) throws IOException, NumberFormatException {
    ...
    protected void buildSubset(InputStream ttfSubset, String tag, Map<Integer, Integer> gidToCid) throws IOException, NumberFormatException {
    ...
    private void buildToUnicodeCMap(Map<Integer, Integer> newGIDToOldCID) throws IOException, NumberFormatException {
        int cid;
        ...
        PDStream stream = new PDStream(this.document, cMapStream, COSName.FLATE_DECODE);
        if (hasSurrogates) {
    ...
    private void buildCIDToGIDMap(TreeMap<Integer, Integer> cidToGid) throws IOException {
        ...
        PDStream stream = new PDStream(this.document, input, COSName.FLATE_DECODE);
