...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/PDAbstractContentStream.class */
abstract class PDAbstractContentStream implements Closeable {
    private static final Log LOG = LogFactory.getLog((Class<?>) PDAbstractContentStream.class);
