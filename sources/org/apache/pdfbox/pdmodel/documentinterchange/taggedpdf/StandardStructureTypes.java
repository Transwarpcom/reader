...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/documentinterchange/taggedpdf/StandardStructureTypes.class */
public class StandardStructureTypes {
    ...
    private static final Log LOG = LogFactory.getLog((Class<?>) StandardStructureTypes.class);
