...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/documentinterchange/taggedpdf/PDLayoutAttributeObject.class */
public class PDLayoutAttributeObject extends PDStandardAttributeObject {
    ...
    public String toString() {
        ...
        if (isSpecified(LINE_HEIGHT)) {
            sb.append(", LineHeight=").append(getLineHeight());
        }
