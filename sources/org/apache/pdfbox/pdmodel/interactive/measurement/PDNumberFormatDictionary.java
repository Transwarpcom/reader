...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/interactive/measurement/PDNumberFormatDictionary.class */
public class PDNumberFormatDictionary implements COSObjectable {
    ...
    public void setConversionFactor(float conversionFactor) {
        getCOSObject().setFloat("C", conversionFactor);
    }
