...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/interactive/annotation/layout/PlainTextFormatter.class */
public class PlainTextFormatter {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/interactive/annotation/layout/PlainTextFormatter$TextAlign.class */
    enum TextAlign {
        LEFT(0),
        CENTER(1),
        RIGHT(2),
        ...
        public static TextAlign valueOf(int alignment) {
            for (TextAlign textAlignment : values()) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/interactive/annotation/layout/PlainTextFormatter$Builder.class */
