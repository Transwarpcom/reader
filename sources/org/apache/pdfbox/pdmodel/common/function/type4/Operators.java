...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/common/function/type4/Operators.class */
public class Operators {
    ...
    public Operators() {
        this.operators.put(BeanUtil.PREFIX_ADDER, ADD);
