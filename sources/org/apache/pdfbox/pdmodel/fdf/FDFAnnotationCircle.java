...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/pdmodel/fdf/FDFAnnotationCircle.class */
public class FDFAnnotationCircle extends FDFAnnotation {
    ...
    public FDFAnnotationCircle(Element element) throws NumberFormatException, IOException {
        super(element);
        this.annot.setName(COSName.SUBTYPE, "Circle");
