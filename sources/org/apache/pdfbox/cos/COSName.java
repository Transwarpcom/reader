...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/cos/COSName.class */
public final class COSName extends COSBase implements Comparable<COSName> {
    ...
    public static final COSName DOMAIN = new COSName(CookieHeaderNames.DOMAIN);
    ...
    public static final COSName PATH = new COSName(CookieHeaderNames.PATH);
    ...
    public static final COSName URL = new COSName(Identifier.Scheme.URL);
