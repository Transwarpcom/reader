...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/text/PDFTextStripper.class */
public class PDFTextStripper extends LegacyPDFStreamEngine {
    ...
    private static final Log LOG = LogFactory.getLog((Class<?>) PDFTextStripper.class);
    ...
    static {
        ...
        InputStream input = new BufferedInputStream(PDFTextStripper.class.getResourceAsStream("/org/apache/pdfbox/resources/text/BidiMirroring.txt"));
        try {
            try {
                parseBidiFile(input);
                try {
                    ...
                    LOG.error("Could not close BidiMirroring.txt ", e4);
                }
            } catch (IOException e5) {
                LOG.warn("Could not parse BidiMirroring.txt, mirroring char map will be empty: " + e5.getMessage());
                try {
                    input.close();
                } catch (IOException e6) {
                    LOG.error("Could not close BidiMirroring.txt ", e6);
                }
            }
        } catch (Throwable th) {
            try {
                ...
                LOG.error("Could not close BidiMirroring.txt ", e7);
            }
            throw th;
        }
    }
    ...
    @Override // org.apache.pdfbox.text.LegacyPDFStreamEngine, org.apache.pdfbox.contentstream.PDFStreamEngine
    ...
    private String handleDirection(String word) {
        ...
        for (int i2 = 0; i2 < runCount; i2++) {
            ...
            if ((levels[index] & 1) != 0) {
                ...
                result.append((CharSequence) word, start, end);
            }
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/text/PDFTextStripper$LineItem.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/text/PDFTextStripper$WordWithTextPositions.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/text/PDFTextStripper$PositionWrapper.class */
