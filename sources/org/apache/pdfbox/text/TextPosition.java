...
/* loaded from: reader.jar:BOOT-INF/lib/pdfbox-2.0.27.jar:org/apache/pdfbox/text/TextPosition.class */
public final class TextPosition {
    private static final Log LOG = LogFactory.getLog((Class<?>) TextPosition.class);
    ...
    public boolean equals(Object o) {
        ...
        if (this.textMatrix != null) {
            if (!this.textMatrix.equals(that.textMatrix)) {
                return false;
            }
        } else if (that.textMatrix != null) {
            return false;
        }
