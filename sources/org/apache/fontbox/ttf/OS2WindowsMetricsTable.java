...
/* loaded from: reader.jar:BOOT-INF/lib/fontbox-2.0.27.jar:org/apache/fontbox/ttf/OS2WindowsMetricsTable.class */
public class OS2WindowsMetricsTable extends TTFTable {
    private static final Log LOG = LogFactory.getLog((Class<?>) OS2WindowsMetricsTable.class);
        ...
        try {
            ...
            if (this.version >= 2) {
                try {
                    ...
                    this.version = 1;
                    LOG.warn("Could not read all expected parts of version >= 2, setting version to 1", ex2);
                    this.initialized = true;
                    return;
                }
            }
