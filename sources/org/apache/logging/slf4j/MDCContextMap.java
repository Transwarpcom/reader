...
/* loaded from: reader.jar:BOOT-INF/lib/log4j-to-slf4j-2.11.2.jar:org/apache/logging/slf4j/MDCContextMap.class */
public class MDCContextMap implements CleanableThreadContextMap {
    ...
    public void putAll(Map<String, String> m) throws IllegalArgumentException {
    ...
    public void removeAll(Iterable<String> keys) throws IllegalArgumentException {
        for (String key : keys) {
            MDC.remove(key);
        }
    }
