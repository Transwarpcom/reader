...
/* loaded from: reader.jar:BOOT-INF/lib/log4j-api-2.11.2.jar:org/apache/logging/log4j/util/SortedArrayStringMap.class */
public class SortedArrayStringMap implements IndexedStringMap {
    ...
    private static Object unmarshall(byte[] data, ObjectInputStream inputStream) throws IllegalAccessException, IOException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
