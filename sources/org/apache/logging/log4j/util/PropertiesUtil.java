...
/* loaded from: reader.jar:BOOT-INF/lib/log4j-api-2.11.2.jar:org/apache/logging/log4j/util/PropertiesUtil.class */
public final class PropertiesUtil {
    ...
    static Properties loadClose(InputStream in, Object source) throws IOException {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/log4j-api-2.11.2.jar:org/apache/logging/log4j/util/PropertiesUtil$Environment.class */
    private static class Environment {
        ...
        private Environment(PropertySource propertySource) {
            ...
            for (ClassLoader classLoader : arr$) {
                try {
                    Iterator i$ = ServiceLoader.load(PropertySource.class, classLoader).iterator();
                    while (i$.hasNext()) {
