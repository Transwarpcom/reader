...
/* loaded from: reader.jar:BOOT-INF/lib/log4j-api-2.11.2.jar:org/apache/logging/log4j/message/StructuredDataId.class */
public class StructuredDataId implements Serializable, StringBuilderFormattable {
    ...
    public static final StructuredDataId ORIGIN = new StructuredDataId(HttpHeaders.ReferrerPolicyValues.ORIGIN, null, new String[]{"ip", "enterpriseId", "software", "swVersion"});
    public static final StructuredDataId META = new StructuredDataId("meta", null, new String[]{"sequenceId", "sysUpTime", PackageDocumentBase.DCTags.language});
