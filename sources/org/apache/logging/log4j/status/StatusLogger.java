...
/* loaded from: reader.jar:BOOT-INF/lib/log4j-api-2.11.2.jar:org/apache/logging/log4j/status/StatusLogger.class */
public final class StatusLogger extends AbstractLogger {
    ...
    public void removeListener(StatusListener listener) throws IOException {
    ...
    private static void closeSilently(Closeable resource) throws IOException {
        try {
            resource.close();
        } catch (IOException e) {
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/log4j-api-2.11.2.jar:org/apache/logging/log4j/status/StatusLogger$BoundedQueue.class */
