...
@Deprecated
/* loaded from: reader.jar:BOOT-INF/lib/commons-lang3-3.8.1.jar:org/apache/commons/lang3/text/translate/EntityArrays.class */
public class EntityArrays {
    ...
    private static final String[][] BASIC_ESCAPE = {new String[]{OperatorName.SHOW_TEXT_LINE_AND_SPACE, "&quot;"}, new String[]{BeanFactory.FACTORY_BEAN_PREFIX, "&amp;"}, new String[]{"<", "&lt;"}, new String[]{">", "&gt;"}};
    private static final String[][] BASIC_UNESCAPE = invert(BASIC_ESCAPE);
    private static final String[][] APOS_ESCAPE = {new String[]{OperatorName.SHOW_TEXT_LINE, "&apos;"}};
