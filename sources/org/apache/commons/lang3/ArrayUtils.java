...
/* loaded from: reader.jar:BOOT-INF/lib/commons-lang3-3.8.1.jar:org/apache/commons/lang3/ArrayUtils.class */
public class ArrayUtils {
    ...
    public static String toString(Object array) {
        return toString(array, StrPool.EMPTY_JSON);
    }
    ...
    private static Object copyArrayGrow1(Object array, Class<?> newArrayComponentType) throws NegativeArraySizeException {
        if (array != null) {
    ...
    private static Object add(Object array, int index, Object element, Class<?> clss) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        if (array == null) {
            if (index != 0) {
    ...
    private static Object remove(Object array, int index) throws NegativeArraySizeException {
    ...
    static Object removeAll(Object array, int... indices) throws NegativeArraySizeException {
        int index;
        int length = getLength(array);
        int diff = 0;
    ...
    static Object removeAll(Object array, BitSet indices) throws NegativeArraySizeException {
    ...
    public static boolean[] removeAllOccurences(boolean[] array, boolean element) {
        ...
        int count = 1;
        while (true) {
            int index2 = indexOf(array, element, indices[count - 1] + 1);
            if (index2 != -1) {
                int i = count;
                count++;
                indices[i] = index2;
