...
/* loaded from: reader.jar:BOOT-INF/lib/commons-lang3-3.8.1.jar:org/apache/commons/lang3/time/GmtTimeZone.class */
class GmtTimeZone extends TimeZone {
    ...
    GmtTimeZone(boolean negate, int hours, int minutes) {
        ...
        this.zoneId = twoDigits(twoDigits(new StringBuilder(9).append(TimeZones.GMT_ID).append(negate ? '-' : '+'), hours).append(':'), minutes).toString();
    }
