...
/* loaded from: reader.jar:BOOT-INF/lib/commons-lang3-3.8.1.jar:org/apache/commons/lang3/Conversion.class */
public class Conversion {
    ...
    public static long shortArrayToLong(short[] src, int srcPos, long dstInit, int dstPos, int nShorts) {
        ...
        for (int i = 0; i < nShorts; i++) {
            ...
            long bits = (WebSocketProtocol.PAYLOAD_SHORT_MAX & src[i + srcPos]) << shift;
