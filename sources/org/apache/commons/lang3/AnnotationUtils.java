...
/* loaded from: reader.jar:BOOT-INF/lib/commons-lang3-3.8.1.jar:org/apache/commons/lang3/AnnotationUtils.class */
public class AnnotationUtils {
    private static final ToStringStyle TO_STRING_STYLE = new ToStringStyle() { // from class: org.apache.commons.lang3.AnnotationUtils.1
        ...
        @Override // org.apache.commons.lang3.builder.ToStringStyle
        protected void appendDetail(StringBuffer buffer, String fieldName, Object value) throws SecurityException {
    ...
    public static boolean equals(Annotation a1, Annotation a2) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (a1 == a2) {
            return true;
        }
        if (a1 == null || a2 == null) {
    ...
    public static int hashCode(Annotation a) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        int result = 0;
    ...
    public static String toString(Annotation a) throws SecurityException {
