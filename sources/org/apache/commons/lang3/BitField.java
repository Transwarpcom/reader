...
/* loaded from: reader.jar:BOOT-INF/lib/commons-lang3-3.8.1.jar:org/apache/commons/lang3/BitField.class */
public class BitField {
    ...
    public int setValue(int holder, int value) {
        return (holder & (this._mask ^ (-1))) | ((value << this._shift_count) & this._mask);
    }
