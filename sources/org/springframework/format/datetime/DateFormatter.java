...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/format/datetime/DateFormatter.class */
public class DateFormatter implements Formatter<Date> {
    ...
    private DateFormat createDateFormat(Locale locale) {
        ...
        if (StringUtils.hasLength(this.stylePattern)) {
            ...
            throw new IllegalStateException("Unsupported style pattern '" + this.stylePattern + OperatorName.SHOW_TEXT_LINE);
        }
