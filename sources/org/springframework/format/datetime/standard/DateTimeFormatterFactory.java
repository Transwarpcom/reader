...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/format/datetime/standard/DateTimeFormatterFactory.class */
public class DateTimeFormatterFactory {
    ...
    private FormatStyle convertStyleCharacter(char c) {
        switch (c) {
            ...
            default:
                throw new IllegalArgumentException("Invalid style character '" + c + OperatorName.SHOW_TEXT_LINE);
        }
    }
