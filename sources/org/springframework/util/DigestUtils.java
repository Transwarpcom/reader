...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/DigestUtils.class */
public abstract class DigestUtils {
    ...
    private static MessageDigest getDigest(String algorithm) {
        try {
            ...
            throw new IllegalStateException("Could not find MessageDigest with algorithm \"" + algorithm + OperatorName.SHOW_TEXT_LINE_AND_SPACE, ex);
        }
    }
