...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/concurrent/MonoToListenableFutureAdapter.class */
public class MonoToListenableFutureAdapter<T> implements ListenableFuture<T> {
    ...
    public MonoToListenableFutureAdapter(Mono<T> mono) {
        ...
        Mono monoDoOnSuccess = mono.doOnSuccess(listenableFutureCallbackRegistry::success);
        ...
        this.processor = monoDoOnSuccess.doOnError(listenableFutureCallbackRegistry2::failure).toProcessor();
    }
