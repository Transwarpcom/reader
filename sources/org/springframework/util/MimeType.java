...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/MimeType.class */
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    private void checkToken(String token) {
        for (int i = 0; i < token.length(); i++) {
            ...
            if (!TOKEN.get(ch2)) {
                throw new IllegalArgumentException("Invalid token character '" + ch2 + "' in token \"" + token + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            }
        }
    }
    ...
    private boolean isQuotedString(String s) {
        ...
        return (s.startsWith(OperatorName.SHOW_TEXT_LINE_AND_SPACE) && s.endsWith(OperatorName.SHOW_TEXT_LINE_AND_SPACE)) || (s.startsWith(OperatorName.SHOW_TEXT_LINE) && s.endsWith(OperatorName.SHOW_TEXT_LINE));
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/MimeType$SpecificityComparator.class */
