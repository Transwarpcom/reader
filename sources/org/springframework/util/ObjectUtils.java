...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/ObjectUtils.class */
public abstract class ObjectUtils {
    ...
    public static String identityToString(@Nullable Object obj) {
        ...
        return obj.getClass().getName() + StrPool.AT + getIdentityHexString(obj);
    }
    ...
    public static String nullSafeToString(@Nullable char[] array) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            sb.append(OperatorName.SHOW_TEXT_LINE).append(array[i]).append(OperatorName.SHOW_TEXT_LINE);
        }
        sb.append("}");
        return sb.toString();
    }
