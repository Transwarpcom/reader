...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/xml/DomContentHandler.class */
class DomContentHandler implements ContentHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws DOMException {
        ...
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (!attrQname.startsWith(NCXDocumentV3.XHTMLAttributes.xmlns)) {
