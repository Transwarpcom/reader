...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/xml/XmlValidationModeDetector.class */
public class XmlValidationModeDetector {
    ...
    private String consumeCommentTokens(String line) {
        ...
        while (true) {
            String strConsume = consume(currLine);
            currLine = strConsume;
            if (strConsume != null) {
