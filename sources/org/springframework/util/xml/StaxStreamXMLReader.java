...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/xml/StaxStreamXMLReader.class */
        ...
        if (hasNamespacePrefixesFeature()) {
            for (int i2 = 0; i2 < this.reader.getNamespaceCount(); i2++) {
                ...
                if (StringUtils.hasLength(prefix)) {
                    ...
                    str = NCXDocumentV3.XHTMLAttributes.xmlns;
                }
                String qName = str;
