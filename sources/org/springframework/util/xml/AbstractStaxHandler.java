...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/xml/AbstractStaxHandler.class */
abstract class AbstractStaxHandler implements ContentHandler, LexicalHandler {
    ...
    protected boolean isNamespaceDeclaration(QName qName) {
        ...
        return (NCXDocumentV3.XHTMLAttributes.xmlns.equals(localPart) && prefix.isEmpty()) || (NCXDocumentV3.XHTMLAttributes.xmlns.equals(prefix) && !localPart.isEmpty());
    }
