...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/util/xml/StaxEventXMLReader.class */
        ...
        if (hasNamespacePrefixesFeature()) {
            ...
            while (i2.hasNext()) {
                ...
                if (StringUtils.hasLength(prefix)) {
                    ...
                    qName = NCXDocumentV3.XHTMLAttributes.xmlns;
                }
