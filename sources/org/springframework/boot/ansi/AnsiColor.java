...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/ansi/AnsiColor.class */
public enum AnsiColor implements AnsiElement {
    ...
    BRIGHT_BLACK(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_90_DEGREES),
    BRIGHT_RED("91"),
    BRIGHT_GREEN("92"),
    BRIGHT_YELLOW("93"),
    BRIGHT_BLUE("94"),
