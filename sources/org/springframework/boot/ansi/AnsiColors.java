...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/ansi/AnsiColors.class */
public final class AnsiColors {
    ...
    static {
        ...
        colorMap.put(AnsiColor.BLUE, new LabColor((Integer) 170));
        ...
        colorMap.put(AnsiColor.BRIGHT_WHITE, new LabColor(Integer.valueOf(Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND)));
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/ansi/AnsiColors$LabColor.class */
