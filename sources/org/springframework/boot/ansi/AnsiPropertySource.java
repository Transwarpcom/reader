...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/ansi/AnsiPropertySource.class */
public class AnsiPropertySource extends PropertySource<AnsiElement> {
        ...
        if (StringUtils.hasLength(name)) {
            for (MappedEnum<?> mappedEnum : MAPPED_ENUMS) {
                if (name.startsWith(mappedEnum.getPrefix())) {
                    ...
                    for (E e : mappedEnum.getEnums()) {
                        if (e.name().equals(enumName)) {
                            if (this.encode) {
                                return AnsiOutput.encode((AnsiElement) e);
                            }
                            return e;
                        }
                    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/ansi/AnsiPropertySource$MappedEnum.class */
