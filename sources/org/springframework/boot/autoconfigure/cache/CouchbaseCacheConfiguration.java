...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/cache/CouchbaseCacheConfiguration.class */
public class CouchbaseCacheConfiguration {
    ...
    public CouchbaseCacheManager cacheManager() {
        ...
        couchbase.getClass();
        PropertyMapper.Source<Integer> sourceAsInt = propertyMapper.from(couchbase::getExpiration).whenNonNull().asInt((v0) -> {
