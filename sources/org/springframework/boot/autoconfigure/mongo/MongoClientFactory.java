...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/mongo/MongoClientFactory.class */
public class MongoClientFactory {
    ...
    private MongoClient createNetworkMongoClient(MongoClientOptions options) {
        ...
        if (hasCustomAddress() || hasCustomCredentials()) {
            ...
            int port = ((Integer) getValue(properties.getPort(), Integer.valueOf(MongoProperties.DEFAULT_PORT))).intValue();
