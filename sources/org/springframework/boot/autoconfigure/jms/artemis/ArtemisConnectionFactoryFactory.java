...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/jms/artemis/ArtemisConnectionFactoryFactory.class */
class ArtemisConnectionFactoryFactory {
    ...
    private <T extends ActiveMQConnectionFactory> T createNativeConnectionFactory(Class<T> factoryClass) throws Exception {
        ...
        params.put(RtspHeaders.Values.PORT, Integer.valueOf(this.properties.getPort()));
