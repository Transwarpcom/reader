...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/data/cassandra/CassandraDataAutoConfiguration.class */
public class CassandraDataAutoConfiguration {
    ...
    public CassandraMappingContext cassandraMapping(CassandraCustomConversions conversions) throws ClassNotFoundException {
        ...
        PropertyMapper.Source sourceAs = propertyMapper.from(cassandraProperties::getKeyspaceName).whenHasText().as(this::createSimpleUserTypeResolver);
        context.getClass();
        sourceAs.to((v1) -> {
