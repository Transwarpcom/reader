...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/data/OnRepositoryTypeCondition.class */
class OnRepositoryTypeCondition extends SpringBootCondition {
    ...
    private RepositoryType getTypeProperty(Environment environment, String store) {
        return RepositoryType.valueOf(environment.getProperty(String.format("spring.data.%s.repositories.type", store), DebugKt.DEBUG_PROPERTY_VALUE_AUTO).toUpperCase(Locale.ENGLISH));
    }
}
