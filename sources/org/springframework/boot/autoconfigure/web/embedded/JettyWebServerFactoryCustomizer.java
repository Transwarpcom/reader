...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/web/embedded/JettyWebServerFactoryCustomizer.class */
public class JettyWebServerFactoryCustomizer implements WebServerFactoryCustomizer<ConfigurableJettyWebServerFactory>, Ordered {
    ...
    public void customize(ConfigurableJettyWebServerFactory factory) {
        ...
        PropertyMapper.Source sourceWhenNonNull = propertyMapper.from(jettyProperties::getAcceptors).whenNonNull();
        factory.getClass();
        sourceWhenNonNull.to((v1) -> {
            r1.setAcceptors(v1);
        });
        jettyProperties.getClass();
        PropertyMapper.Source sourceWhenNonNull2 = propertyMapper.from(jettyProperties::getSelectors).whenNonNull();
        factory.getClass();
        ...
        jettyProperties.getClass();
        propertyMapper.from(jettyProperties::getMaxHttpPostSize).asInt((v0) -> {
            return v0.toBytes();
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/web/embedded/JettyWebServerFactoryCustomizer$MaxHttpHeaderSizeCustomizer.class */
