...
@Order(2147483627)
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/condition/OnJndiCondition.class */
class OnJndiCondition extends SpringBootCondition {
    ...
    private ConditionOutcome getMatchOutcome(String[] locations) {
        ...
        if (location != null) {
            return ConditionOutcome.match(ConditionMessage.forCondition((Class<? extends Annotation>) ConditionalOnJndi.class, details).foundExactly(OperatorName.SHOW_TEXT_LINE_AND_SPACE + location + OperatorName.SHOW_TEXT_LINE_AND_SPACE));
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/condition/OnJndiCondition$JndiLocator.class */
