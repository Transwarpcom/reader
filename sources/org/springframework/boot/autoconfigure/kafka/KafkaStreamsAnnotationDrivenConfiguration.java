...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/kafka/KafkaStreamsAnnotationDrivenConfiguration.class */
class KafkaStreamsAnnotationDrivenConfiguration {
    ...
    @Bean
    public KafkaStreamsFactoryBeanConfigurer kafkaStreamsFactoryBeanConfigurer(@Qualifier("defaultKafkaStreamsBuilder") StreamsBuilderFactoryBean factoryBean) {
        return new KafkaStreamsFactoryBeanConfigurer(this.properties, factoryBean);
    }

    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.1.6.RELEASE.jar:org/springframework/boot/autoconfigure/kafka/KafkaStreamsAnnotationDrivenConfiguration$KafkaStreamsFactoryBeanConfigurer.class */
