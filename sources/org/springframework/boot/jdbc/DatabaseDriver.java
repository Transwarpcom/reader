...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/jdbc/DatabaseDriver.class */
public enum DatabaseDriver {
    ...
    H2(StandardStructureTypes.H2, "org.h2.Driver", "org.h2.jdbcx.JdbcDataSource", "SELECT 1"),
    ...
    HANA("HDB", "com.sap.db.jdbc.Driver", "com.sap.db.jdbcext.XADataSourceSAP", "SELECT 1 FROM SYS.DUMMY") { // from class: org.springframework.boot.jdbc.DatabaseDriver.2
        @Override // org.springframework.boot.jdbc.DatabaseDriver
