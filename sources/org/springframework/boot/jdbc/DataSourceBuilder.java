...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/jdbc/DataSourceBuilder.class */
public final class DataSourceBuilder<T extends DataSource> {
    ...
    private void bind(DataSource result) {
        ...
        aliases.addAliases(FormLoginHandler.DEFAULT_USERNAME_PARAM, ClassicConstants.USER_MDC_KEY);
    ...
    public DataSourceBuilder<T> username(String username) {
        this.properties.put(FormLoginHandler.DEFAULT_USERNAME_PARAM, username);
        return this;
    }

    public DataSourceBuilder<T> password(String password) {
        this.properties.put(FormLoginHandler.DEFAULT_PASSWORD_PARAM, password);
        return this;
    }
