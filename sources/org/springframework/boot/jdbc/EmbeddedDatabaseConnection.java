...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/jdbc/EmbeddedDatabaseConnection.class */
public enum EmbeddedDatabaseConnection {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/jdbc/EmbeddedDatabaseConnection$IsEmbedded.class */
    private static class IsEmbedded implements ConnectionCallback<Boolean> {
        private IsEmbedded() {
        }

        /* renamed from: doInConnection, reason: merged with bridge method [inline-methods] */
        public Boolean m5583doInConnection(Connection connection) throws SQLException, DataAccessException {
