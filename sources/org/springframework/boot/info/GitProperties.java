...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/info/GitProperties.class */
public class GitProperties extends InfoProperties {
    ...
    private static String coerceToEpoch(String s) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(DatePattern.UTC_WITH_ZONE_OFFSET_PATTERN);
        try {
