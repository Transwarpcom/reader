...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/env/SpringApplicationJsonEnvironmentPostProcessor.class */
public class SpringApplicationJsonEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    private String findPropertySource(MutablePropertySources sources) {
        if (ClassUtils.isPresent(SERVLET_ENVIRONMENT_CLASS, null) && sources.contains("jndiProperties")) {
            return "jndiProperties";
        }
        return "systemProperties";
    }

    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/env/SpringApplicationJsonEnvironmentPostProcessor$JsonPropertySource.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/env/SpringApplicationJsonEnvironmentPostProcessor$JsonPropertyValue.class */
