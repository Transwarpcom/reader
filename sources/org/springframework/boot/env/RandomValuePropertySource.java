...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/env/RandomValuePropertySource.class */
public class RandomValuePropertySource extends PropertySource<Random> {
    ...
    public Object getProperty(String name) {
        ...
        if (logger.isTraceEnabled()) {
            logger.trace("Generating random property for '" + name + OperatorName.SHOW_TEXT_LINE);
        }
    ...
    private int getNextIntInRange(String range) throws NumberFormatException {
    ...
    private long getNextLongInRange(String range) throws NumberFormatException {
        String[] tokens = StringUtils.commaDelimitedListToStringArray(range);
        if (tokens.length == 1) {
