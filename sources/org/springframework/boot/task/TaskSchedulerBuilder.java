...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/task/TaskSchedulerBuilder.class */
public class TaskSchedulerBuilder {
    ...
    public <T extends ThreadPoolTaskScheduler> T configure(T taskScheduler) {
        ...
        PropertyMapper.Source sourceFrom2 = map.from((PropertyMapper) this.threadNamePrefix);
        taskScheduler.getClass();
        sourceFrom2.to(taskScheduler::setThreadNamePrefix);
