...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/task/TaskExecutorBuilder.class */
public class TaskExecutorBuilder {
    ...
    public <T extends ThreadPoolTaskExecutor> T configure(T taskExecutor) {
        ...
        PropertyMapper.Source sourceFrom5 = map.from((PropertyMapper) this.taskDecorator);
        taskExecutor.getClass();
        sourceFrom5.to(taskExecutor::setTaskDecorator);
