...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/convert/DurationStyle.class */
public enum DurationStyle {
    SIMPLE("^([\\+\\-]?\\d+)([a-zA-Z]{0,2})$") { // from class: org.springframework.boot.convert.DurationStyle.1
        ...
        public Duration parse(String value, ChronoUnit unit) {
            try {
                ...
                throw new IllegalArgumentException(OperatorName.SHOW_TEXT_LINE + value + "' is not a valid simple duration", ex);
            }
        }
    ...
    ISO8601("^[\\+\\-]?P.*$") { // from class: org.springframework.boot.convert.DurationStyle.2
        ...
        public Duration parse(String value, ChronoUnit unit) {
            try {
                ...
                throw new IllegalArgumentException(OperatorName.SHOW_TEXT_LINE + value + "' is not a valid ISO-8601 duration", ex);
            }
        }
    ...
    public static DurationStyle detect(String value) {
        ...
        throw new IllegalArgumentException(OperatorName.SHOW_TEXT_LINE + value + "' is not a valid duration");
    }

    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/convert/DurationStyle$Unit.class */
    enum Unit {
        ...
        SECONDS(ChronoUnit.SECONDS, OperatorName.CLOSE_AND_STROKE, (v0) -> {
            return v0.getSeconds();
        }),
        MINUTES(ChronoUnit.MINUTES, "m", (v0) -> {
            return v0.toMinutes();
        }),
        HOURS(ChronoUnit.HOURS, OperatorName.CLOSE_PATH, (v0) -> {
            return v0.toHours();
        }),
        ...
        public static Unit fromSuffix(String suffix) {
            ...
            throw new IllegalArgumentException("Unknown unit '" + suffix + OperatorName.SHOW_TEXT_LINE);
        }
    }
}
