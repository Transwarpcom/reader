...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/logging/logback/DebugLogbackConfigurator.class */
class DebugLogbackConfigurator extends LogbackConfigurator {
    ...
    public void appender(String name, Appender<?> appender) {
        info("Adding appender '" + appender + "' named '" + name + OperatorName.SHOW_TEXT_LINE);
    ...
    public void logger(String name, Level level, boolean additive, Appender<ILoggingEvent> appender) {
        ...
        if (appender != null) {
            info("Adding appender '" + appender + "' to logger '" + name + OperatorName.SHOW_TEXT_LINE);
        }
    ...
    public void start(LifeCycle lifeCycle) {
        info("Starting '" + lifeCycle + OperatorName.SHOW_TEXT_LINE);
