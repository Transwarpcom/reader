...
/* loaded from: reader.jar:org/springframework/boot/loader/jar/JarFile.class */
public class JarFile extends java.util.jar.JarFile {
    ...
    /* loaded from: reader.jar:org/springframework/boot/loader/jar/JarFile$JarFileType.class */
    enum JarFileType {
        DIRECT,
        NESTED_DIRECTORY,
        NESTED_JAR
    ...
    public synchronized JarFile getNestedJarFile(JarEntry entry) throws IOException {
        try {
            ...
            throw new IOException("Unable to open nested jar file '" + entry.getName() + OperatorName.SHOW_TEXT_LINE, ex);
        }
    }
    ...
    public URL getUrl() throws MalformedURLException {
        if (this.url == null) {
            ...
            this.url = new URL("jar", "", -1, file.replace("file:////", "file://"), handler);
        }
        return this.url;
    }
