...
/* loaded from: reader.jar:org/springframework/boot/loader/jar/AsciiBytes.class */
    ...
    public boolean matches(CharSequence name, char suffix) {
        ...
        while (i < this.offset + this.length) {
            ...
            if (b2 <= 65535) {
                ...
                if (c != (b2 >> 10) + Utf8.HIGH_SURROGATE_HEADER) {
                    return false;
                }
                charIndex++;
                if (getChar(name, suffix, charIndex) != (b2 & 1023) + 56320) {
                    return false;
                }
            }
            i++;
        ...
        if (hash == 0 && this.bytes.length > 0) {
            ...
            while (i3 < this.offset + this.length) {
                ...
                if (b2 <= 65535) {
                    ...
                    i = 31 * ((31 * hash) + (b2 >> 10) + Utf8.HIGH_SURROGATE_HEADER);
                    i2 = (b2 & 1023) + 56320;
                }
                hash = i + i2;
                i3++;
