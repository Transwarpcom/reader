...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/system/ApplicationPid.class */
public class ApplicationPid {
    ...
    private String getPid() {
        try {
            ...
            return jvmName.split(StrPool.AT)[0];
        } catch (Throwable th) {
            return null;
        }
    }
