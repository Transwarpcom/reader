...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/server/MimeMappings.class */
public final class MimeMappings implements Iterable<Mapping> {
    ...
    static {
        ...
        mappings.add(ImgUtil.IMAGE_TYPE_BMP, "image/bmp");
        mappings.add(NCXDocumentV3.XHTMLTgs.body, "text/html");
        ...
        mappings.add(ImgUtil.IMAGE_TYPE_GIF, MimeTypeUtils.IMAGE_GIF_VALUE);
        ...
        mappings.add("jpe", MimeTypeUtils.IMAGE_JPEG_VALUE);
        mappings.add(ImgUtil.IMAGE_TYPE_JPEG, MimeTypeUtils.IMAGE_JPEG_VALUE);
        mappings.add(ImgUtil.IMAGE_TYPE_JPG, MimeTypeUtils.IMAGE_JPEG_VALUE);
        ...
        mappings.add(ImgUtil.IMAGE_TYPE_PNG, MimeTypeUtils.IMAGE_PNG_VALUE);
        ...
        mappings.add(ImgUtil.IMAGE_TYPE_PSD, "image/vnd.adobe.photoshop");
        ...
        mappings.add(OperatorName.SHADING_FILL, "application/x-sh");
        mappings.add("shar", "application/x-shar");
        mappings.add("sit", "application/x-stuffit");
        mappings.add("snd", "audio/basic");
        mappings.add(NCXDocumentV2.NCXAttributes.src, "application/x-wais-source");
        ...
        mappings.add("xml", MimeTypeUtils.APPLICATION_XML_VALUE);
        mappings.add("xpm", "image/x-xpixmap");
        mappings.add("xsl", MimeTypeUtils.APPLICATION_XML_VALUE);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/server/MimeMappings$Mapping.class */
