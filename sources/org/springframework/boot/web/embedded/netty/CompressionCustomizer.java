...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/embedded/netty/CompressionCustomizer.class */
final class CompressionCustomizer implements NettyServerCustomizer {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/embedded/netty/CompressionCustomizer$CompressionPredicate.class */
    ...
    private CompressionPredicate getExcludedUserAgentsPredicate(String[] excludedUserAgents) {
        ...
        return (request, response) -> {
            ...
            return Arrays.stream(excludedUserAgents).noneMatch(candidate -> {
                return headers.contains((CharSequence) HttpHeaderNames.USER_AGENT, (CharSequence) candidate, true);
            });
        };
    }
}
