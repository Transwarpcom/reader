...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServer.class */
public class UndertowServletWebServer implements WebServer {
    private static final Log logger = LogFactory.getLog((Class<?>) UndertowServletWebServer.class);
    ...
    private Port getPortFromListener(Object listener) {
        ...
        Field portField = ReflectionUtils.findField(listener.getClass(), RtspHeaders.Values.PORT);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServer$Port.class */
