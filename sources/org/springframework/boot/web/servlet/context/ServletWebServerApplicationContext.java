...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/servlet/context/ServletWebServerApplicationContext.class */
public class ServletWebServerApplicationContext extends GenericWebApplicationContext implements ConfigurableWebServerApplicationContext {
    ...
    private void registerApplicationScope(ServletContext servletContext) {
        ...
        getBeanFactory().registerScope(LiveBeansView.MBEAN_APPLICATION_KEY, appScope);
    ...
    protected void prepareWebApplicationContext(ServletContext servletContext) {
        ...
        Log logger2 = LogFactory.getLog((Class<?>) ContextLoader.class);
    ...
    private WebServer startWebServer() throws WebServerException {
        WebServer webServer = this.webServer;
        if (webServer != null) {
            webServer.start();
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/servlet/context/ServletWebServerApplicationContext$ExistingWebApplicationScopes.class */
