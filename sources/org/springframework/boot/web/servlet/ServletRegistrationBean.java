...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/web/servlet/ServletRegistrationBean.class */
public class ServletRegistrationBean<T extends Servlet> extends DynamicRegistrationBean<ServletRegistration.Dynamic> {
    ...
    public ServletRegistration.Dynamic mo5641addRegistration(String description, ServletContext servletContext) {
