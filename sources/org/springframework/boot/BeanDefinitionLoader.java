...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/BeanDefinitionLoader.class */
class BeanDefinitionLoader {
    ...
    @FunctionalInterface
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/BeanDefinitionLoader$GroovyBeanDefinitionSource.class */
    ...
    private int load(Class<?> source) throws BeanDefinitionStoreException {
    ...
    private int load(CharSequence source) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid source '" + resolvedSource + OperatorName.SHOW_TEXT_LINE);
        }
    }
    ...
    private Resource[] findResources(String source) {
        ...
        try {
            ...
            throw new IllegalStateException("Error reading source '" + source + OperatorName.SHOW_TEXT_LINE);
        }
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/BeanDefinitionLoader$ClassExcludeFilter.class */
