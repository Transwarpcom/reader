...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/context/properties/source/MapConfigurationPropertySource.class */
public class MapConfigurationPropertySource implements IterableConfigurationPropertySource {
    ...
    public MapConfigurationPropertySource(Map<?, ?> map) {
        ...
        this.delegate = new SpringIterableConfigurationPropertySource(new MapPropertySource(PackageDocumentBase.DCTags.source, this.source), DefaultPropertyMapper.INSTANCE);
        putAll(map);
    }
