...
/* loaded from: reader.jar:BOOT-INF/lib/spring-boot-2.1.6.RELEASE.jar:org/springframework/boot/context/logging/LoggingApplicationListener.class */
public class LoggingApplicationListener implements GenericApplicationListener {
    ...
    private void initializeSystem(ConfigurableEnvironment environment, LoggingSystem system, LogFile logFile) throws IOException {
        ...
        try {
            ...
            System.err.println("Logging system failed to initialize using configuration from '" + logConfig + OperatorName.SHOW_TEXT_LINE);
    ...
    protected void initializeLogLevel(LoggingSystem system, LogLevel level) {
        LOG_LEVEL_LOGGERS.getOrDefault(level, Collections.emptyList()).forEach(logger -> {
            initializeLogLevel(system, level, logger);
        });
    }
    ...
    private void setLogLevel(LoggingSystem system, String name, String level) {
        try {
            ...
            this.logger.error("Cannot set level '" + level + "' for '" + name + OperatorName.SHOW_TEXT_LINE);
        }
    }
