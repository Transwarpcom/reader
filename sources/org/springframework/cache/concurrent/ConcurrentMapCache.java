...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/cache/concurrent/ConcurrentMapCache.class */
public class ConcurrentMapCache extends AbstractValueAdaptingCache {
    ...
    public <T> T get(Object obj, Callable<T> callable) {
        return (T) fromStoreValue(this.store.computeIfAbsent(obj, r -> {
            try {
    ...
    protected Object fromStoreValue(@Nullable Object storeValue) {
        if (storeValue != null && this.serialization != null) {
            try {
                ...
                throw new IllegalArgumentException("Failed to deserialize cache value '" + storeValue + OperatorName.SHOW_TEXT_LINE, ex);
            }
        }
    ...
    private Object deserializeValue(SerializationDelegate serialization, Object storeValue) throws IOException {
        ...
        try {
            Object objDeserialize = serialization.deserialize(in);
            in.close();
