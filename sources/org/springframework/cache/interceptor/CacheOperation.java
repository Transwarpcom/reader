...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/cache/interceptor/CacheOperation.class */
public abstract class CacheOperation implements BasicOperation {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/cache/interceptor/CacheOperation$Builder.class */
    public static abstract class Builder {
        ...
        protected StringBuilder getOperationDescription() {
            ...
            result.append("' | condition='").append(this.condition).append(OperatorName.SHOW_TEXT_LINE);
            return result;
        }
    }
}
