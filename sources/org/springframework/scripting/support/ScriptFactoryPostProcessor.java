...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/scripting/support/ScriptFactoryPostProcessor.class */
public class ScriptFactoryPostProcessor extends InstantiationAwareBeanPostProcessorAdapter implements BeanClassLoaderAware, BeanFactoryAware, ResourceLoaderAware, DisposableBean, Ordered {
    ...
    public static final String LANGUAGE_ATTRIBUTE = Conventions.getQualifiedAttributeName(ScriptFactoryPostProcessor.class, PackageDocumentBase.DCTags.language);
    ...
    public Class<?> predictBeanType(Class<?> beanClass, String beanName) throws NoSuchBeanDefinitionException {
        ...
        try {
            ...
            if (this.logger.isDebugEnabled()) {
                this.logger.debug("Could not determine scripted object type for bean '" + beanName + OperatorName.SHOW_TEXT_LINE, ex);
                return null;
            }
            return null;
        }
        ...
        try {
            ...
            if (refreshCheckDelay >= 0) {
                ...
                if (proxyTargetClass && (language == null || !language.equals("groovy"))) {
                    throw new BeanDefinitionValidationException("Cannot use proxyTargetClass=true with script beans where language is not 'groovy': '" + language + OperatorName.SHOW_TEXT_LINE);
                }
