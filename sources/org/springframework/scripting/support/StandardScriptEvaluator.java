...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/scripting/support/StandardScriptEvaluator.class */
public class StandardScriptEvaluator implements ScriptEvaluator, BeanClassLoaderAware {
    ...
    protected ScriptEngine getScriptEngine(ScriptSource script) {
        ...
        if (script instanceof ResourceScriptSource) {
            ...
            if (engine == null) {
                throw new IllegalStateException("No matching engine found for file extension '" + extension + OperatorName.SHOW_TEXT_LINE);
            }
            return engine;
        }
