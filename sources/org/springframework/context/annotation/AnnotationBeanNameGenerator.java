...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/context/annotation/AnnotationBeanNameGenerator.class */
                ...
                if (value instanceof String) {
                    ...
                    if (!StringUtils.hasLength(strVal)) {
                        ...
                        if (beanName != null && !strVal.equals(beanName)) {
                            throw new IllegalStateException("Stereotype annotations suggest inconsistent component names: '" + beanName + "' versus '" + strVal + OperatorName.SHOW_TEXT_LINE);
                        }
                        beanName = strVal;
                    }
                } else {
