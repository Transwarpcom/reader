...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/context/annotation/AnnotatedBeanDefinitionReader.class */
public class AnnotatedBeanDefinitionReader {
    ...
    public <T> void registerBean(Class<T> annotatedClass, @Nullable Supplier<T> instanceSupplier) throws BeanDefinitionStoreException {
        doRegisterBean(annotatedClass, instanceSupplier, null, null, new BeanDefinitionCustomizer[0]);
    }

    public <T> void registerBean(Class<T> annotatedClass, String name, @Nullable Supplier<T> instanceSupplier) throws BeanDefinitionStoreException {
    ...
    <T> void doRegisterBean(Class<T> annotatedClass, @Nullable Supplier<T> instanceSupplier, @Nullable String name, @Nullable Class<? extends Annotation>[] qualifiers, BeanDefinitionCustomizer... definitionCustomizers) throws BeanDefinitionStoreException {
