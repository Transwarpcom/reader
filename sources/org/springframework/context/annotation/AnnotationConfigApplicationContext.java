...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/context/annotation/AnnotationConfigApplicationContext.class */
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
    ...
    public <T> void registerBean(Class<T> annotatedClass, Object... constructorArguments) throws BeanDefinitionStoreException {
        registerBean((String) null, annotatedClass, constructorArguments);
    }

    public <T> void registerBean(@Nullable String beanName, Class<T> annotatedClass, Object... constructorArguments) throws BeanDefinitionStoreException {
