...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/context/support/LiveBeansView.class */
    ...
    protected String getEscapedResourceDescription(BeanDefinition bd) {
        ...
        for (int i = 0; i < resourceDescription.length(); i++) {
            ...
            if (character == '\\') {
                ...
                result.append(StrPool.BACKSLASH).append('\"');
            } else {
