...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/context/config/LoadTimeWeaverBeanDefinitionParser.class */
class LoadTimeWeaverBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    protected boolean isAspectJWeavingEnabled(String value, ParserContext parserContext) {
        ...
        return ("off".equals(value) || (cl = parserContext.getReaderContext().getBeanClassLoader()) == null || cl.getResource(AspectJWeavingEnabler.ASPECTJ_AOP_XML_RESOURCE) == null) ? false : true;
    }
