...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/asm/ClassReader.class */
public class ClassReader {
    ...
    private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
        ...
        while (true) {
            ...
            int attributeLength = readInt(currentOffset2 + 2);
            int currentOffset3 = currentOffset2 + 6;
            if (StandardStructureTypes.CODE.equals(attributeName)) {
    ...
    private String readUtf(int utfOffset, int utfLength, char[] charBuffer) {
        ...
        while (currentOffset < endOffset) {
            ...
            if ((b & 128) == 0) {
                ...
                int i5 = ((b & 15) << 12) + ((classFileBuffer[currentOffset] & 63) << 6);
                currentOffset = currentOffset2 + 1;
                charBuffer[i4] = (char) (i5 + (classFileBuffer[currentOffset2] & 63));
            }
        }
