...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/asm/Frame.class */
class Frame {
    ...
    final boolean merge(SymbolTable symbolTable, Frame dstFrame, int catchTypeIndex) {
        ...
        for (int i4 = 0; i4 < this.outputStackTop; i4++) {
            ...
            if (kind2 == LOCAL_KIND) {
                ...
                if ((abstractOutputType2 & TOP_IF_LONG_OR_DOUBLE_FLAG) != 0 && (concreteOutputType == LONG || concreteOutputType == DOUBLE)) {
