...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/cglib/core/Constants.class */
public interface Constants extends Opcodes {
    ...
    public static final Type TYPE_DOUBLE = TypeUtils.parseType(PDLayoutAttributeObject.BORDER_STYLE_DOUBLE);
