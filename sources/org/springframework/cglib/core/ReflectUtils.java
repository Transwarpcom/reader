...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/cglib/core/ReflectUtils.class */
public class ReflectUtils {
    ...
    static {
        ...
        transforms.put("long", OperatorName.SET_LINE_CAPSTYLE);
    ...
    public static Class defineClass(String className, byte[] b, ClassLoader loader, ProtectionDomain protectionDomain, Class<?> contextClass) throws Exception {
        ...
        if (c == null && classLoaderDefineClassMethod != null) {
            ...
            try {
                ...
                if (!ex4.getClass().getName().endsWith("InaccessibleObjectException")) {
