...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/jmx/export/annotation/AnnotationJmxAttributeSource.class */
public class AnnotationJmxAttributeSource implements JmxAttributeSource, BeanFactoryAware {
    ...
    @Nullable
    private static <T> T copyPropertiesToBean(@Nullable Annotation annotation, Class<T> cls) throws SecurityException {
        if (annotation == null) {
            return null;
        }
