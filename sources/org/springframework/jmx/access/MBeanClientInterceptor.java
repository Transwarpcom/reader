...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/jmx/access/MBeanClientInterceptor.class */
public class MBeanClientInterceptor implements MethodInterceptor, BeanClassLoaderAware, InitializingBean, DisposableBean {
    ...
    protected Object convertResultValueIfNecessary(@Nullable Object result, MethodParameter parameter) throws NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            if (result instanceof CompositeData) {
                Method fromMethod = targetClass.getMethod(FromBasedConverter.FROM, CompositeData.class);
            ...
            if (result instanceof CompositeData[]) {
                ...
                if (result instanceof TabularData) {
                    Method fromMethod2 = targetClass.getMethod(FromBasedConverter.FROM, TabularData.class);
    ...
    private Object convertDataArrayToTargetArray(Object[] array, Class<?> targetClass) throws NoSuchMethodException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        ...
        Method fromMethod = targetType.getMethod(FromBasedConverter.FROM, array.getClass().getComponentType());
    ...
    private Collection<?> convertDataArrayToTargetCollection(Object[] array, Class<?> collectionType, Class<?> elementType) throws NoSuchMethodException, SecurityException {
        Method fromMethod = elementType.getMethod(FromBasedConverter.FROM, array.getClass().getComponentType());
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/jmx/access/MBeanClientInterceptor$MethodCacheKey.class */
