...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/BeanUtils.class */
public abstract class BeanUtils {
    ...
    public static <T> T instantiateClass(Constructor<T> constructor, Object... objArr) throws BeanInstantiationException {
        ...
        try {
            ...
            return (KotlinDetector.isKotlinReflectPresent() && KotlinDetector.isKotlinType(constructor.getDeclaringClass())) ? (T) KotlinDelegate.instantiateClass(constructor, objArr) : constructor.newInstance(objArr);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/BeanUtils$KotlinDelegate.class */
    private static class KotlinDelegate {
        ...
        public static <T> T instantiateClass(Constructor<T> ctor, Object... args) throws IllegalAccessException, InstantiationException, InvocationTargetException {
