...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/BeanMetadataAttribute.class */
public class BeanMetadataAttribute implements BeanMetadataElement {
    ...
    public String toString() {
        return "metadata attribute '" + this.name + OperatorName.SHOW_TEXT_LINE;
    }
}
