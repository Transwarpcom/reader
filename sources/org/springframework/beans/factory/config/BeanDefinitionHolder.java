...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/config/BeanDefinitionHolder.class */
public class BeanDefinitionHolder implements BeanMetadataElement {
    ...
    public String getShortDescription() {
        ...
        sb.append("Bean definition with name '").append(this.beanName).append(OperatorName.SHOW_TEXT_LINE);
