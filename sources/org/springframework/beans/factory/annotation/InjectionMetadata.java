...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/annotation/InjectionMetadata.class */
public class InjectionMetadata {
    private static final Log logger = LogFactory.getLog((Class<?>) InjectionMetadata.class);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/annotation/InjectionMetadata$InjectedElement.class */
