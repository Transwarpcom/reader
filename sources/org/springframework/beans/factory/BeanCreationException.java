...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/BeanCreationException.class */
public class BeanCreationException extends FatalBeanException {
    ...
    public BeanCreationException(@Nullable String resourceDescription, @Nullable String beanName, String msg) {
        super("Error creating bean with name '" + beanName + OperatorName.SHOW_TEXT_LINE + (resourceDescription != null ? " defined in " + resourceDescription : "") + ": " + msg);
