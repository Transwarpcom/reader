...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader.class */
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader implements GroovyObject {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$DeferredProperty.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$GroovyRuntimeBeanReference.class */
    private class GroovyRuntimeBeanReference extends RuntimeBeanReference implements GroovyObject {
        ...
        public Object getProperty(String property) {
            ...
            if (property.equals(PackageDocumentBase.DCTags.source)) {
                return getSource();
            }
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$GroovyRuntimeBeanReference$GroovyPropertyValue.class */
