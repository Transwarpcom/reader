...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/xml/DefaultBeanDefinitionDocumentReader.class */
    ...
    protected void processAliasRegistration(Element ele) {
        ...
        if (valid) {
            try {
                ...
                getReaderContext().error("Failed to register alias '" + alias + "' for bean with name '" + name + OperatorName.SHOW_TEXT_LINE, ele, ex);
            }
    ...
    protected void processBeanDefinition(Element ele, BeanDefinitionParserDelegate delegate) {
        ...
        if (bdHolder != null) {
            ...
            try {
                ...
                getReaderContext().error("Failed to register bean definition with name '" + bdHolder2.getBeanName() + OperatorName.SHOW_TEXT_LINE, ele, ex);
            }
