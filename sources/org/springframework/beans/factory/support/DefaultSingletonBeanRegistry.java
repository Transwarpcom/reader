...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/factory/support/DefaultSingletonBeanRegistry.class */
        ...
        synchronized (this.singletonObjects) {
            ...
            if (singletonObject == null) {
                ...
                if (this.logger.isDebugEnabled()) {
                    this.logger.debug("Creating shared instance of singleton bean '" + beanName + OperatorName.SHOW_TEXT_LINE);
                }
