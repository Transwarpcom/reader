...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/GenericTypeAwarePropertyDescriptor.class */
final class GenericTypeAwarePropertyDescriptor extends PropertyDescriptor {
    ...
    public GenericTypeAwarePropertyDescriptor(Class<?> beanClass, String propertyName, @Nullable Method readMethod, @Nullable Method writeMethod, Class<?> propertyEditorClass) throws SecurityException, IntrospectionException {
        Method candidate;
    ...
    public Method getWriteMethodForActualAccess() {
        ...
        if (ambiguousCandidates != null) {
            ...
            LogFactory.getLog((Class<?>) GenericTypeAwarePropertyDescriptor.class).warn("Invalid JavaBean property '" + getName() + "' being accessed! Ambiguous write methods found next to actually used [" + this.writeMethod + "]: " + ambiguousCandidates);
        }
        return this.writeMethod;
    }
