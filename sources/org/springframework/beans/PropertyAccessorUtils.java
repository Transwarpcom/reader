...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/PropertyAccessorUtils.class */
        ...
        while (searchIndex != -1) {
            ...
            if (keyStart != -1) {
                ...
                if (keyEnd != -1) {
                    ...
                    if ((key.startsWith(OperatorName.SHOW_TEXT_LINE) && key.endsWith(OperatorName.SHOW_TEXT_LINE)) || (key.startsWith(OperatorName.SHOW_TEXT_LINE_AND_SPACE) && key.endsWith(OperatorName.SHOW_TEXT_LINE_AND_SPACE))) {
