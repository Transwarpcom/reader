...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/propertyeditors/CustomBooleanEditor.class */
public class CustomBooleanEditor extends PropertyEditorSupport {
    ...
    public void setAsText(@Nullable String text) throws IllegalArgumentException {
        ...
        if (this.trueString == null && ("true".equalsIgnoreCase(input) || "on".equalsIgnoreCase(input) || VALUE_YES.equalsIgnoreCase(input) || VALUE_1.equals(input))) {
            setValue(Boolean.TRUE);
            return;
        }
