...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/propertyeditors/ResourceBundleEditor.class */
public class ResourceBundleEditor extends PropertyEditorSupport {
    ...
    public void setAsText(String text) throws IllegalArgumentException {
        ...
        if (!StringUtils.hasText(baseName)) {
            throw new IllegalArgumentException("Invalid ResourceBundle name: '" + text + OperatorName.SHOW_TEXT_LINE);
        }
