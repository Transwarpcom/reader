...
/* loaded from: reader.jar:BOOT-INF/lib/spring-beans-5.1.8.RELEASE.jar:org/springframework/beans/TypeConverterDelegate.class */
    ...
    public <T> T convertIfNecessary(@Nullable String str, @Nullable Object obj, @Nullable Object obj2, @Nullable Class<T> cls, @Nullable TypeDescriptor typeDescriptor) throws ClassNotFoundException, ArrayIndexOutOfBoundsException, IllegalArgumentException {
        ...
        if (cls != null) {
            ...
            if (!ClassUtils.isAssignableValue(cls, objDoConvertValue)) {
                ...
                sb.append("' to required type '").append(ClassUtils.getQualifiedName(cls)).append(OperatorName.SHOW_TEXT_LINE);
                if (str != null) {
                    sb.append(" for property '").append(str).append(OperatorName.SHOW_TEXT_LINE);
                }
                if (propertyEditorFindCustomEditor != null) {
                    sb.append(": PropertyEditor [").append(propertyEditorFindCustomEditor.getClass().getName()).append("] returned inappropriate value of type '").append(ClassUtils.getDescriptiveType(objDoConvertValue)).append(OperatorName.SHOW_TEXT_LINE);
