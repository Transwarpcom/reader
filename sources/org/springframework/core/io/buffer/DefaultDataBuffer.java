...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DefaultDataBuffer.class */
public class DefaultDataBuffer implements DataBuffer {
    ...
    private int calculateCapacity(int neededCapacity) {
        ...
        if (neededCapacity > CAPACITY_THRESHOLD) {
            int newCapacity2 = (neededCapacity / CAPACITY_THRESHOLD) * CAPACITY_THRESHOLD;
            if (newCapacity2 > 2143289343) {
                newCapacity = Integer.MAX_VALUE;
            } else {
                newCapacity = newCapacity2 + CAPACITY_THRESHOLD;
            }
            return newCapacity;
        }
        int i = 64;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DefaultDataBuffer$DefaultDataBufferInputStream.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DefaultDataBuffer$DefaultDataBufferOutputStream.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DefaultDataBuffer$SlicedDefaultDataBuffer.class */
