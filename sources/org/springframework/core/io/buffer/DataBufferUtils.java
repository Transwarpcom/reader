...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DataBufferUtils.class */
public abstract class DataBufferUtils {
    ...
    static void closeChannel(@Nullable Channel channel) throws IOException {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DataBufferUtils$ReadableByteChannelGenerator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DataBufferUtils$ReadCompletionHandler.class */
    private static class ReadCompletionHandler implements CompletionHandler<Integer, DataBuffer> {
        ...
        public void completed(Integer read, DataBuffer dataBuffer) throws IOException {
            if (read.intValue() != -1 && !this.disposed.get()) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DataBufferUtils$WritableByteChannelSubscriber.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/buffer/DataBufferUtils$WriteCompletionHandler.class */
