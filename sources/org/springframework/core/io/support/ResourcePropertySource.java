...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/io/support/ResourcePropertySource.class */
public class ResourcePropertySource extends PropertiesPropertySource {
    ...
    private static String getNameForResource(Resource resource) {
        ...
        if (!StringUtils.hasText(name)) {
            name = resource.getClass().getSimpleName() + StrPool.AT + System.identityHashCode(resource);
        }
        return name;
    }
}
