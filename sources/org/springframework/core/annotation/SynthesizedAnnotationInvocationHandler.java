...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/annotation/SynthesizedAnnotationInvocationHandler.class */
class SynthesizedAnnotationInvocationHandler implements InvocationHandler {
    ...
    private int annotationHashCode() {
        ...
        for (Method attributeMethod : AnnotationUtils.getAttributeMethods(annotationType())) {
            ...
            if (value.getClass().isArray()) {
                iHashCode = hashCodeForArray(value);
            } else {
                iHashCode = value.hashCode();
            }
            int hashCode = iHashCode;
    ...
    private String annotationToString() {
        StringBuilder sb = new StringBuilder(StrPool.AT).append(annotationType().getName()).append("(");
