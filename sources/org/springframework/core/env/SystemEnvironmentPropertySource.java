...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/env/SystemEnvironmentPropertySource.class */
public class SystemEnvironmentPropertySource extends MapPropertySource {
    ...
    public Object getProperty(String name) {
        ...
        if (this.logger.isDebugEnabled() && !name.equals(actualName)) {
            this.logger.debug("PropertySource '" + getName() + "' does not contain property '" + name + "', but found equivalent '" + actualName + OperatorName.SHOW_TEXT_LINE);
        }
