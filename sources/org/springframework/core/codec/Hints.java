...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/codec/Hints.class */
public abstract class Hints {
    ...
    public static <T> T getRequiredHint(@Nullable Map<String, Object> map, String str) {
        if (map == null) {
            throw new IllegalArgumentException("No hints map for required hint '" + str + OperatorName.SHOW_TEXT_LINE);
        }
        T t = (T) map.get(str);
        if (t == null) {
            throw new IllegalArgumentException("Hints map must contain the hint '" + str + OperatorName.SHOW_TEXT_LINE);
        }
        return t;
    }
