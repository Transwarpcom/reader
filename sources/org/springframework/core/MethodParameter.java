...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/MethodParameter.class */
public class MethodParameter {
    ...
    public MethodParameter nested() {
        ...
        MethodParameter nestedParam2 = mo5762clone();
    ...
    public String toString() {
        Method method = getMethod();
        return (method != null ? "method '" + method.getName() + OperatorName.SHOW_TEXT_LINE : BeanDefinitionParserDelegate.AUTOWIRE_CONSTRUCTOR_VALUE) + " parameter " + this.parameterIndex;
    }

    @Override // 
    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public MethodParameter mo5762clone() {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/MethodParameter$KotlinDelegate.class */
