...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/convert/TypeDescriptor.class */
public class TypeDescriptor implements Serializable {
    ...
    public String toString() {
        ...
        for (Annotation ann : getAnnotations()) {
            builder.append(StrPool.AT).append(ann.annotationType().getName()).append(' ');
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/convert/TypeDescriptor$AnnotatedElementAdapter.class */
