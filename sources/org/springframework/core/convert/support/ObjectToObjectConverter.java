...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/core/convert/support/ObjectToObjectConverter.class */
final class ObjectToObjectConverter implements ConditionalGenericConverter {
    ...
    @Nullable
    private static Member getValidatedMember(Class<?> targetClass, Class<?> sourceClass) throws NoSuchMethodException, SecurityException {
    ...
    private static Method determineFactoryMethod(Class<?> targetClass, Class<?> sourceClass) throws NoSuchMethodException, SecurityException {
        ...
        if (method == null) {
            ...
            if (method == null) {
                method = ClassUtils.getStaticMethod(targetClass, FromBasedConverter.FROM, sourceClass);
            }
        }
        return method;
    }
