...
/* loaded from: reader.jar:BOOT-INF/lib/spring-core-5.1.8.RELEASE.jar:org/springframework/objenesis/instantiator/basic/ProxyingInstantiator.class */
    ...
    private static byte[] writeExtendingClass(Class<?> type) {
        ...
        try {
            ...
            try {
                ...
                in.writeByte(1);
                in.writeUTF(StandardStructureTypes.CODE);
                in.writeByte(1);
                in.writeUTF("L" + clazz + ";");
                in.writeByte(1);
                in.writeUTF(clazz);
