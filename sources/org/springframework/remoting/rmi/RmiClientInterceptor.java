...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/remoting/rmi/RmiClientInterceptor.class */
public class RmiClientInterceptor extends RemoteInvocationBasedAccessor implements MethodInterceptor {
        ...
        try {
            if (this.registryClientSocketFactory != null) {
                ...
                if (protocol != null && !"rmi".equals(protocol)) {
                    throw new MalformedURLException("Invalid URL scheme '" + protocol + OperatorName.SHOW_TEXT_LINE);
                }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/remoting/rmi/RmiClientInterceptor$DummyURLStreamHandler.class */
