...
/* loaded from: reader.jar:BOOT-INF/lib/spring-context-5.1.8.RELEASE.jar:org/springframework/remoting/rmi/RmiServiceExporter.class */
public class RmiServiceExporter extends RmiBasedExporter implements InitializingBean, DisposableBean {
    ...
    protected Registry getRegistry(int registryPort) throws RemoteException {
        ...
        if (this.logger.isDebugEnabled()) {
            this.logger.debug("Looking for RMI registry at port '" + registryPort + OperatorName.SHOW_TEXT_LINE);
        }
        synchronized (LocateRegistry.class) {
            try {
    ...
    public void destroy() throws RemoteException {
        if (this.logger.isDebugEnabled()) {
            this.logger.debug("Unbinding RMI service '" + this.serviceName + "' from registry" + (this.createdRegistry ? " at port '" + this.registryPort + OperatorName.SHOW_TEXT_LINE : ""));
        }
        try {
