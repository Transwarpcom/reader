...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/standard/SpelCompiler.class */
public final class SpelCompiler implements Opcodes {
    ...
    @Nullable
    public CompiledExpression compile(SpelNodeImpl expression) throws MethodTooLargeException, ClassTooLargeException {
    ...
    @Nullable
    private Class<? extends CompiledExpression> createExpressionClass(SpelNodeImpl expressionToCompile) throws MethodTooLargeException, ClassTooLargeException {
        ...
        mv.visitMethodInsn(183, "org/springframework/expression/spel/CompiledExpression", Constants.CONSTRUCTOR_NAME, "()V", false);
        mv.visitInsn(177);
        mv.visitMaxs(1, 1);
        mv.visitEnd();
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/standard/SpelCompiler$ChildClassLoader.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/standard/SpelCompiler$ExpressionClassWriter.class */
