...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/standard/InternalSpelExpressionParser.class */
class InternalSpelExpressionParser extends TemplateAwareExpressionParser {
    ...
    private boolean maybeEatTypeReference() {
        if (peekToken(TokenKind.IDENTIFIER)) {
            ...
            if (!PDNumberFormatDictionary.FRACTIONAL_DISPLAY_TRUNCATE.equals(typeName.stringValue())) {
                return false;
            }
            Token t = takeToken();
