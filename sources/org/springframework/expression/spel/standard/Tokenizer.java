...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/standard/Tokenizer.class */
class Tokenizer {
        ...
        while (this.pos < this.max) {
            ...
            if (isAlphabetic(ch2)) {
                ...
                switch (ch2) {
                    ...
                    case 'z':
                    default:
                        throw new IllegalStateException("Cannot handle (" + ((int) ch2) + ") '" + ch2 + OperatorName.SHOW_TEXT_LINE);
                    case '\t':
                    case '\n':
                    case '\r':
                    case ' ':
