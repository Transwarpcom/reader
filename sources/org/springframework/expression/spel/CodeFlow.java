...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/CodeFlow.class */
public class CodeFlow implements Opcodes {
    ...
    @FunctionalInterface
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/CodeFlow$ClinitAdder.class */
    public interface ClinitAdder {
        void generateCode(MethodVisitor methodVisitor, CodeFlow codeFlow);
    }

    @FunctionalInterface
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/CodeFlow$FieldAdder.class */
    ...
    public static void insertUnboxInsns(MethodVisitor mv, char ch2, @Nullable String stackDescriptor) {
        ...
        switch (ch2) {
            ...
            case 'Y':
            default:
                throw new IllegalArgumentException("Unboxing should not be attempted for descriptor '" + ch2 + OperatorName.SHOW_TEXT_LINE);
            case 'F':
    ...
    public static void insertUnboxNumberInsns(MethodVisitor mv, char targetDescriptor, @Nullable String stackDescriptor) {
        ...
        switch (targetDescriptor) {
            ...
            case 'H':
            default:
                throw new IllegalArgumentException("Unboxing should not be attempted for descriptor '" + targetDescriptor + OperatorName.SHOW_TEXT_LINE);
            case 'F':
                if (stackDescriptor.equals("Ljava/lang/Object")) {
                    mv.visitTypeInsn(192, "java/lang/Number");
                }
    ...
    public static boolean areBoxingCompatible(String desc1, String desc2) {
        ...
        if (desc1.length() == 1) {
            ...
            if (desc1.equals(OperatorName.SET_LINE_CAPSTYLE)) {
        ...
        if (desc2.length() == 1) {
            ...
            if (desc2.equals(OperatorName.SET_LINE_CAPSTYLE)) {
    ...
    public static boolean isPrimitiveOrUnboxableSupportedNumber(@Nullable String descriptor) {
        ...
        if (descriptor.startsWith("Ljava/lang/")) {
            ...
            if (name.equals(PDLayoutAttributeObject.BORDER_STYLE_DOUBLE) || name.equals("Float") || name.equals("Integer") || name.equals("Long")) {
                return true;
            }
            return false;
        }
    ...
    public static char toPrimitiveTargetDesc(String descriptor) {
        ...
        throw new IllegalStateException("No primitive for '" + descriptor + OperatorName.SHOW_TEXT_LINE);
    }
    ...
    public static void insertBoxIfNecessary(MethodVisitor mv, char ch2) {
        switch (ch2) {
            ...
            case 'Y':
            default:
                throw new IllegalArgumentException("Boxing should not be attempted for descriptor '" + ch2 + OperatorName.SHOW_TEXT_LINE);
            case 'F':
