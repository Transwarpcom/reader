...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/SpelMessage.class */
public enum SpelMessage {
    ...
    TYPE_NOT_FOUND(Kind.ERROR, WebSocketProtocol.CLOSE_NO_STATUS_CODE, "Type cannot be found ''{0}''"),
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/SpelMessage$Kind.class */
    public enum Kind {
        INFO,
        WARNING,
        ERROR
