...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor.class */
public class ReflectivePropertyAccessor implements PropertyAccessor {
    ...
    public boolean canRead(EvaluationContext context, @Nullable Object target, String name) throws SecurityException, AccessException {
        ...
        if (type.isArray() && name.equals(Length.TOKEN_NAME)) {
            return true;
        }
        ...
        if (invoker == null || (invoker.member instanceof Field)) {
            ...
            if (field != null) {
                try {
                    ...
                    throw new AccessException("Unable to access field '" + name + OperatorName.SHOW_TEXT_LINE, ex2);
                }
            }
        }
        throw new AccessException("Neither getter method nor field found for property '" + name + OperatorName.SHOW_TEXT_LINE);
    }
    ...
    public void write(EvaluationContext context, @Nullable Object target, String name, @Nullable Object newValue) throws IllegalAccessException, SecurityException, IllegalArgumentException, AccessException, InvocationTargetException {
        ...
        throw new AccessException("Neither setter method nor field found for property '" + name + OperatorName.SHOW_TEXT_LINE);
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$InvokerPair.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$PropertyCacheKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$OptimalPropertyAccessor.class */
