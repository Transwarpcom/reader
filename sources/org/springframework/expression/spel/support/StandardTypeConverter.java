...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/support/StandardTypeConverter.class */
    ...
    public Object convertValue(@Nullable Object value, @Nullable TypeDescriptor sourceType, TypeDescriptor targetType) {
        ...
        try {
            ...
            if (sourceType != null) {
                ...
                name = value != null ? value.getClass().getName() : "null";
            }
            objArr[0] = name;
