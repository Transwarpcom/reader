...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/ast/OpDec.class */
public class OpDec extends Operator {
    private final boolean postfix;

    public OpDec(int pos, boolean postfix, SpelNodeImpl... operands) {
        super(UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX, pos, operands);
    ...
    public String toStringAST() {
        return getLeftOperand().toStringAST() + UsageMessageFormatter.DEFAULT_LONG_OPT_PREFIX;
    }
