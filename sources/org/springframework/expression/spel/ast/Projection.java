...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/ast/Projection.class */
        ...
        if ((operand instanceof Iterable) || operandIsArray) {
            ...
            for (Object element : data) {
                try {
                    ...
                    state.enterScope("index", Integer.valueOf(idx));
