...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/ast/InlineList.class */
public class InlineList extends SpelNodeImpl {
    ...
    void generateClinitCode(String clazzname, String constantFieldName, MethodVisitor mv, CodeFlow codeflow, boolean nested) {
        ...
        mv.visitInsn(89);
        mv.visitMethodInsn(183, "java/util/ArrayList", Constants.CONSTRUCTOR_NAME, "()V", false);
        if (!nested) {
