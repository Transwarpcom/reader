...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/spel/ast/OpPlus.class */
public class OpPlus extends Operator {
    ...
    public void generateCode(MethodVisitor mv, CodeFlow cf) {
        if ("Ljava/lang/String".equals(this.exitTypeDescriptor)) {
            ...
            mv.visitInsn(89);
            mv.visitMethodInsn(183, "java/lang/StringBuilder", Constants.CONSTRUCTOR_NAME, "()V", false);
            ...
            if (this.children.length > 1) {
                ...
                switch (targetDesc) {
                    ...
                    case 'H':
                    default:
                        throw new IllegalStateException("Unrecognized exit type descriptor: '" + this.exitTypeDescriptor + OperatorName.SHOW_TEXT_LINE);
                    case 'F':
                        mv.visitInsn(98);
                        break;
                    case 'I':
