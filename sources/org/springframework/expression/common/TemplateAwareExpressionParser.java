...
/* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/common/TemplateAwareExpressionParser.class */
public abstract class TemplateAwareExpressionParser implements ExpressionParser {
    ...
    private int skipToCorrectEndSuffix(String suffix, String expressionString, int afterPrefixIndex) throws ParseException {
        ...
        while (pos < maxlen && (!isSuffixHere(expressionString, pos, suffix) || !stack.isEmpty())) {
            ...
            switch (ch2) {
                ...
                case '}':
                    if (stack.isEmpty()) {
                        throw new ParseException(expressionString, pos, "Found closing '" + ch2 + "' at position " + pos + " without an opening '" + Bracket.theOpenBracketFor(ch2) + OperatorName.SHOW_TEXT_LINE);
                    }
                    Bracket p = stack.pop();
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/spring-expression-5.1.8.RELEASE.jar:org/springframework/expression/common/TemplateAwareExpressionParser$Bracket.class */
