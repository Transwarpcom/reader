...
/* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter.class */
public final class Emitter implements Emitable {
    ...
    static {
        ...
        ESCAPE_REPLACEMENTS.put('\b', OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE);
        ESCAPE_REPLACEMENTS.put('\t', "t");
        ESCAPE_REPLACEMENTS.put('\n', OperatorName.ENDPATH);
        ESCAPE_REPLACEMENTS.put((char) 11, OperatorName.CURVE_TO_REPLICATE_INITIAL_POINT);
        ESCAPE_REPLACEMENTS.put('\f', OperatorName.FILL_NON_ZERO);
        ESCAPE_REPLACEMENTS.put('\r', PDPageLabelRange.STYLE_ROMAN_LOWER);
        ESCAPE_REPLACEMENTS.put((char) 27, "e");
        ESCAPE_REPLACEMENTS.put('\"', OperatorName.SHOW_TEXT_LINE_AND_SPACE);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectStreamStart.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectNothing.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstDocumentStart.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectDocumentStart.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectDocumentEnd.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectDocumentRoot.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstFlowSequenceItem.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowSequenceItem.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstFlowMappingKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowMappingKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowMappingSimpleValue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFlowMappingValue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstBlockSequenceItem.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockSequenceItem.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectFirstBlockMappingKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockMappingKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockMappingSimpleValue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/emitter/Emitter$ExpectBlockMappingValue.class */
    ...
    private void writeSingleQuoted(String text, boolean split) throws IOException {
        writeIndicator(OperatorName.SHOW_TEXT_LINE, true, false, false);
        ...
        writeIndicator(OperatorName.SHOW_TEXT_LINE, false, false, false);
    }

    private void writeDoubleQuoted(String text, boolean split) throws IOException {
        String data;
        String data2;
        writeIndicator(OperatorName.SHOW_TEXT_LINE_AND_SPACE, true, false, false);
        int start = 0;
        int end = 0;
                ...
                if (ch2 != null) {
                    if (ESCAPE_REPLACEMENTS.containsKey(ch2)) {
                        ...
                        if (ch2.charValue() <= 255) {
                            String s = "0" + Integer.toString(ch2.charValue(), 16);
        ...
        writeIndicator(OperatorName.SHOW_TEXT_LINE_AND_SPACE, false, false, false);
    }
