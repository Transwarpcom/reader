...
/* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/DumperOptions.class */
public class DumperOptions {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/DumperOptions$ScalarStyle.class */
    public enum ScalarStyle {
        ...
        public String toString() {
            return "Scalar style: '" + this.styleChar + OperatorName.SHOW_TEXT_LINE;
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/DumperOptions$FlowStyle.class */
    public enum FlowStyle {
        ...
        @Override // java.lang.Enum
        public String toString() {
            return "Flow style: '" + this.styleBoolean + OperatorName.SHOW_TEXT_LINE;
        }
    }

    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/DumperOptions$LineBreak.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/DumperOptions$Version.class */
    public enum Version {
