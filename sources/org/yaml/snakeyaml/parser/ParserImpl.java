...
/* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl.class */
public class ParserImpl implements Parser {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseStreamStart.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseImplicitDocumentStart.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseDocumentStart.class */
        ...
        public Event produce() {
            ...
            if (!ParserImpl.this.scanner.checkToken(Token.ID.StreamEnd)) {
                ...
                if (!ParserImpl.this.scanner.checkToken(Token.ID.DocumentStart)) {
                    throw new ParserException(null, null, "expected '<document start>', but found '" + ParserImpl.this.scanner.peekToken().getTokenId() + OperatorName.SHOW_TEXT_LINE, ParserImpl.this.scanner.peekToken().getStartMark());
                }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseDocumentEnd.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseDocumentContent.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockNode.class */
    ...
    public Event parseNode(boolean block, boolean indentlessSequence) {
        ...
        if (this.scanner.checkToken(Token.ID.Alias)) {
            ...
            if (indentlessSequence && this.scanner.checkToken(Token.ID.BlockEntry)) {
                ...
                throw new ParserException("while parsing a " + node + " node", startMark, "expected the node content, but found '" + token5.getTokenId() + OperatorName.SHOW_TEXT_LINE, token5.getStartMark());
            }
        }
        return event;
    }

    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockSequenceFirstEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockSequenceEntry.class */
    private class ParseBlockSequenceEntry implements Production {
        ...
        public Event produce() {
            ...
            if (!ParserImpl.this.scanner.checkToken(Token.ID.BlockEnd)) {
                ...
                throw new ParserException("while parsing a block collection", (Mark) ParserImpl.this.marks.pop(), "expected <block end>, but found '" + token2.getTokenId() + OperatorName.SHOW_TEXT_LINE, token2.getStartMark());
            }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseIndentlessSequenceEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockMappingFirstKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockMappingKey.class */
    private class ParseBlockMappingKey implements Production {
        ...
        public Event produce() {
            ...
            if (!ParserImpl.this.scanner.checkToken(Token.ID.BlockEnd)) {
                Token token2 = ParserImpl.this.scanner.peekToken();
                throw new ParserException("while parsing a block mapping", (Mark) ParserImpl.this.marks.pop(), "expected <block end>, but found '" + token2.getTokenId() + OperatorName.SHOW_TEXT_LINE, token2.getStartMark());
            }
            Token token3 = ParserImpl.this.scanner.getToken();
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseBlockMappingValue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceFirstEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntryMappingKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntryMappingValue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowSequenceEntryMappingEnd.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingFirstKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingKey.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingValue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/snakeyaml-1.23.jar:org/yaml/snakeyaml/parser/ParserImpl$ParseFlowMappingEmptyValue.class */
