...
/* loaded from: reader.jar:BOOT-INF/classes/org/kxml2/io/KXmlSerializer.class */
public class KXmlSerializer implements XmlSerializer {
    ...
    */
    private final void writeEscaped(java.lang.String r5, int r6) throws java.io.IOException {
        /*
    ...
    private final String getPrefix(String namespace, boolean includeDefault, boolean create) throws IOException {
        ...
        if ("".equals(namespace)) {
            ...
            do {
                StringBuilder sbAppend = new StringBuilder().append(OperatorName.ENDPATH);
                int i2 = this.auto;
                this.auto = i2 + 1;
    ...
    public void startDocument(String encoding, Boolean standalone) throws IOException {
        ...
        if (standalone != null) {
            ...
            this.writer.write(standalone.booleanValue() ? CustomBooleanEditor.VALUE_YES : "no");
            this.writer.write("' ");
        }
        this.writer.write("?>");
    }
    ...
    public XmlSerializer startTag(String namespace, String name) throws IOException {
        ...
        if (this.indent[this.depth]) {
            this.writer.write(StrPool.CRLF);
