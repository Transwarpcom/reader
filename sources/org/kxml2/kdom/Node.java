...
/* loaded from: reader.jar:BOOT-INF/classes/org/kxml2/kdom/Node.class */
public class Node {
    ...
    public void write(XmlSerializer writer) throws IllegalStateException, IOException, IllegalArgumentException {
        writeChildren(writer);
        writer.flush();
    }

    public void writeChildren(XmlSerializer writer) throws IllegalStateException, IOException, IllegalArgumentException {
        if (this.children == null) {
            return;
        }
