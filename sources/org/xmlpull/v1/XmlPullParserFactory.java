...
/* loaded from: reader.jar:BOOT-INF/lib/xmlpull-1.1.3.1.jar:org/xmlpull/v1/XmlPullParserFactory.class */
public class XmlPullParserFactory {
    ...
    public static XmlPullParserFactory newInstance(String classNames, Class context) throws XmlPullParserException, IllegalAccessException, InstantiationException, ClassNotFoundException, IOException {
        String classNamesLocation;
        if (context == null) {
            context = referenceContextClass;
        }
        if (classNames == null || classNames.length() == 0 || Book.imgStyleDefault.equals(classNames)) {
            try {
                ...
                classNamesLocation = new StringBuffer().append("resource /META-INF/services/org.xmlpull.v1.XmlPullParserFactory that contained '").append(classNames).append(OperatorName.SHOW_TEXT_LINE).toString();
            } catch (Exception e) {
                throw new XmlPullParserException(null, null, e);
            }
        } else {
            classNamesLocation = new StringBuffer().append("parameter classNames to newInstance() that contained '").append(classNames).append(OperatorName.SHOW_TEXT_LINE).toString();
        }
