...
/* loaded from: reader.jar:BOOT-INF/lib/xmlpull-1.1.3.1.jar:org/xmlpull/v1/XmlPullParser.class */
public interface XmlPullParser {
    ...
    public static final String[] TYPES = {"START_DOCUMENT", "END_DOCUMENT", "START_TAG", "END_TAG", Book.imgStyleText, "CDSECT", "ENTITY_REF", "IGNORABLE_WHITESPACE", "PROCESSING_INSTRUCTION", "COMMENT", "DOCDECL"};
