...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-crypto-5.8.0.M1.jar:cn/hutool/crypto/asymmetric/AsymmetricDecryptor.class */
public interface AsymmetricDecryptor {
    ...
    default byte[] decryptFromBcd(String data, KeyType keyType, Charset charset) throws IllegalArgumentException {
