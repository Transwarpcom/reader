...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-crypto-5.8.0.M1.jar:cn/hutool/crypto/asymmetric/Sign.class */
public class Sign extends BaseAsymmetric<Sign> {
    ...
    public Sign setParameter(AlgorithmParameterSpec params) throws InvalidAlgorithmParameterException {
        try {
    ...
    public boolean verify(byte[] data, byte[] sign) {
        ...
        try {
            try {
                ...
                boolean zVerify = this.signature.verify(sign);
                this.lock.unlock();
                return zVerify;
            } catch (Exception e) {
                throw new CryptoException(e);
