...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/text/escape/NumericEntityUnescaper.class */
public class NumericEntityUnescaper extends StrReplacer {
    private static final long serialVersionUID = 1;

    @Override // cn.hutool.core.text.replacer.StrReplacer
    protected int replace(CharSequence str, int pos, StrBuilder out) throws NumberFormatException {
        int entityValue;
        int len = str.length();
