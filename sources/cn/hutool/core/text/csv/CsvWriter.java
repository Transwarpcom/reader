...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/text/csv/CsvWriter.class */
public final class CsvWriter implements Closeable, Flushable, Serializable {
    ...
    public CsvWriter write(Iterable<?> lines) throws IOException, IORuntimeException {
    ...
    public CsvWriter writeBeans(Iterable<?> beans) throws IOException, IORuntimeException {
    ...
    public CsvWriter writeComment(String comment) throws IOException, IllegalArgumentException {
