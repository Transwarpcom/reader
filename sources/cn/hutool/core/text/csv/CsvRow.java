...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/text/csv/CsvRow.class */
public final class CsvRow implements List<String> {
    private final long originalLineNumber;
    final Map<String, Integer> headerMap;
    final List<String> fields;

    public CsvRow(long originalLineNumber, Map<String, Integer> headerMap, List<String> fields) throws IllegalArgumentException {
    ...
    public String getByName(String name) throws IllegalArgumentException {
