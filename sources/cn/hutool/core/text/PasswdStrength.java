...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/text/PasswdStrength.class */
public class PasswdStrength {
    private static final String[] DICTIONARY = {FormLoginHandler.DEFAULT_PASSWORD_PARAM, "abc123", "iloveyou", "adobe123", "123123", "sunshine", "1314520", "a1b2c3", "123qwe", "aaa111", "qweasd", "admin", "passwd"};
    private static final int[] SIZE_TABLE = {9, 99, 999, 9999, 99999, 999999, 9999999, 99999999, 999999999, Integer.MAX_VALUE};

    /* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/text/PasswdStrength$CHAR_TYPE.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/text/PasswdStrength$PASSWD_LEVEL.class */
    ...
    public static int check(String passwd) throws NumberFormatException {
        if (null == passwd) {
    ...
    public static PASSWD_LEVEL getLevel(String passwd) throws NumberFormatException {
