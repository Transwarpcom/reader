...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/codec/Base62.class */
public class Base62 {
    ...
    public static void decodeToStream(CharSequence base62Str, OutputStream out, boolean isCloseOut) throws IOException, IORuntimeException {
    ...
    public static void decodeToStreamInverted(CharSequence base62Str, OutputStream out, boolean isCloseOut) throws IOException, IORuntimeException {
