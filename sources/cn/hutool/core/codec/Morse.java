...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/codec/Morse.class */
public class Morse {
    ...
    public String encode(String text) throws IllegalArgumentException {
    ...
    public String decode(String morse) throws IllegalArgumentException {
