...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/BooleanUtil.class */
public class BooleanUtil {
    private static final Set<String> TRUE_SET = CollUtil.newHashSet("true", CustomBooleanEditor.VALUE_YES, OperatorName.CURVE_TO_REPLICATE_FINAL_POINT, "t", "ok", CustomBooleanEditor.VALUE_1, "on", "是", "对", "真", "對", "√");
