...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/IdcardUtil.class */
public class IdcardUtil {
    ...
    public static String[] isValidCard10(String idcard) {
        ...
        if (idcard.matches("^[a-zA-Z][0-9]{9}$")) {
            ...
            if ('1' == char2) {
                info[1] = OperatorName.SET_LINE_MITERLIMIT;
            } else if ('2' == char2) {
                info[1] = "F";
            } else {
                info[1] = "N";
    ...
    public static String getBirth(String idCard) throws IllegalArgumentException {
    ...
    public static int getGenderByIdCard(String idcard) throws IllegalArgumentException {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/IdcardUtil$Idcard.class */
