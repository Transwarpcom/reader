...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/ClassUtil.class */
public class ClassUtil {
    ...
    public static Set<String> getClassPaths(String packageName, boolean isDecode) throws IOException {
    ...
    public static <T> T invoke(String str, boolean z, Object... objArr) {
        ...
        return (T) invoke(str.substring(0, iLastIndexOf), str.substring(iLastIndexOf + 1), z, objArr);
    }
    ...
    public static <T> T invoke(String str, String str2, boolean z, Object... objArr) throws NoSuchMethodException {
        ...
        try {
            ...
            return (T) ReflectUtil.invoke(z ? Singleton.get(clsLoadClass, new Object[0]) : clsLoadClass.newInstance(), declaredMethod, objArr);
        } catch (Exception e) {
