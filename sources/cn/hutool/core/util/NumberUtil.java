...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/NumberUtil.class */
public class NumberUtil {
    ...
    public static BigDecimal div(BigDecimal v1, BigDecimal v2, int scale, RoundingMode roundingMode) throws IllegalArgumentException {
    ...
    public static BigDecimal round(String numberStr, int scale, RoundingMode roundingMode) throws IllegalArgumentException {
    ...
    public static String decimalFormat(String pattern, double value) throws Throwable {
    ...
    public static String decimalFormat(String pattern, Object value, RoundingMode roundingMode) throws Throwable {
    ...
    */
    ...
    public static boolean isPrimes(int n) throws Throwable {
    ...
    public static int[] generateRandomNumber(int begin, int end, int size, int[] seed) throws Throwable {
        if (begin > end) {
            begin = end;
            end = begin;
        }
    ...
    public static BigInteger factorial(BigInteger start, BigInteger end) throws IllegalArgumentException {
    ...
    public static boolean isGreater(BigDecimal bigNum1, BigDecimal bigNum2) throws IllegalArgumentException {
        Assert.notNull(bigNum1);
        Assert.notNull(bigNum2);
        return bigNum1.compareTo(bigNum2) > 0;
    }

    public static boolean isGreaterOrEqual(BigDecimal bigNum1, BigDecimal bigNum2) throws IllegalArgumentException {
        Assert.notNull(bigNum1);
        Assert.notNull(bigNum2);
        return bigNum1.compareTo(bigNum2) >= 0;
    }

    public static boolean isLess(BigDecimal bigNum1, BigDecimal bigNum2) throws IllegalArgumentException {
        Assert.notNull(bigNum1);
        Assert.notNull(bigNum2);
        return bigNum1.compareTo(bigNum2) < 0;
    }

    public static boolean isLessOrEqual(BigDecimal bigNum1, BigDecimal bigNum2) throws IllegalArgumentException {
        Assert.notNull(bigNum1);
        Assert.notNull(bigNum2);
        return bigNum1.compareTo(bigNum2) <= 0;
    }
    ...
    public static String toStr(Number number, boolean isStripTrailingZeros) throws Throwable {
    ...
    public static String toStr(BigDecimal bigDecimal, boolean isStripTrailingZeros) throws IllegalArgumentException {
