...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/IdUtil.class */
public class IdUtil {
    ...
    public static long getDataCenterId(long maxDatacenterId) throws Throwable {
    ...
    public static long getWorkerId(long datacenterId, long maxWorkerId) {
        ...
        return (mpid.toString().hashCode() & 65535) % (maxWorkerId + 1);
    }
