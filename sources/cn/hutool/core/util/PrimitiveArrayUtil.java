...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/util/PrimitiveArrayUtil.class */
public class PrimitiveArrayUtil {
    ...
    public static Object remove(Object array, int index) throws IllegalArgumentException, NegativeArraySizeException {
        if (null == array) {
            return null;
        }
        int length = Array.getLength(array);
