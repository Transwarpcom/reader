...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/convert/NumberWordFormatter.class */
public class NumberWordFormatter {
    ...
    private static final String[] NUMBER_SUFFIX = {OperatorName.NON_STROKING_CMYK, OperatorName.SET_LINE_WIDTH, "", "m", "", "", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "", "", "t", "", "", "p", "", "", "e"};
