...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/convert/Convert.class */
public class Convert {
    ...
    public static <T> T convertWithCheck(Type type, Object obj, T t, boolean z) throws Exception {
        try {
    ...
    public static long convertTime(long sourceDuration, TimeUnit sourceUnit, TimeUnit destUnit) throws IllegalArgumentException {
