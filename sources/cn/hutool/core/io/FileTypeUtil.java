...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/io/FileTypeUtil.class */
public class FileTypeUtil {
    ...
    public static String getType(File file) throws IOException, IORuntimeException {
        FileInputStream in = null;
        try {
            in = IoUtil.toStream(file);
            String type = getType(in, file.getName());
