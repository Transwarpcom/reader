...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/io/file/FileCopier.class */
public class FileCopier extends SrcToDestCopier<File, FileCopier> {
    ...
    private void internalCopyDirContent(File src, File dest) throws IOException, IORuntimeException {
    ...
    private void internalCopyFile(File src, File dest) throws IOException, IORuntimeException {
        if (null != this.copyFilter && false == this.copyFilter.accept(src)) {
            return;
        }
        if (dest.exists()) {
