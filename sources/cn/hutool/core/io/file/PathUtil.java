...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/io/file/PathUtil.class */
public class PathUtil {
    ...
    public static List<File> loopFiles(Path path, int maxDepth, final FileFilter fileFilter) throws IOException {
    ...
    public static void walkFiles(Path start, FileVisitor<? super Path> visitor) throws IOException {
    ...
    public static boolean del(Path path) throws IOException, IORuntimeException {
    ...
    public static Path copyFile(Path src, Path target, CopyOption... options) throws IllegalArgumentException, IORuntimeException {
    ...
    public static Path copy(Path src, Path target, CopyOption... options) throws IllegalArgumentException, IORuntimeException {
    ...
    public static Path copyContent(Path src, Path target, CopyOption... options) throws IOException, IllegalArgumentException, IORuntimeException {
        Assert.notNull(src, "Src path must be not null !", new Object[0]);
        Assert.notNull(target, "Target path must be not null !", new Object[0]);
        try {
    ...
    public static BufferedInputStream getInputStream(Path path) throws IOException, IORuntimeException {
        try {
    ...
    public static BufferedOutputStream getOutputStream(Path path) throws IOException, IORuntimeException {
        try {
    ...
    public static Path move(Path src, Path target, boolean isOverride) throws IllegalArgumentException {
        Assert.notNull(src, "Src path must be not null !", new Object[0]);
        Assert.notNull(target, "Target path must be not null !", new Object[0]);
    ...
    public static Path moveContent(Path src, Path target, boolean isOverride) throws IOException, IllegalArgumentException, IORuntimeException {
        Assert.notNull(src, "Src path must be not null !", new Object[0]);
        Assert.notNull(target, "Target path must be not null !", new Object[0]);
