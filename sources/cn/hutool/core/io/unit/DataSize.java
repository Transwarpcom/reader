...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/io/unit/DataSize.class */
public final class DataSize implements Comparable<DataSize> {
    ...
    public static DataSize parse(CharSequence text, DataUnit defaultUnit) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException(OperatorName.SHOW_TEXT_LINE + ((Object) text) + "' is not a valid data size", ex);
        }
    }
