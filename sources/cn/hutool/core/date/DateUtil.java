...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/date/DateUtil.class */
public class DateUtil extends CalendarUtil {
    ...
    public static int age(Date birthday, Date dateToCompare) throws IllegalArgumentException {
    ...
    public static String secondToTime(int seconds) {
        ...
        int hour = seconds / ACache.TIME_HOUR;
        int other = seconds % ACache.TIME_HOUR;
        int minute = other / 60;
        int second = other % 60;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/date/DateUtil$1.class */
