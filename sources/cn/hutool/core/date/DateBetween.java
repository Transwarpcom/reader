...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/date/DateBetween.class */
public class DateBetween implements Serializable {
    ...
    public DateBetween(Date begin, Date end, boolean isAbs) throws IllegalArgumentException {
