...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/date/GroupTimeInterval.class */
public class GroupTimeInterval implements Serializable {
    ...
    public long interval(String id, DateUnit dateUnit) {
        long intervalMs = this.isNano ? interval(id) / StaticHandler.DEFAULT_MAX_AVG_SERVE_TIME_NS : interval(id);
