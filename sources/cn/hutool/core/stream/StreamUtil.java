...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/stream/StreamUtil.class */
public class StreamUtil {
    @SafeVarargs
    public static <T> Stream<T> of(T... array) throws IllegalArgumentException {
    ...
    public static <T> Stream<T> of(Iterable<T> iterable, boolean parallel) throws IllegalArgumentException {
