...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/img/gif/LZWEncoder.class */
class LZWEncoder {
    ...
    int cur_accum = 0;
    int cur_bits = 0;
    final int[] masks = {0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, ShortCompanionObject.MAX_VALUE, 65535};
