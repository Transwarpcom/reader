...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/img/ImgUtil.class */
public class ImgUtil {
    ...
    public static void scale(File srcImageFile, File destImageFile, float scale) throws IORuntimeException {
        scale((Image) read(srcImageFile), destImageFile, scale);
    }

    public static void scale(InputStream srcStream, OutputStream destStream, float scale) throws IORuntimeException {
        scale((Image) read(srcStream), destStream, scale);
    }

    public static void scale(ImageInputStream srcStream, ImageOutputStream destStream, float scale) throws IORuntimeException {
        scale((Image) read(srcStream), destStream, scale);
    }
    ...
    public static void cut(File srcImgFile, File destImgFile, Rectangle rectangle) throws IOException, IORuntimeException {
        cut((Image) read(srcImgFile), destImgFile, rectangle);
    }

    public static void cut(InputStream srcStream, OutputStream destStream, Rectangle rectangle) throws IORuntimeException {
        cut((Image) read(srcStream), destStream, rectangle);
    }

    public static void cut(ImageInputStream srcStream, ImageOutputStream destStream, Rectangle rectangle) throws IORuntimeException {
        cut((Image) read(srcStream), destStream, rectangle);
    }

    public static void cut(Image srcImage, File destFile, Rectangle rectangle) throws IOException, IORuntimeException {
    ...
    public static void slice(File srcImageFile, File descDir, int destWidth, int destHeight) throws IOException, IORuntimeException {
        slice((Image) read(srcImageFile), descDir, destWidth, destHeight);
    }

    public static void slice(Image srcImage, File descDir, int destWidth, int destHeight) throws IOException, IORuntimeException {
        int cols;
        int rows;
        if (destWidth <= 0) {
            destWidth = 200;
    ...
    public static void convert(File srcImageFile, File destImageFile) throws Throwable {
    ...
    public static void convert(InputStream srcStream, String formatName, OutputStream destStream) throws IORuntimeException {
    ...
    public static void gray(File srcImageFile, File destImageFile) throws IOException, IORuntimeException {
        gray((Image) read(srcImageFile), destImageFile);
    }

    public static void gray(InputStream srcStream, OutputStream destStream) throws IORuntimeException {
        gray((Image) read(srcStream), getImageOutputStream(destStream));
    }

    public static void gray(ImageInputStream srcStream, ImageOutputStream destStream) throws IORuntimeException {
        gray((Image) read(srcStream), destStream);
    }

    public static void gray(Image srcImage, File outFile) throws IOException, IORuntimeException {
        write(gray(srcImage), outFile);
    }

    public static void gray(Image srcImage, OutputStream out) throws IORuntimeException {
    ...
    public static void binary(File srcImageFile, File destImageFile) throws IOException, IORuntimeException {
        binary((Image) read(srcImageFile), destImageFile);
    }

    public static void binary(InputStream srcStream, OutputStream destStream, String imageType) throws IORuntimeException {
        binary((Image) read(srcStream), getImageOutputStream(destStream), imageType);
    }

    public static void binary(ImageInputStream srcStream, ImageOutputStream destStream, String imageType) throws IORuntimeException {
        binary((Image) read(srcStream), destStream, imageType);
    }

    public static void binary(Image srcImage, File outFile) throws IOException, IORuntimeException {
        write(binary(srcImage), outFile);
    }

    public static void binary(Image srcImage, OutputStream out, String imageType) throws IORuntimeException {
    ...
    public static void pressText(File imageFile, File destFile, String pressText, Color color, Font font, int x, int y, float alpha) throws IOException, IORuntimeException {
        pressText((Image) read(imageFile), destFile, pressText, color, font, x, y, alpha);
    }

    public static void pressText(InputStream srcStream, OutputStream destStream, String pressText, Color color, Font font, int x, int y, float alpha) throws IORuntimeException {
        pressText((Image) read(srcStream), getImageOutputStream(destStream), pressText, color, font, x, y, alpha);
    }

    public static void pressText(ImageInputStream srcStream, ImageOutputStream destStream, String pressText, Color color, Font font, int x, int y, float alpha) throws IORuntimeException {
        pressText((Image) read(srcStream), destStream, pressText, color, font, x, y, alpha);
    }

    public static void pressText(Image srcImage, File destFile, String pressText, Color color, Font font, int x, int y, float alpha) throws IOException, IORuntimeException {
    ...
    public static void pressImage(File srcImageFile, File destImageFile, Image pressImg, int x, int y, float alpha) throws IOException, IORuntimeException {
        pressImage((Image) read(srcImageFile), destImageFile, pressImg, x, y, alpha);
    }

    public static void pressImage(InputStream srcStream, OutputStream destStream, Image pressImg, int x, int y, float alpha) throws IORuntimeException {
    ...
    public static void pressImage(Image srcImage, File outFile, Image pressImg, int x, int y, float alpha) throws IOException, IORuntimeException {
    ...
    public static void rotate(File imageFile, int degree, File outFile) throws IOException, IORuntimeException {
        rotate((Image) read(imageFile), degree, outFile);
    }

    public static void rotate(Image image, int degree, File outFile) throws IOException, IORuntimeException {
    ...
    public static void flip(File imageFile, File outFile) throws IOException, IORuntimeException {
        flip((Image) read(imageFile), outFile);
    }

    public static void flip(Image image, File outFile) throws IOException, IORuntimeException {
    ...
    public static String toBase64DataUri(Image image, String imageType) {
        return URLUtil.getDataUri("image/" + imageType, HttpHeaders.Values.BASE64, toBase64(image, imageType));
    }
    ...
    public static byte[] toBytes(Image image, String imageType) throws IORuntimeException {
    ...
    public static void write(ImageInputStream srcStream, String formatName, ImageOutputStream destStream) throws IORuntimeException {
    ...
    public static void write(Image image, File targetFile) throws IOException, IORuntimeException {
