...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/builder/HashCodeBuilder.class */
public class HashCodeBuilder implements Builder<Integer> {
    ...
    public HashCodeBuilder(int initialOddNumber, int multiplierOddNumber) throws Throwable {
