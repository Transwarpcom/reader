...
/* loaded from: reader.jar:BOOT-INF/lib/hutool-core-5.8.0.M1.jar:cn/hutool/core/lang/Console.class */
public class Console {
    ...
    public static void printProgress(char showChar, int totalLen, double rate) throws Throwable {
