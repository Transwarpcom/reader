...
/* loaded from: reader.jar:BOOT-INF/lib/json-smart-2.4.7.jar:net/minidev/json/writer/BeansMapper.class */
public abstract class BeansMapper<T> extends JsonReaderI<T> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/json-smart-2.4.7.jar:net/minidev/json/writer/BeansMapper$Bean.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/json-smart-2.4.7.jar:net/minidev/json/writer/BeansMapper$BeanNoConv.class */
