...
/* loaded from: reader.jar:BOOT-INF/lib/json-path-2.6.0.jar:com/jayway/jsonpath/internal/filter/ValueNode.class */
public abstract class ValueNode {
    ...
    public static ValueNode toValueNode(Object o) {
        ...
        if (isPath(o)) {
            return new ValueNodes.PathNode((CharSequence) o.toString(), false, false);
        }
        if (isJson(o)) {
