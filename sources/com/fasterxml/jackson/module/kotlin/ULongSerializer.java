...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-module-kotlin-2.13.5.jar:com/fasterxml/jackson/module/kotlin/ULongSerializer.class */
public final class ULongSerializer extends StdSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ void serialize(Object p0, JsonGenerator p1, SerializerProvider p2) throws IOException {
        m516serializeE0BElUM(((ULong) p0).m2328unboximpl(), p1, p2);
    }

    /* renamed from: serialize-E0BElUM, reason: not valid java name */
    public void m516serializeE0BElUM(long value, @NotNull JsonGenerator gen, @NotNull SerializerProvider provider) throws IOException {
