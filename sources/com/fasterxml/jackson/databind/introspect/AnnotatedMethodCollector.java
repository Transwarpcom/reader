...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector.class */
public class AnnotatedMethodCollector extends CollectorBase {
    ...
    AnnotatedMethodMap collect(TypeFactory typeFactory, TypeResolutionContext tc, JavaType mainType, List<JavaType> superTypes, Class<?> primaryMixIn) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        Class<?> mixin;
    ...
    private void _addMemberMethods(TypeResolutionContext tc, Class<?> cls, Map<MemberKey, MethodBuilder> methods, Class<?> mixInCls) throws ClassNotFoundException {
        if (mixInCls != null) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector$MethodBuilder.class */
