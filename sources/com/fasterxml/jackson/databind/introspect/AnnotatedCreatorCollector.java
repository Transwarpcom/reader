...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/introspect/AnnotatedCreatorCollector.class */
final class AnnotatedCreatorCollector extends CollectorBase {
    ...
    AnnotatedClass.Creators collect(JavaType type, Class<?> primaryMixIn) throws SecurityException, ClassNotFoundException {
    ...
    private List<AnnotatedMethod> _findPotentialFactories(JavaType type, Class<?> primaryMixIn) throws ClassNotFoundException {
    ...
    protected AnnotatedConstructor constructDefaultConstructor(ClassUtil.Ctor ctor, ClassUtil.Ctor mixin) {
        ...
        return new AnnotatedConstructor(this._typeContext, ctor.getConstructor(), collectAnnotations(ctor, mixin), collectAnnotations(ctor.getConstructor().getParameterAnnotations(), mixin == null ? (Annotation[][]) null : mixin.getConstructor().getParameterAnnotations()));
    }
    ...
    protected AnnotatedMethod constructFactoryCreator(Method m, Method mixin) {
        ...
        return new AnnotatedMethod(this._typeContext, m, collectAnnotations(m, mixin), collectAnnotations(m.getParameterAnnotations(), mixin == null ? (Annotation[][]) null : mixin.getParameterAnnotations()));
    }
