...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/jsontype/impl/StdTypeResolverBuilder.class */
public class StdTypeResolverBuilder implements TypeResolverBuilder<StdTypeResolverBuilder> {
    ...
    @Override // com.fasterxml.jackson.databind.jsontype.TypeResolverBuilder
    public TypeDeserializer buildTypeDeserializer(DeserializationConfig config, JavaType baseType, Collection<NamedType> subtypes) throws IllegalArgumentException {
        if (this._idType == JsonTypeInfo.Id.NONE || baseType.isPrimitive()) {
            return null;
        }
    ...
    protected JavaType defineDefaultImpl(DeserializationConfig config, JavaType baseType) throws IllegalArgumentException {
