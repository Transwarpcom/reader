...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/SerializerProvider.class */
public abstract class SerializerProvider extends DatabindContext {
    ...
    protected JsonSerializer<Object> _createUntypedSerializer(JavaType type) throws JsonMappingException {
        ...
        synchronized (this._serializerCache) {
            jsonSerializerCreateSerializer = this._serializerFactory.createSerializer(this, type);
        }
