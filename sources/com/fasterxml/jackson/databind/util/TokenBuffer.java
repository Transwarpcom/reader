...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/util/TokenBuffer.class */
public class TokenBuffer extends JsonGenerator {
    ...
    protected final void _append(JsonToken type) {
        ...
        if (this._hasNativeId) {
            segmentAppend = this._last.append(this._appendAt, type, this._objectId, this._typeId);
        } else {
            segmentAppend = this._last.append(this._appendAt, type);
        }
        Segment next = segmentAppend;
        if (next == null) {
            this._appendAt++;
        } else {
            this._last = next;
    ...
    protected final void _append(JsonToken type, Object value) {
        Segment segmentAppend;
        if (this._hasNativeId) {
            segmentAppend = this._last.append(this._appendAt, type, value, this._objectId, this._typeId);
        } else {
            segmentAppend = this._last.append(this._appendAt, type, value);
        }
        Segment next = segmentAppend;
        if (next == null) {
            this._appendAt++;
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Parser.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Segment.class */
