...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/type/TypeFactory.class */
public final class TypeFactory implements Serializable {
    ...
    */
    public com.fasterxml.jackson.databind.JavaType constructSpecializedType(com.fasterxml.jackson.databind.JavaType r9, java.lang.Class<?> r10) throws java.lang.IllegalArgumentException {
        /*
    ...
    private TypeBindings _bindingsForSubtype(JavaType baseType, int typeParamCount, Class<?> subclass) throws IllegalArgumentException {
    ...
    private String _resolveTypePlaceholders(JavaType sourceType, JavaType actualType) throws IllegalArgumentException {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (!_verifyAndResolvePlaceholders(exp, act) && !exp.hasRawClass(Object.class) && ((i != 0 || !sourceType.hasRawClass(Map.class) || !act.hasRawClass(Object.class)) && (!exp.isInterface() || !exp.isTypeOrSuperTypeOf(act.getRawClass())))) {
