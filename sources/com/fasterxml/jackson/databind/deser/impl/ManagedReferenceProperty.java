...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/deser/impl/ManagedReferenceProperty.class */
        ...
        if (value != null) {
            if (this._isContainer) {
                if (value instanceof Object[]) {
                    ...
                    throw new IllegalStateException("Unsupported container type (" + value.getClass().getName() + ") when resolving reference '" + this._referenceName + OperatorName.SHOW_TEXT_LINE);
                }
            } else {
