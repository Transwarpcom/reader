...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/deser/impl/PropertyValueBuffer.class */
public class PropertyValueBuffer {
    ...
    public Object getParameter(SettableBeanProperty prop) throws JsonMappingException {
        ...
        if (value == null && this._context.isEnabled(DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES)) {
            return this._context.reportInputMismatch(prop, "Null value for creator property '%s' (index %d); `DeserializationFeature.FAIL_ON_NULL_FOR_CREATOR_PARAMETERS` enabled", prop.getName(), Integer.valueOf(prop.getCreatorIndex()));
        }
        return value;
    }
