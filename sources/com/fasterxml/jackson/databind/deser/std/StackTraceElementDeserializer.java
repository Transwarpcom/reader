...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/deser/std/StackTraceElementDeserializer.class */
            ...
            while (true) {
                ...
                if (t2 != JsonToken.END_OBJECT) {
                    ...
                    if ("className".equals(propName)) {
                        ...
                        } else if (!"declaringClass".equals(propName) && !PackageDocumentBase.DCTags.format.equals(propName)) {
