...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-databind-2.9.9.jar:com/fasterxml/jackson/databind/deser/std/StdDeserializer.class */
public abstract class StdDeserializer<T> extends JsonDeserializer<T> implements Serializable {
    ...
    protected String _coercedTypeDesc() {
        ...
        if (t != null && !t.isPrimitive()) {
            ...
            typeDesc = OperatorName.SHOW_TEXT_LINE + t.toString() + OperatorName.SHOW_TEXT_LINE;
        } else {
