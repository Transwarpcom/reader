...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/base/ParserBase.class */
public abstract class ParserBase extends ParserMinimalBase {
    ...
    protected void _reportTooLongInt(int expType, String rawNum) throws IOException {
        String numDesc = _longIntegerDesc(rawNum);
        _reportError("Numeric value (%s) out of range of %s", numDesc, expType == 2 ? "long" : "int");
    }
