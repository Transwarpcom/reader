...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/base/ParserMinimalBase.class */
public abstract class ParserMinimalBase extends JsonParser {
    ...
    protected static final String _getCharDesc(int ch2) {
        ...
        if (ch2 > 255) {
            return OperatorName.SHOW_TEXT_LINE + c + "' (code " + ch2 + " / 0x" + Integer.toHexString(ch2) + ")";
        }
        return OperatorName.SHOW_TEXT_LINE + c + "' (code " + ch2 + ")";
    }
