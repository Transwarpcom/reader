...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/Base64Variants.class */
public final class Base64Variants {
    ...
    public static Base64Variant valueOf(String name) throws IllegalArgumentException {
        ...
        if (name == null) {
            ...
            name2 = OperatorName.SHOW_TEXT_LINE + name + OperatorName.SHOW_TEXT_LINE;
        }
