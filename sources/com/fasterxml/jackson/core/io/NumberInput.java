...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/io/NumberInput.class */
public final class NumberInput {
    ...
    public static int parseInt(char[] ch2, int off, int len) {
        ...
        if (len > 4) {
            int off2 = off + 1;
            int i = ((num * 10) + (ch2[off2] - '0')) * 10;
            int off3 = off2 + 1;
            int i2 = (i + (ch2[off3] - '0')) * 10;
            int off4 = off3 + 1;
            int i3 = (i2 + (ch2[off4] - '0')) * 10;
            off = off4 + 1;
            num = i3 + (ch2[off] - '0');
            len -= 4;
            if (len > 4) {
                int off5 = off + 1;
                int i4 = ((num * 10) + (ch2[off5] - '0')) * 10;
                int off6 = off5 + 1;
                int i5 = (i4 + (ch2[off6] - '0')) * 10;
                int off7 = off6 + 1;
                return ((i5 + (ch2[off7] - '0')) * 10) + (ch2[off7 + 1] - '0');
            }
        }
        if (len > 1) {
            int off8 = off + 1;
