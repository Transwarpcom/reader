...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/json/UTF8StreamJsonParser.class */
public class UTF8StreamJsonParser extends ParserBase {
                ...
                if (bits3 < 0) {
                    ...
                    if (bits3 == -2) {
                        ...
                        if (!b64variant.usesPaddingChar(ch5) && _decodeBase64Escape(b64variant, ch5, 3) != -2) {
                            throw reportInvalidBase64Char(b64variant, ch5, 3, "expected padding character '" + b64variant.getPaddingChar() + OperatorName.SHOW_TEXT_LINE);
                        }
                        int i6 = outputPtr;
                        outputPtr++;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x004b, code lost:
        ...
        if (r7._parsingContext.inArray() == false) goto L33;
     */
