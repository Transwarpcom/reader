...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/json/JsonWriteContext.class */
public class JsonWriteContext extends JsonStreamContext {
    ...
    private final void _checkDup(DupDetector dd, String name) throws JsonProcessingException {
        if (dd.isDup(name)) {
            ...
            throw new JsonGenerationException("Duplicate field '" + name + OperatorName.SHOW_TEXT_LINE, src instanceof JsonGenerator ? (JsonGenerator) src : null);
        }
    }
