...
/* loaded from: reader.jar:BOOT-INF/lib/jackson-core-2.9.9.jar:com/fasterxml/jackson/core/JsonPointer.class */
public class JsonPointer {
    ...
    public static JsonPointer compile(String input) throws IllegalArgumentException {
        ...
        if (input.charAt(0) != '/') {
            throw new IllegalArgumentException("Invalid input: JSON Pointer expression must start with '/': \"" + input + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
        }
