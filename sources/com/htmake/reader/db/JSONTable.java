...
public final class JSONTable<T> extends DB<T> {
    ...
    public void saveMulti(@NotNull T[] value, @Nullable Function3<? super T, ? super Boolean, ? super JsonArray, Unit> onCheckEnd, @NotNull Function2<? super JsonObject, ? super T, Boolean> checker) {
        ...
        while (i < length) {
            ...
            if (existIndex >= 0) {
                dataList.set(existIndex, JsonObject.mapFrom(t));
            } else {
        ...
        if (removeIndexList.size() > 0) {
            ...
            if (0 < size2) {
                do {
                    int i4 = i3;
                    i3++;
                    if (!removeIndexList.contains(Integer.valueOf(i4))) {
                        newList.add(dataList.getJsonObject(i4));
                    }
                } while (i3 < size2);
            }
            dataList = newList;
