...
/* loaded from: reader.jar:BOOT-INF/classes/com/htmake/reader/api/controller/LicenseController$importLicense$$inlined$CoroutineExceptionHandler$1.class */
public final class LicenseController$importLicense$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    ...
    public LicenseController$importLicense$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Key $super_call_param$1, RoutingContext routingContext, ReturnData returnData) {
    ...
    public void handleException(@NotNull CoroutineContext context, @NotNull Throwable exception) {
        LicenseControllerKt.logger.info("activate license error: {}", exception.getMessage());
