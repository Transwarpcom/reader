...
/* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap.class */
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    Node<K, V> find(K k, boolean z) {
        ...
        int i = 0;
        if (node2 != null) {
            Comparable<Object> comparable = comparator == NATURAL_ORDER ? (Comparable) k : null;
            while (true) {
                if (comparable != null) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap$Node.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap$AvlIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap$AvlBuilder.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap$LinkedTreeMapIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap$EntrySet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/LinkedHashTreeMap$KeySet.class */
