...
/* loaded from: reader.jar:BOOT-INF/lib/gson-2.8.5.jar:com/google/gson/internal/bind/util/ISO8601Utils.class */
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean millis, TimeZone tz) {
        ...
        padInt(formatted, calendar.get(1), DatePattern.NORM_YEAR_PATTERN.length());
        formatted.append('-');
