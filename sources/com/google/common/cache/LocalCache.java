...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache.class */
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$Strength.class */
    enum Strength {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$ValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$EntryFactory.class */
    enum EntryFactory {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$NullEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$AbstractReferenceEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$StrongEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$StrongAccessEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$StrongWriteEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$StrongAccessWriteEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeakEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeakAccessEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeakWriteEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeakAccessWriteEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeakValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$SoftValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$StrongValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeightedWeakValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeightedSoftValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WeightedStrongValueReference.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$Segment.class */
    static class Segment<K, V> extends ReentrantLock {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:30:0x0138, code lost:
            ...
            r11 = newEntry(r8, r9, r0);
            r11.setValueReference(r13);
            r0.set(r0, r11);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:54:0x01a9, code lost:
            ...
            r7.statsCounter.recordMisses(1);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:57:0x01be, code lost:
            ...
            return waitForLoadingValue(r11, r8, r12);
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        V lockedGetOrLoad(K r8, int r9, com.google.common.cache.CacheLoader<? super K, V> r10) throws java.util.concurrent.ExecutionException {
            /*
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r0v21, types: [com.google.common.cache.LocalCache$LoadingValueReference, com.google.common.cache.LocalCache$ValueReference] */
        /* JADX WARN: Type inference failed for: r0v23, types: [com.google.common.cache.ReferenceEntry] */
        /* JADX WARN: Type inference failed for: r0v25, types: [V, java.lang.Object] */
        /* JADX WARN: Type inference failed for: r11v3, types: [com.google.common.cache.ReferenceEntry, java.lang.Object] */
        /* JADX WARN: Type inference failed for: r7v0, types: [com.google.common.cache.LocalCache$Segment, com.google.common.cache.LocalCache$Segment<K, V>] */
        V compute(K k, int i, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            ...
            try {
                ...
                if (next == null) {
                    z = true;
                    ?? NewEntry = newEntry(k, i, referenceEntry2);
                ...
                ?? Compute = loadingValueReference.compute(k, biFunction);
                if (Compute == null) {
                    if (z) {
                    ...
                    removeEntry(referenceEntry, i, RemovalCause.EXPLICIT);
                    unlock();
                    postWriteCleanup();
                    return null;
                }
                if (valueReference == null || Compute != valueReference.get()) {
                    try {
                        V v = (V) getAndRecordStats(k, i, loadingValueReference, Futures.immediateFuture(Compute));
                        unlock();
                        postWriteCleanup();
                        return v;
                ...
                recordWrite(referenceEntry, 0, j);
                unlock();
                postWriteCleanup();
                return Compute;
            } catch (Throwable th) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$LoadingValueReference.class */
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public V compute(K k, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            ...
            this.stopwatch.start();
            try {
                vWaitForValue = this.oldValue.waitForValue();
            } catch (ExecutionException e) {
                vWaitForValue = null;
            }
            try {
                V vApply = biFunction.apply(k, (Object) vWaitForValue);
                set(vApply);
                return vApply;
            } catch (Throwable th) {
                setException(th);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WriteQueue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$AccessQueue.class */
    ...
    */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$HashIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$KeyIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$ValueIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$WriteThroughEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$EntryIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$AbstractCacheSet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$KeySet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$Values.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$EntrySet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$ManualSerializationProxy.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$LoadingSerializationProxy.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$LocalManualCache.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/cache/LocalCache$LocalLoadingCache.class */
