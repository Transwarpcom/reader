...
@Beta
@GwtCompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/UnsignedLongs.class */
public final class UnsignedLongs {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/UnsignedLongs$LexicographicalComparator.class */
    ...
    public static void sortDescending(long[] array, int fromIndex, int toIndex) {
        ...
        for (int i3 = fromIndex; i3 < toIndex; i3++) {
            int i4 = i3;
            array[i4] = array[i4] ^ Long.MAX_VALUE;
        }
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/UnsignedLongs$ParseOverflowDetection.class */
