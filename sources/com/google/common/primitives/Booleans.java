...
@GwtCompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/Booleans.class */
public final class Booleans {
    private Booleans() {
    }

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/Booleans$BooleanComparator.class */
    ...
    */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/Booleans$LexicographicalComparator.class */
    ...
    @GwtCompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/primitives/Booleans$BooleanArrayAsList.class */
