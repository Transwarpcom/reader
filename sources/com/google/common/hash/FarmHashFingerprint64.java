...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/hash/FarmHashFingerprint64.class */
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bytes, int offset, int length) {
        ...
        if (length >= 4) {
            ...
            return hashLength16(length + (a2 << 3), LittleEndianByteArray.load32(bytes, (offset + length) - 4) & 4294967295L, K2 + (length * 2));
        }
        if (length > 0) {
