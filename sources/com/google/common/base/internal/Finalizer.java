...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/base/internal/Finalizer.class */
public class Finalizer implements Runnable {
    ...
    public static void startFinalizer(Class<?> finalizableReferenceClass, ReferenceQueue<Object> queue, PhantomReference<Object> frqReference) {
        ...
        if (bigThreadConstructor != null) {
            try {
                thread = bigThreadConstructor.newInstance((ThreadGroup) null, finalizer, threadName, 0L, false);
            } catch (Throwable t) {
