...
@Beta
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/reflect/AbstractInvocationHandler.class */
public abstract class AbstractInvocationHandler implements InvocationHandler {
    ...
    public final Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (args.length == 0 && method.getName().equals(IdentityNamingStrategy.HASH_CODE_KEY)) {
