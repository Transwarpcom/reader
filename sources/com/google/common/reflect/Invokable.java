...
@Beta
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/reflect/Invokable.class */
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    public abstract boolean isOverridable();

    public abstract boolean isVarArgs();

    abstract Object invokeInternal(Object obj, Object[] objArr) throws IllegalAccessException, InvocationTargetException;
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < parameterTypes.length; i++) {
            builder.add((ImmutableList.Builder<Parameter>) new Parameter(this, i, TypeToken.of(parameterTypes[i]), annotations[i], annotatedTypes[i]));
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/reflect/Invokable$MethodInvokable.class */
    static class MethodInvokable<T> extends Invokable<T, Object> {
        ...
        final Object invokeInternal(Object receiver, Object[] args) throws IllegalAccessException, InvocationTargetException {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/reflect/Invokable$ConstructorInvokable.class */
