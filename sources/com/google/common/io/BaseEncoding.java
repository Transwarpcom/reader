...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding.class */
public abstract class BaseEncoding {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding$DecodingException.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding$Alphabet.class */
    private static final class Alphabet {
        ...
        boolean canDecode(char ch2) {
            return ch2 <= 127 && this.decodabet[ch2] != -1;
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding$StandardBaseEncoding.class */
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        public BaseEncoding upperCase() {
            ...
            if (result == null) {
                ...
                BaseEncoding baseEncodingNewInstance = upper == this.alphabet ? this : newInstance(upper, this.paddingChar);
                this.upperCase = baseEncodingNewInstance;
                result = baseEncodingNewInstance;
            }
            return result;
        }
        ...
        public BaseEncoding lowerCase() {
            ...
            if (result == null) {
                ...
                BaseEncoding baseEncodingNewInstance = lower == this.alphabet ? this : newInstance(lower, this.paddingChar);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding$Base16Encoding.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding$Base64Encoding.class */
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        void encodeTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            ...
            for (int remaining = len; remaining >= 3; remaining -= 3) {
                ...
                int i3 = i + 1;
                int i4 = i3 + 1;
                int i5 = ((bytes[i2] & 255) << 16) | ((bytes[i3] & 255) << 8);
                i = i4 + 1;
                int chunk = i5 | (bytes[i4] & 255);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/BaseEncoding$SeparatedBaseEncoding.class */
