...
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/ByteStreams.class */
public final class ByteStreams {
    ...
    private static byte[] toByteArrayInternal(InputStream in, Deque<byte[]> bufs, int totalLen) throws IOException {
        ...
        while (true) {
            int bufSize = iSaturatedMultiply;
            if (totalLen < MAX_ARRAY_LEN) {
                ...
                iSaturatedMultiply = IntMath.saturatedMultiply(bufSize, 2);
            } else {
                if (in.read() == -1) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/ByteStreams$ByteArrayDataInputStream.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/ByteStreams$ByteArrayDataOutputStream.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/ByteStreams$LimitedInputStream.class */
