...
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/io/LineBuffer.class */
abstract class LineBuffer {
    ...
    private boolean finishLine(boolean sawNewline) throws IOException {
        String separator = this.sawReturn ? sawNewline ? StrPool.CRLF : "\r" : sawNewline ? "\n" : "";
