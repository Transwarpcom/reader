...
@Beta
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/ImmutableGraph.class */
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N node) {
        ...
        if (graph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(graph.predecessors((Graph<N>) node), Maps.asMap(graph.successors((Graph<N>) node), edgeValueFn));
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/ImmutableGraph$Builder.class */
