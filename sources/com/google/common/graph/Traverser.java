...
@Beta
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser.class */
public abstract class Traverser<N> {

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$Order.class */
    private enum Order {
        PREORDER,
        POSTORDER
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$GraphTraverser.class */
    private static final class GraphTraverser<N> extends Traverser<N> {
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$GraphTraverser$BreadthFirstIterator.class */
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$GraphTraverser$DepthFirstIterator.class */
        private final class DepthFirstIterator extends AbstractIterator<N> {
            ...
            protected N computeNext() {
                while (!this.stack.isEmpty()) {
                    ...
                    boolean z2 = (zAdd && this.order == Order.PREORDER) || (z && this.order == Order.POSTORDER);
                    if (z) {
                        this.stack.pop();
                    } else {
            ...
            /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$GraphTraverser$DepthFirstIterator$NodeAndSuccessors.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$TreeTraverser.class */
    private static final class TreeTraverser<N> extends Traverser<N> {
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$TreeTraverser$BreadthFirstIterator.class */
        private final class BreadthFirstIterator extends UnmodifiableIterator<N> {
            private final Queue<N> queue = new ArrayDeque();
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$TreeTraverser$DepthFirstPreOrderIterator.class */
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$TreeTraverser$DepthFirstPostOrderIterator.class */
        private final class DepthFirstPostOrderIterator extends AbstractIterator<N> {
            ...
            /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/Traverser$TreeTraverser$DepthFirstPostOrderIterator$NodeAndChildren.class */
