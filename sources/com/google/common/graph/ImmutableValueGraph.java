...
@Beta
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/ImmutableValueGraph.class */
public final class ImmutableValueGraph<N, V> extends ConfigurableValueGraph<N, V> {
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(final ValueGraph<N, V> graph, final N node) {
        Function<N, V> successorNodeToValueFn = new Function<N, V>() { // from class: com.google.common.graph.ImmutableValueGraph.1
            ...
            public V apply(N n) {
                return (V) graph.edgeValueOrDefault(node, n, null);
            }
        };
        if (graph.isDirected()) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/ImmutableValueGraph$Builder.class */
