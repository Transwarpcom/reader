...
@Immutable
@Beta
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/ElementOrder.class */
public final class ElementOrder<T> {
    private final Type type;
    private final Comparator<T> comparator;

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/graph/ElementOrder$Type.class */
    public enum Type {
        UNORDERED,
        INSERTION,
        SORTED
