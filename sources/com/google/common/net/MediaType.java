...
@Beta
@GwtCompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/net/MediaType.class */
public final class MediaType {
    ...
    public static final MediaType BMP = createConstant(IMAGE_TYPE, ImgUtil.IMAGE_TYPE_BMP);
    public static final MediaType CRW = createConstant(IMAGE_TYPE, "x-canon-crw");
    public static final MediaType GIF = createConstant(IMAGE_TYPE, ImgUtil.IMAGE_TYPE_GIF);
    public static final MediaType ICO = createConstant(IMAGE_TYPE, "vnd.microsoft.icon");
    public static final MediaType JPEG = createConstant(IMAGE_TYPE, ImgUtil.IMAGE_TYPE_JPEG);
    public static final MediaType PNG = createConstant(IMAGE_TYPE, ImgUtil.IMAGE_TYPE_PNG);
    ...
    public static final MediaType KEY_ARCHIVE = createConstant("application", KeyUtil.KEY_TYPE_PKCS12);
    public static final MediaType APPLICATION_BINARY = createConstant("application", HttpHeaders.Values.BINARY);
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not parse '" + input + OperatorName.SHOW_TEXT_LINE, e);
        }
    }

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/net/MediaType$Tokenizer.class */
