...
@Beta
@GwtCompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/net/HostAndPort.class */
public final class HostAndPort implements Serializable {
    ...
    public static HostAndPort fromString(String hostPortString) throws NumberFormatException {
        ...
        if (!Strings.isNullOrEmpty(portString)) {
            Preconditions.checkArgument(!portString.startsWith(Marker.ANY_NON_NULL_MARKER), "Unparseable port number: %s", hostPortString);
            try {
