...
@Beta
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/net/InetAddresses.class */
public final class InetAddresses {
    ...
    private static final Inet4Address ANY4 = (Inet4Address) forString(NetServerOptions.DEFAULT_HOST);
    ...
    private static byte[] textToNumericFormatV6(String ipString) {
        ...
        if (skipIndex >= 0) {
            ...
            if (((String) Iterables.getLast(parts)).length() == 0) {
                partsLo--;
                if (partsLo != 0) {
                    return null;
                }
    ...
    private static byte parseOctet(String ipPart) throws NumberFormatException {
    ...
    private static short parseHextet(String ipPart) throws NumberFormatException {
    ...
    @Beta
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/net/InetAddresses$TeredoInfo.class */
