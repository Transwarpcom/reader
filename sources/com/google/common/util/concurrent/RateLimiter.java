...
@Beta
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/RateLimiter.class */
public abstract class RateLimiter {
    ...
    public static RateLimiter create(double permitsPerSecond, Duration warmupPeriod) {
        return create(permitsPerSecond, Internal.saturatedToNanos(warmupPeriod), TimeUnit.NANOSECONDS);
    }
    ...
    public boolean tryAcquire(Duration timeout) {
        return tryAcquire(1, Internal.saturatedToNanos(timeout), TimeUnit.NANOSECONDS);
    }
    ...
    public boolean tryAcquire(int permits, Duration timeout) {
        return tryAcquire(permits, Internal.saturatedToNanos(timeout), TimeUnit.NANOSECONDS);
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/RateLimiter$SleepingStopwatch.class */
