...
@GwtCompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/AtomicLongMap.class */
public final class AtomicLongMap<K> implements Serializable {
    ...
    public long updateAndGet(K key, LongUnaryOperator updaterFunction) {
        ...
        return this.map.compute(key, (k, value) -> {
            return Long.valueOf(updaterFunction.applyAsLong(value == null ? 0L : value.longValue()));
        }).longValue();
    }
    ...
    public long getAndAccumulate(K key, long x, LongBinaryOperator accumulatorFunction) {
        Preconditions.checkNotNull(accumulatorFunction);
        return getAndUpdate(key, oldValue -> {
            return accumulatorFunction.applyAsLong(oldValue, x);
        });
    }
