...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors.class */
public final class MoreExecutors {
    ...
    public static ExecutorService getExitingExecutorService(ThreadPoolExecutor executor, Duration terminationTimeout) {
        return getExitingExecutorService(executor, Internal.saturatedToNanos(terminationTimeout), TimeUnit.NANOSECONDS);
    }
    ...
    public static ScheduledExecutorService getExitingScheduledExecutorService(ScheduledThreadPoolExecutor executor, Duration terminationTimeout) {
        return getExitingScheduledExecutorService(executor, Internal.saturatedToNanos(terminationTimeout), TimeUnit.NANOSECONDS);
    }
    ...
    public static void addDelayedShutdownHook(ExecutorService service, Duration terminationTimeout) {
        addDelayedShutdownHook(service, Internal.saturatedToNanos(terminationTimeout), TimeUnit.NANOSECONDS);
    }
    ...
    @VisibleForTesting
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$Application.class */
    ...
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$DirectExecutorService.class */
    ...
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$ListeningDecorator.class */
    ...
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$ScheduledListeningDecorator.class */
    private static final class ScheduledListeningDecorator extends ListeningDecorator implements ListeningScheduledExecutorService {
        ...
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$ScheduledListeningDecorator$ListenableScheduledTask.class */
        ...
        @GwtIncompatible
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$ScheduledListeningDecorator$NeverSuccessfulListenableFutureTask.class */
    ...
    @GwtIncompatible
    static <T> T invokeAnyImpl(ListeningExecutorService listeningExecutorService, Collection<? extends Callable<T>> collection, boolean z, Duration duration) throws ExecutionException, InterruptedException, TimeoutException {
        return (T) invokeAnyImpl(listeningExecutorService, collection, z, Internal.saturatedToNanos(duration), TimeUnit.NANOSECONDS);
    }
    ...
    static <T> T invokeAnyImpl(ListeningExecutorService executorService, Collection<? extends Callable<T>> tasks, boolean timed, long timeout, TimeUnit unit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        long lastTime = jNanoTime;
        Iterator<? extends Callable<T>> it2 = tasks.iterator();
        futures.add(submitAndAddQueueListener(executorService, it2.next(), futureQueue));
    ...
    public static boolean shutdownAndAwaitTermination(ExecutorService service, Duration timeout) {
        return shutdownAndAwaitTermination(service, Internal.saturatedToNanos(timeout), TimeUnit.NANOSECONDS);
    }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/MoreExecutors$5.class */
