...
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/ListenerCallQueue.class */
final class ListenerCallQueue<L> {
    private static final Logger logger = Logger.getLogger(ListenerCallQueue.class.getName());
    private final List<PerListenerQueue<L>> listeners = Collections.synchronizedList(new ArrayList());

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/ListenerCallQueue$Event.class */
    interface Event<L> {
        void call(L l);
    }
    ...
    private void enqueueHelper(Event<L> event, Object label) {
        Preconditions.checkNotNull(event, PackageDocumentBase.OPFAttributes.event);
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/util/concurrent/ListenerCallQueue$PerListenerQueue.class */
    private static final class PerListenerQueue<L> implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:20:0x0053, code lost:
            ...
            com.google.common.util.concurrent.ListenerCallQueue.logger.log(java.util.logging.Level.SEVERE, "Exception while executing callback: " + r5.listener + " " + r0, (java.lang.Throwable) r9);
         */
