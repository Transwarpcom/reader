...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedHashMultimap.class */
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedHashMultimap$ValueSetLink.class */
    ...
    @VisibleForTesting
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedHashMultimap$ValueEntry.class */
    ...
    @VisibleForTesting
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedHashMultimap$ValueSet.class */
    final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public void forEach(Consumer<? super V> consumer) {
            ...
            while (true) {
                ValueSetLink<K, V> valueSetLink = successorInValueSet;
                if (valueSetLink != this) {
                    consumer.accept(((ValueEntry) valueSetLink).getValue());
                    successorInValueSet = valueSetLink.getSuccessorInValueSet();
                } else {
                    return;
                }
            }
    ...
    private void readObject(ObjectInputStream stream) throws ClassNotFoundException, IOException {
        ...
        for (int i2 = 0; i2 < entries; i2++) {
            ((Collection) mapNewLinkedHashMapWithExpectedSize.get(stream.readObject())).add(stream.readObject());
        }
