...
@GwtCompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableTable.class */
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableTable$CellSet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableTable$Values.class */
    ...
    private static <R, C, V> RegularImmutableTable<R, C, V> forCellsInternal(Iterable<Table.Cell<R, C, V>> cells, Comparator<? super R> rowComparator, Comparator<? super C> columnComparator) {
        ImmutableSet<R> immutableSetCopyOf;
        ImmutableSet<C> immutableSetCopyOf2;
        ...
        if (rowComparator == null) {
            immutableSetCopyOf = ImmutableSet.copyOf((Collection) rowSpaceBuilder);
        } else {
            immutableSetCopyOf = ImmutableSet.copyOf((Collection) ImmutableList.sortedCopyOf(rowComparator, rowSpaceBuilder));
        }
        ImmutableSet<R> rowSpace = immutableSetCopyOf;
        if (columnComparator == null) {
            immutableSetCopyOf2 = ImmutableSet.copyOf((Collection) columnSpaceBuilder);
        } else {
            immutableSetCopyOf2 = ImmutableSet.copyOf((Collection) ImmutableList.sortedCopyOf(columnComparator, columnSpaceBuilder));
        }
        ImmutableSet<C> columnSpace = immutableSetCopyOf2;
