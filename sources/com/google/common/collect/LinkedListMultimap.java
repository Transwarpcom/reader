...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedListMultimap.class */
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedListMultimap$Node.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedListMultimap$KeyList.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeAllNodes(Object key) {
        Iterators.clear(new ValueForKeyIterator(key));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void checkElement(Object node) {
        if (node == null) {
            throw new NoSuchElementException();
        }
    }

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedListMultimap$NodeIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedListMultimap$DistinctKeyIterator.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/LinkedListMultimap$ValueForKeyIterator.class */
    ...
    public List<Map.Entry<K, V>> createEntries() {
        return new AbstractSequentialList<Map.Entry<K, V>>() { // from class: com.google.common.collect.LinkedListMultimap.1EntriesImpl
            ...
            public void forEach(Consumer<? super Map.Entry<K, V>> action) {
                ...
                Node<K, V> node = LinkedListMultimap.this.head;
                while (true) {
                    Node<K, V> node2 = node;
                    if (node2 != null) {
                        action.accept(node2);
