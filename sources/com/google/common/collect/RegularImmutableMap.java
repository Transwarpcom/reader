...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableMap.class */
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    static <V> V get(Object key, ImmutableMapEntry<?, V>[] keyTable, int mask) {
        ...
        ImmutableMapEntry<?, V> nextInKeyBucket = keyTable[index];
        while (true) {
            ImmutableMapEntry<?, V> entry = nextInKeyBucket;
            if (entry != null) {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableMap$KeySet.class */
    private static final class KeySet<K, V> extends IndexedImmutableSet<K> {
        ...
        @GwtIncompatible
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableMap$KeySet$SerializedForm.class */
    ...
    @GwtCompatible(emulated = true)
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableMap$Values.class */
    private static final class Values<K, V> extends ImmutableList<V> {
        ...
        @GwtIncompatible
        /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/RegularImmutableMap$Values$SerializedForm.class */
