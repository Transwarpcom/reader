...
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized.class */
final class Synchronized {
    private Synchronized() {
    }

    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedObject.class */
    ...
    @VisibleForTesting
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedCollection.class */
    static class SynchronizedCollection<E> extends SynchronizedObject implements Collection<E> {
        ...
        public boolean removeIf(Predicate<? super E> filter) {
            boolean zRemoveIf;
            synchronized (this.mutex) {
                zRemoveIf = delegate().removeIf(filter);
            }
            return zRemoveIf;
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedSet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedSortedSet.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedList.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedRandomAccessList.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedMultiset.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedMultimap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedListMultimap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedSetMultimap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedSortedSetMultimap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedAsMapEntries.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedMap.class */
    private static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V> {
        ...
        public V putIfAbsent(K key, V value) {
            V vPutIfAbsent;
            synchronized (this.mutex) {
                vPutIfAbsent = delegate().putIfAbsent(key, value);
            }
            return vPutIfAbsent;
        }
        ...
        public boolean replace(K key, V oldValue, V newValue) {
            boolean zReplace;
            synchronized (this.mutex) {
                zReplace = delegate().replace(key, oldValue, newValue);
            }
            return zReplace;
        }
        ...
        public V replace(K key, V value) {
            V vReplace;
            synchronized (this.mutex) {
                vReplace = delegate().replace(key, value);
            }
            return vReplace;
        }
        ...
        public V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
            V vComputeIfAbsent;
            synchronized (this.mutex) {
                vComputeIfAbsent = delegate().computeIfAbsent(key, mappingFunction);
            }
        ...
        public V computeIfPresent(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
            V vComputeIfPresent;
            synchronized (this.mutex) {
                vComputeIfPresent = delegate().computeIfPresent(key, remappingFunction);
            }
        ...
        public V compute(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
            V vCompute;
            synchronized (this.mutex) {
                vCompute = delegate().compute(key, remappingFunction);
            }
            return vCompute;
        }
        ...
        public V merge(K key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
            V vMerge;
            synchronized (this.mutex) {
                vMerge = delegate().merge(key, value, remappingFunction);
            }
            return vMerge;
        }
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedSortedMap.class */
    ...
    @VisibleForTesting
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedBiMap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedAsMap.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedAsMapValues.class */
    ...
    @VisibleForTesting
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedNavigableSet.class */
    ...
    @VisibleForTesting
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedNavigableMap.class */
    ...
    @GwtIncompatible
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedEntry.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedQueue.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedDeque.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/Synchronized$SynchronizedTable.class */
