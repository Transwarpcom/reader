...
@Beta
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet.class */
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet$AsRanges.class */
    ...
    @VisibleForTesting
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet$RangesByUpperBound.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet$ComplementRangesByLowerBound.class */
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            if (peekingIterator.hasNext()) {
                if (((Range) peekingIterator.peek()).upperBound == Cut.aboveAll()) {
                    cutHigherKey2 = ((Range) peekingIterator.next()).lowerBound;
                } else {
                    cutHigherKey2 = this.positiveRangesByLowerBound.higherKey(((Range) peekingIterator.peek()).upperBound);
                }
                cutHigherKey = cutHigherKey2;
            } else {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet$Complement.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet$SubRangeSetRangesByLowerBound.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/collect/TreeRangeSet$SubRangeSet.class */
