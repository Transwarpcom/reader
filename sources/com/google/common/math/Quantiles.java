...
@Beta
@GwtIncompatible
/* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/math/Quantiles.class */
public final class Quantiles {
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/math/Quantiles$Scale.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/math/Quantiles$ScaleAndIndex.class */
    ...
    /* loaded from: reader.jar:BOOT-INF/lib/guava-28.0-jre.jar:com/google/common/math/Quantiles$ScaleAndIndexes.class */
        ...
        public Map<Integer, Double> computeInPlace(double... dataset) {
            ...
            for (int i2 = 0; i2 < this.indexes.length; i2++) {
                ...
                if (remainder2 == 0) {
                    ...
                    ret.put(Integer.valueOf(this.indexes[i2]), Double.valueOf(Quantiles.interpolate(dataset[quotient2], dataset[quotient2 + 1], remainder2, this.scale)));
                }
            }
